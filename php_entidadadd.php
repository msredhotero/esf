...
<form name="entidadadd" id="entidadadd" action="php_entidadadd.php" method="post" onSubmit="return EW_checkMyForm(this);">
<p>
...
function AddData($conn)
{
	...
	if ((@$x_entidad_id == "") || (is_null($x_entidad_id))) {
		...
		$sTmp =  (get_magic_quotes_gpc()) ? stripslashes($x_entidad_id) : $x_entidad_id;			
		$sWhereChk .= "(`entidad_id` = " . addslashes($sTmp) . ")";
	}
	if ($bCheckKey) {
