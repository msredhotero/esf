...
//if (!empty($x_medio_pago_id )) $x_medio_pago_id  = (get_magic_quotes_gpc()) ? stripslashes($x_medio_pago_id ) : $x_medio_pago_id ;
// Get action
...
<form name="medio_pagoedit" id="medio_pagoedit" action="php_medio_pagoedit.php" method="post" onSubmit="return EW_checkMyForm(this);">
<p>
<input type="hidden" name="a_edit" value="U">
<table class="ewTable_small">
	<tr>
		<td width="111" class="ewTableHeader"><span>No</span></td>
		<td width="877" class="ewTableAltRow"><span>
<?php echo $x_medio_pago_id; ?>
<input type="hidden" id="x_medio_pago_id" name="x_medio_pago_id" value="<?php echo htmlspecialchars(@$x_medio_pago_id); ?>">
</span></td>
	</tr>
	<tr>
