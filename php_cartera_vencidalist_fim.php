...
if($_SESSION["php_project_esf_status_UserRolID"] == 7) {
	...
	if($_SESSION["php_project_esf_status_UserRolID"] == 5) {
		...
		$sSql = "select vencimiento.credito_id,solicitud.formato_nuevo as formato from vencimiento join credito on credito.credito_id = vencimiento.credito_id join solicitud on solicitud.solicitud_id = credito.solicitud_id join promotor on promotor.promotor_id = solicitud.promotor_id JOIN fondeo_colocacion ON fondeo_colocacion.credito_id = credito.credito_id  where (fondeo_colocacion.fondeo_credito_id = 7) AND (credito.credito_status_id in (1,3)) AND (vencimiento.vencimiento_status_id = 3) AND ((TO_DAYS('".ConvertDateToMysqlFormat($currdate)."') - TO_DAYS(vencimiento.fecha_vencimiento)) >= ".$_SESSION["x_dias_ini"].") AND ((TO_DAYS('".ConvertDateToMysqlFormat($currdate)."') - TO_DAYS(vencimiento.fecha_vencimiento)) <= ".$_SESSION["x_dias_fin"].$sWhere.")";
	}
...
<br /><br />
<?php if ($sExport == "") { ?>
&nbsp;&nbsp;<a href="php_cartera_vencidalist_fim.php?export=excel&x_dias_ini=<?php echo $x_dias_ini; ?>&x_dias_fin=<?php echo $x_dias_fin; ?>">Exportar a Excel</a>
<?php } ?>
</span></p>

<?php if ($sExport == "") { ?>
<form action="php_cartera_vencidalist_fim.php" name="filtro" id="filtro" method="post">
...
<div id="txtlineas" style=" float: left;">
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td><span class="phpmaker"><a href="php_cartera_vencidalist_fim.php?cmd=reset">Mostrar Todos</a>&nbsp;&nbsp; </span></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
...
<tr class="ewTableHeader">
  <td valign="top"><span> Ver Solicitud </span></td>
  <td valign="top"><span> Ver Cr&eacute;dito </span></td>
  <td valign="top"><span> Credito Num. </span></td>
  <td valign="top"><span> Fondo </span></td>
  <td valign="top"><span> Promotor </span></td>
  <td valign="top"><span> Cliente </span></td>
  <td valign="top"><span> Aval </span></td>
  <td valign="top"><span> Municipio </span></td>
  <td valign="top"><span> Calle </span></td>
  <td valign="top"><span> Colonia </span></td>
  <td valign="top"><span> Num. de Pagos Vencidos </span></td>
  <td valign="top"><span> Max. num de Dias vencido </span></td>
  <td valign="top">Dias sin pagar</td>
  <td valign="top"><span> Capital
    Vencido</span></td>
  <td valign="top">Capital Deudor</td>
  <td valign="top"><span> Total de Intereses </span></td>
  <td valign="top"><span> Total de Moratorios </span></td>
  <td valign="top"><span> Total Vencido </span></td>
  <td valign="top"><span> Comentarios </span></td>
</tr>
<?php
$x_tot_pagos_venc = 0;
$x_max_dias_venc = 0;
...
<tr<?php echo $sItemRowClass; ?>>
  ...
  <td align="center"><span>
    ...
    <a href="php_creditoedit.php?credito_id=<?php echo $x_credito_id; ?>" target="_blank">
      <?php }else{ ?>
      </a><a href="php_creditoview.php?credito_id=<?php echo $x_credito_id; ?>" target="_blank">
        <?php } ?>
        Ver</a> </span></td>
  <td align="right"><span> <?php echo $x_credito_num; ?> </span></td>
  <td align="left"><span>
    <?php 
...
echo  $x_municipio."<br>".$x_municipio_a; ?>
  ...
  <td align="left"><span> <?php echo $x_calle." Telefono : ".$x_numero_telefonico."<br>".$x_calle_a." Telefono : ".$x_numero_telefonicoa;
$x_numero_telefonico = "";
$x_numero_telefonicoa = "";
?> </span></td>
  <td align="left"><span> <?php echo  $x_colonia."<br>".$x_colonia_a ;?> </span></td>
  <td align="right"><span> <?php echo $x_contador; ?> </span></td>
  <td align="right"><span> <?php echo $x_dias_venc_ant; ?> </span></td>
  <td align="right"><?php echo $x_dias_ultimo_pago; ?></td>
  <!-- importe -->
  <td align="right"><span> <?php echo FormatNumber($x_total_importe,2,0,0,1) ?> </span></td>
  <td align="right"><?php echo FormatNumber($x_total_importe_d,2,0,0,1) ?></td>
  <!-- interes -->
  <td align="right"><span> <?php echo FormatNumber($x_total_interes,2,0,0,1) ?> </span></td>
  <!-- interes_moratorio -->
  <td align="right"><span> <?php echo FormatNumber($x_total_moratorios,2,0,0,1) ?> </span></td>
  <td align="right"><span> <?php echo FormatNumber($x_total_total,2,0,0,1) ?> </span></td>
  <td align="center"><span>
