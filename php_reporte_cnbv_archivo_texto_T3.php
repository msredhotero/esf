...
$fecha_inicio =  $x_today_anio."-"."07"."-01";
$fecha_fin = $x_today_anio."-"."09"."-30";

$año_nombre_reporte = substr($arra_fecha[0],2,4);
$nombre_archivo =  "1069119".$año_nombre_reporte."09.002";
...
$rs2 = phpmkr_query($SQLInsert,$conn) or die("Error al seleccionar los datos de la solicitud".phpmkr_error()."sql :".$SQLInsert);
	...
	echo "<center>
	ARCHIVO GENERADO CORRECTAMENTE <br><BR> TRIMESTRE 3 DEL A&Ntilde;O ".$arra_fecha[0]."</B><BR>".$nombre_archivo."<br></center>";
