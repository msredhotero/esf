...
<a href="php_fondeo_empresalist.php">Regresar al listado</a>&nbsp;
<a href="<?php echo "php_fondeo_empresaedit.php?key=" . urlencode($sKey); ?>">Editar</a>&nbsp;
<a href="<?php echo "php_fondeo_empresadelete.php?key=" . urlencode($sKey); ?>">Eliminar</a></span></p>
<p>
<form>
<table class="ewTable">
	<tr>
