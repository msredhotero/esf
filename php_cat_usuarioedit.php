...
if (empty($x_cliente_id)) {
	...
	$sSql = "select usuario_id from cliente where cliente_id = $x_cliente_id";
...
switch ($sAction)
{
	...
	case "A": // Add
		...
		if (EditData($conn, $x_cliente_id)) { // Add New Record
			echo "
...
<form name="usuarioadd" id="usuarioadd" action="php_cat_usuarioedit.php" method="post" onSubmit="return EW_checkMyForm(this);">
<p>
