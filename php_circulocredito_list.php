...
<form action="php_circulocredito_list.php" name="filtro" id="filtro" method="post">
<table width="587">
	<tr>
	  <td colspan="6" class="ewTableHeaderThin">GENERACION DEL REPORTE PARACIRCULO DE CREDITO</td>
	  </tr>
	<tr>
