...
//-->
   ...
   <p><span class="phpmaker">Agregar nueva galeria de fotos<br><br>
     <a href="php_avallist.php">Regresar a la lista</a></span></p>
...
<table width="697" border="0">
  ...
  <tr background="images/headTUpload2.jpg">
    <td height="27"><a href="php_galeria_carga_coprebante_domicilio.php?x_galeria_fotografica_id=<?php echo $x_galeria_fotografica_id;?>" target="_blank">Comprobante Domicilio</a></td>
     ...
     <tr background="images/headTUpload1.jpg">
    <td height="27"><a href="php_galeria_carga_coprobante_propiedad.php?x_galeria_fotografica_id=<?php echo $x_galeria_fotografica_id;?>" target="_blank">Comprobante Propiedad</a></td>
    </tr>
  <tr background="images/headTUpload2.jpg">
    <td height="27"><a href="php_galeria_carga_negocio.php?x_galeria_fotografica_id=<?php echo $x_galeria_fotografica_id;?>" target="_blank">Negocio</a></td>
    </tr>
