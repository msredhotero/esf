...
function AplicaPropuesta(convenio_propuesta_id) 	
...

{
  ...
  if (xmlHttp.readyState == 4 || xmlHttp.readyState == 0)
  {
	...
	//tipo de solicitud 
	var url = "aplica_propuesta.php?x_convenio_propuesta_id="+convenio_propuesta_id+"";	
...
function handleServerResponse() 
{
  ...
  if (xmlHttp.readyState == 4) 
  {
	...
	document.getElementById("capaAplicaPropuesta_"+convenio_propuesta_id+"").value = "";
	document.getElementById("capaAplicaPropuesta_"+convenio_propuesta_id+"").innerHTML=r1;
