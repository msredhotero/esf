 ...
 --->
  ...
  <tr>
    ...
    <div id="x_boton_tres"><label><!--<?php if($x_disable_edit == "true"){ ?> disabled="disabled" <?php } ?>-->
      <input type="button" name="btn_rest" id="btn_rest" value="Restructurar cartera Vencida" onclick="javascript: document.getElementById('vencdesk').src = 'php_restructura.php?credito_id=<?php echo $x_credito_id; ?>';" <?php echo $x_disabled;?> />
