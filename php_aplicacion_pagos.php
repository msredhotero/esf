...
ResetCmd();
$x_elimina =@$_GET["x_elimina"];
//echo "elimina vale .".$x_elimina ."<br>";
...
//	echo "pro---<br />".$x_procesado."---";
	...
	echo "carga id en GFET".$x_carga_id;
	if(empty($x_fecha_pago)){
		$x_fecha_pago = $currdate;
	}
	if(empty($x_carga_id)){
		$x_carga_id = $currdate_carga.rand(0,9).rand(0,9);
		echo " estaba vacia caraga id".$x_carga_id;
	}
	
}
//echo "el valor de proesado es :".$x_procesado."<br>";
//echo "carga id :".$x_carga_id."<br>";
if($x_procesado == 2 && ($x_elimina == 1)){
...
if(empty($x_elimina) || $x_elimina == 0){
	//echo "elimina es empty....se borrar la tabla<br>";
...
if($x_procesado == 1){
	...
	echo "entra a procesado 1 emina  1";
...
<form action="php_aplicacion_pagos.php?x_elimina=1" name="filtro" id="filtro" method="post">
<input type="hidden" name="x_procesado" value="<?php echo $x_procesado; ?>"  />
<input type="hidden" name="x_carga_id" value="<?php echo $x_carga_id; ?>"  />
<input type="hidden" name="x_elimina" value="1" />
