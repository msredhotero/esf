...
while ($i < count($arRecKey)){
	...
	// Build the SQL
	$sDbWhere .= "`movimiento_cont_id`=" . $sRecKey . " AND ";
...
<p><span class="phpmaker">Delete from TABLE: Contabilidad Movimientos<br><br><a href="php_movimiento_contlist.php">Back to List</a></span></p>
<form action="php_movimiento_contdelete.php" method="post">
<p>
...
<table class="ewTable">
	<tr class="ewTableHeader">
		...
		<td valign="top"><span>Fecha del movimiento</span></td>
...
{
	global $x_movimiento_cont_id;
	$sSql = "Delete FROM `movimiento_cont`";
	$sSql .= " WHERE " . $sqlKey;
