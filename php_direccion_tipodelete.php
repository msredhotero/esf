...
while ($i < count($arRecKey)){
	...
	// Build the SQL
	$sDbWhere .= "`direccion_tipo_id`=" . $sRecKey . " AND ";
...
<p><span class="phpmaker">Delete from TABLE: TIPOS DE DIRECCION<br><br><a href="php_direccion_tipolist.php">Back to List</a></span></p>
<form action="php_direccion_tipodelete.php" method="post">
<p>
...
{
	global $x_direccion_tipo_id;
	$sSql = "Delete FROM `direccion_tipo`";
	$sSql .= " WHERE " . $sqlKey;
