...
$nombre_archivo =  "1069119".$año_nombre_reporte."03.002";
...
$rs2 = phpmkr_query($SQLInsert,$conn) or die("Error al seleccionar los datos de la solicitud".phpmkr_error()."sql :".$SQLInsert);
	...
	echo "<center>
	ARCHIVO GENERADO CORRECTAMENTE <br><BR> TRIMESTRE 1 DEL A&Ntilde;O ".$arra_fecha[0]."</B><BR>".$nombre_archivo."<br></center>";
