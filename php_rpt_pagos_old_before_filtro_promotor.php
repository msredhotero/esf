...
// Build SQL
$sSql = "SELECT cliente.*, credito.credito_num, vencimiento.vencimiento_num, vencimiento.importe as impvenc, vencimiento.interes, vencimiento.iva, vencimiento.interes_moratorio, vencimiento.iva_mor, vencimiento.total_venc, recibo.*, solicitud.solicitud_id 
...
on recibo.recibo_id = recibo_vencimiento.recibo_id join solicitud on solicitud.solicitud_id = credito.solicitud_id  join solicitud_cliente
...
<?php if ($sExport == "") { ?>
&nbsp;&nbsp;<a href="php_rpt_pagos.php?export=excel&x_credito_num_filtro=<?php echo $x_credito_num_filtro; ?>&x_fecha_desde=<?php echo FormatDateTime(@$x_fecha_desde,7); ?>&x_fecha_hasta=<?php echo FormatDateTime(@$x_fecha_hasta,7); ?>">Exportar a Excel</a><?php } ?>
</span></p>
<p>
<?php
if (@$_SESSION["ewmsg"] <> "") {
...
<table width="676" class="phpmaker">
	<tr>
	  <td width="79">&nbsp;</td>
	  <td width="54">&nbsp;</td>
		<td width="55"></td>
