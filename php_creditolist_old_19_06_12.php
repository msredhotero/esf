...
while (($row = @phpmkr_fetch_array($rs)) && ($nRecCount < $nStopRec)) {
	...
	if ($nRecCount >= $nStartRec) {
		...
		$sqlConciliaCheque = "SELECT cheque_conciliado_id FROM cheque_conciliado WHERE credito_id = $x_credito_id";
...
<!-- conciliar cheques -->
<td align="right">
<?php if(($x_cocilia_cheque_id > 0 && $x_cocilia_cheque_id < 6100)){ ?>
<span>
		<input type="checkbox" name="x_concilia_cheque<?php echo $x_credito_id; ?>"  onclick="ConciliaCheque(<?php echo $x_credito_id; ?>);"  /><div id="capaChequeConciliado_<?php echo $x_credito_id;?>"></div><?php } ?></td>
		<!-- importe -->
		<td align="right"><span>
