...
<p><span class="phpmaker">Add to TABLE: STATUS DE CONTACTOS<br><br><a href="php_contacto_statuslist.php">Back to List</a></span></p>
<form name="contacto_statusadd" id="contacto_statusadd" action="php_contacto_statusadd.php" method="post" onSubmit="return EW_checkMyForm(this);">
<p>
...
function AddData($conn)
{
	...
	if ((@$x_contacto_status_id == "") || (is_null($x_contacto_status_id))) {
		...
		$sTmp =  (get_magic_quotes_gpc()) ? stripslashes($x_contacto_status_id) : $x_contacto_status_id;			
		$sWhereChk .= "(`contacto_status_id` = " . addslashes($sTmp) . ")";
	}
	if ($bCheckKey) {
	...
	$sSql = "INSERT INTO `contacto_status` (";
