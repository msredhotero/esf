...
//$x_direccion_id = (get_magic_quotes_gpc()) ? stripslashes($x_direccion_id) : $x_direccion_id;
// Get action
...
<p><span class="phpmaker">View TABLE: DIRECCIONES<br><br>
<a href="php_direccionlist.php">Back to List</a>&nbsp;
<a href="<?php if ($x_direccion_id <> "") {echo "php_direccionedit.php?direccion_id=" . urlencode($x_direccion_id); } else { echo "javascript:alert('Invalid Record! Key is null');";} ?>">Edit</a>&nbsp;
<a href="<?php if ($x_direccion_id <> "") {echo "php_direccionadd.php?direccion_id=" . urlencode($x_direccion_id); } else { echo "javascript:alert('Invalid Record! Key is null');";} ?>">Copy</a>&nbsp;
<a href="<?php if ($x_direccion_id <> "") {echo "php_direcciondelete.php?direccion_id=" . urlencode($x_direccion_id); } else { echo "javascript:alert('Invalid Record! Key is null');";} ?>">Delete</a>&nbsp;
</span></p>
<p>
<form>
<table class="ewTable">
