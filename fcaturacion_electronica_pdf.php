...
function generaPDF($x_factura_id, $conn, $x_cadena_o, $x_sello, $x_fecha ){
...
$fecha = $x_fecha;	
	...
	$x_sub_total_XML = number_format($rowFactura["sub_total"],2);
	$x_total_XML = number_format($rowFactura["total"],2); 
	...
	$x_importe_iva = number_format($x_total_iva,2);
	#echo "XML SUBTOTAL XML*****".$x_sub_total_XML."<BR>***";
	
	$x_importe_letras = covertirNumLetras($x_total_XML);
...
$numero_receptor = $x_numero;
if($numero_receptor > 0){
	$calle_receptor .= " ". $numero_receptor;
	}
...
$sello_digital2 = wordwrap($sello, 115, "<br />", true);
...
<table width="100%" border="0" cellspacing="0" cellpadding="4" style="color:#666;">
  <tr>
    ...
    <td width="49%" rowspan="2" align="center" style="border-bottom:1pt solid #333;"><table width="90%" border="0" cellspacing="0" cellpadding="2" style="font-size:8pt;">
      ...
      <tr>
        <td colspan="2" align="left">México D.F., $fecha</td>
        </tr>
    </table></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="3" align="center" style="border-bottom:1pt solid #333;"><div align="center"><table width="99%" border="0" align="center" cellpadding="2" cellspacing="0">
      ...
      <tr>
        ...
        <td align="right">$x_sub_total_XML</td>
        </tr>
      <tr>
        <td colspan="3" rowspan="2" align="left" style="font-size:8pt;">$x_importe_letras</td>
        <td align="right"><strong>IVA:</strong></td>
        <td align="right">$x_importe_iva </td>
        </tr>
      <tr>
        <td align="right"><strong>Total:</strong></td>
        <td align="right">$x_total_XML</td>
        </tr>
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
  ...
  <tr>
    <td colspan="3">Forma de pago: $forma_pago</td>
  </tr>
  <tr>
    <td colspan="3">Metodo de pago: $metodo_pago</td>
  </tr>
  <tr>
...
$x_nombre_pdf = "PDF_".$x_fecha_actual."_".$x_nn."_".$x_paterno."_".$x_materno."_".$x_serie."_".$folio.".pdf";


// Close and output PDF document
// This method has several options, check the source code documentation for more information.
$pdf->Output('CFDS/PDF/'.$x_nombre_pdf, 'F');
#echo "nombre_archivo...pdf".$x_nombre_pdf."<br>";
//============================================================+
// END OF FILE
//============================================================+
#INSERTAMOS EL ARCHIVO EN LA TABLA
	$sqlpdf = "INSERT INTO factura_pdf (`factura_pdf_id`, `factura_id`, `archivo`, `fecha`) VALUES (NULL, $x_factura,'$x_nombre_pdf','$x_fecha_actual');";
	$rspdf = phpmkr_query($sqlpdf, $conn) or die("Error al insertar en pdf factura".phpmkr_error()."sql :".$sqlpdf);
	if($rspdf){
	#	echo "sen inserto en pdf";
		}	
...
class MYPDF extends TCPDF {
    ...
    function Footer() {
        ...
        // Page number
        $this->Cell(0, 10,' Este Documento es una representación impresa de un CFD', 0, false, 'C', 0, '', 0, false, 'T', 'M');
    }
}