...
<p><span class="phpmaker">Add to TABLE: STATUS DE CREDITO<br><br><a href="php_credito_statuslist.php">Back to List</a></span></p>
<form name="credito_statusadd" id="credito_statusadd" action="php_credito_statusadd.php" method="post" onSubmit="return EW_checkMyForm(this);">
<p>
...
function AddData($conn)
{
	...
	if ((@$x_credito_status_id == "") || (is_null($x_credito_status_id))) {
		...
		$sTmp =  (get_magic_quotes_gpc()) ? stripslashes($x_credito_status_id) : $x_credito_status_id;			
		$sWhereChk .= "(`credito_status_id` = " . addslashes($sTmp) . ")";
	}
	if ($bCheckKey) {
	...
	$sSql = "INSERT INTO `credito_status` (";
