...
<p><span class="phpmaker">CATALOGO DE ESTADOS CIVILES<br><br>
<a href="php_estado_civillist.php">Regresar a la lista</a></span></p>
<form name="estado_civiladd" id="estado_civiladd" action="php_estado_civiladd.php" method="post" onSubmit="return EW_checkMyForm(this);">
<p>
...
<table class="ewTable_small">
	<tr>
		<td width="127" class="ewTableHeader"><span>Descripción</span></td>
		<td width="861" class="ewTableAltRow"><span>
...
function AddData($conn)
{
	...
	if ((@$x_estado_civil_id == "") || (is_null($x_estado_civil_id))) {
		...
		$sTmp =  (get_magic_quotes_gpc()) ? stripslashes($x_estado_civil_id) : $x_estado_civil_id;			
		$sWhereChk .= "(`estado_civil_id` = " . addslashes($sTmp) . ")";
	}
	if ($bCheckKey) {
