...
//if (!empty($x_promotor_comision_status_id )) $x_promotor_comision_status_id  = (get_magic_quotes_gpc()) ? stripslashes($x_promotor_comision_status_id ) : $x_promotor_comision_status_id ;
// Get action
...
<p><span class="phpmaker">Edit TABLE: Status de Comisiones<br><br><a href="php_promotor_comision_statuslist.php">Back to List</a></span></p>
<form name="promotor_comision_statusedit" id="promotor_comision_statusedit" action="php_promotor_comision_statusedit.php" method="post" onSubmit="return EW_checkMyForm(this);">
<p>
...
<?php echo $x_promotor_comision_status_id; ?><input type="hidden" id="x_promotor_comision_status_id" name="x_promotor_comision_status_id" value="<?php echo htmlspecialchars(@$x_promotor_comision_status_id); ?>">
</span></td>
	</tr>
	<tr>
...
function EditData($conn)
{
	...
	if (phpmkr_num_rows($rs) == 0) {
		...
		// update
		$sSql = "UPDATE `promotor_comision_status` SET ";
