...
foreach($row as $campo => $valor){
	...
	if(strlen($valor) >5){
		...
		$x_cadena_links .= "<a href=\"".ewUploadPath(0) .$valor."\" id=\"x_link_".$x_id."\"  target=\"_blank\">$x_id</a> - ";
		$x_cadena_fotografica = $x_cadena_fotografica. "<a href=\"".ewUploadPath(0) .$valor."\" ><img src=\"".ewUploadPath(0) .$valor."\" alt=\"".$nombre_pic."\" title=\"".$nombre_galeria." ( ver individual ".$x_id." )\"></a> ";
		$x_id ++;
		}
...
// galeria fotografica extra
$sqlGE = "SELECT * FROM  galeria_fotografica_extra WHERE galeria_fotografica_id = $x_galeria_fotografica_id ";
$rsGE = phpmkr_query($sqlGE,$conn)or die ("Error al seleccionar la galeria extra".phpmkr_error()."sql:".$sqlGE);
//echo $sqlGE."<br>";
while($rowGE = mysql_fetch_assoc($rsGE)){
//print_r($rowGE);
echo "<br>----";
array_shift($rowGE);
array_shift($rowGE);
...
$x_cadena_links = trim($x_cadena_links,"- ");
...
<tr><td> <a href="php_galeriaview.php?x_galeria_fotografica_id=<?php echo $id?>"> Ver con la galeria anterior</a> &nbsp;<a href="php_galeria_ajustable.php?x_galeria_fotografica_id=<?php echo $id?>">Ver galeria ajustable </a></td></tr>
<tr><td>&nbsp;</td></tr>
<tr><td>Ver fotos individualmente : <?php echo $x_cadena_links;?></td></tr>
<tr><td>
<div id="galleria">
<?php 
