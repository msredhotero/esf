...
<p><span class="phpmaker">Add to TABLE: Status de Recibos<br><br><a href="php_recibo_statuslist.php">Back to List</a></span></p>
<form name="recibo_statusadd" id="recibo_statusadd" action="php_recibo_statusadd.php" method="post" onSubmit="return EW_checkMyForm(this);">
<p>
...
function AddData($conn)
{
	...
	if ((@$x_recibo_status_id == "") || (is_null($x_recibo_status_id))) {
		...
		$sTmp =  (get_magic_quotes_gpc()) ? stripslashes($x_recibo_status_id) : $x_recibo_status_id;			
		$sWhereChk .= "(`recibo_status_id` = " . addslashes($sTmp) . ")";
	}
	if ($bCheckKey) {
	...
	$sSql = "INSERT INTO `recibo_status` (";
