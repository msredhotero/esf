...
<form name="mensajeria_tipoadd" id="mensajeria_tipoadd" action="php_mensajeria_tipoadd.php" method="post" onSubmit="return EW_checkMyForm(this);">
<p>
...
<table class="ewTable_small">
	<tr>
		<td width="122" class="ewTableHeader"><span>Descripcion</span></td>
		<td width="866" class="ewTableAltRow"><span>
...
function AddData($conn)
{
	...
	if ((@$x_mensajeria_tipo_id == "") || (is_null($x_mensajeria_tipo_id))) {
		...
		$sTmp =  (get_magic_quotes_gpc()) ? stripslashes($x_mensajeria_tipo_id) : $x_mensajeria_tipo_id;			
		$sWhereChk .= "(`mensajeria_tipo_id` = " . addslashes($sTmp) . ")";
	}
	if ($bCheckKey) {
	...
	$sSql = "INSERT INTO `mensajeria_tipo` (";
