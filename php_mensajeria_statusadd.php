...
if (empty($x_mensajeria_status_id)) {
	$bCopy = false;
}
...
<p><span class="phpmaker">Add to TABLE: Status de mensajeria<br><br><a href="php_mensajeria_statuslist.php">Back to List</a></span></p>
<form name="mensajeria_statusadd" id="mensajeria_statusadd" action="php_mensajeria_statusadd.php" method="post" onSubmit="return EW_checkMyForm(this);">
<p>
...
function AddData($conn)
{
	...
	if ((@$x_mensajeria_status_id == "") || (is_null($x_mensajeria_status_id))) {
		...
		$sTmp =  (get_magic_quotes_gpc()) ? stripslashes($x_mensajeria_status_id) : $x_mensajeria_status_id;			
		$sWhereChk .= "(`mensajeria_status_id` = " . addslashes($sTmp) . ")";
	}
	if ($bCheckKey) {
	...
	$sSql = "INSERT INTO `mensajeria_status` (";
