...
function ConvenioLiquidacion(convenio_liquidacion_id) 	


{
	this.convenio_liquidacion_id =  convenio_liquidacion_id;
  ...
  if (xmlHttp.readyState == 4 || xmlHttp.readyState == 0)
  {
	...
	//tipo de solicitud 
	var url = "concilia_convenio_liquidacion.php?x_convenio_liquidacion_id="+convenio_liquidacion_id+"";	
...
function handleServerResponse() 
{
  ...
  if (xmlHttp.readyState == 4) 
  {
	...
	document.getElementById("capaConvenioLiquidacion_"+convenio_liquidacion_id+"").value = "";
	document.getElementById("capaConvenioLiquidacion_"+convenio_liquidacion_id+"").innerHTML=xmlHttp.responseText;
   } 
