...
$sDbWhere .= "`giro_negocio_id`=" . trim($sKey) . "";
...
<p><span class="phpmaker">Eliminar Giro Negocio<br><br><a href="giro_negociolist.php">Regresar a la lista</a></span></p>
<form action="giro_negociodelete.php" method="post">
<p>
