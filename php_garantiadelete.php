...
while ($i < count($arRecKey)){
	...
	// Build the SQL
	$sDbWhere .= "`garantia_id`=" . $sRecKey . " AND ";
...
<p><span class="phpmaker">Delete from TABLE: GARANTIAS<br><br><a href="php_garantialist.php">Back to List</a></span></p>
<form action="php_garantiadelete.php" method="post">
<p>
...
<table class="ewTable">
	<tr class="ewTableHeader">
		...
		<td valign="top"><span>Valor</span></td>
		<td valign="top"><span>Documento</span></td>
	</tr>
<?php
$nRecCount = 0;
$i = 0;
