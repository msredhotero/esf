...
// Build SQL
$sSql = "SELECT * FROM `vencimiento_respaldo`";
...
$sDbWhere = "(vencimiento_respaldo.credito_respaldo_id = $x_credito_id) AND ";
...
if ($sOrderBy != "") {
*/
	$sSql .= " ORDER BY vencimiento_respaldo.vencimiento_num ";
/*}*/
...
?>
<?php if ($sExport == "") { ?>
<form action="php_vencimientolist_respaldo_respaldo.php" name="ewpagerform" id="ewpagerform">
</form>
<?php } ?>
<?php if ($nTotalRecs > 0)  { ?>
<form method="post" name="principal" action="php_vencimientolist_respaldo_respaldo.php">
<input type="hidden" name="credito_id" value="<?php echo $x_credito_id; ?>"  />
<table width="700"   align="center"  class="ewTable_small_2">
	<!-- Table header -->
	<tr class="ewTableHeader">
<td width="17"><span>
&nbsp;
</span></td>
		<td width="45" valign="top"><span>
<?php if ($sExport <> "") { ?>
No
<?php }else{ ?>
	<a href="php_vencimientolist_respaldo.php?credito_id=<?php echo $x_credito_id; ?>&order=<?php echo urlencode("vencimiento_id"); ?>">No<?php if (@$_SESSION["vencimiento_x_vencimiento_id_Sort"] == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif (@$_SESSION["vencimiento_x_vencimiento_id_Sort"] == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></a>
<?php } ?>
		</span></td>
...
Status
<?php }else{ ?>
	<a href="php_vencimientolist_respaldo.php?credito_id=<?php echo $x_credito_id; ?>&order=<?php echo urlencode("vencimiento_status_id"); ?>">Status<?php if (@$_SESSION["vencimiento_x_vencimiento_status_id_Sort"] == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif (@$_SESSION["vencimiento_x_vencimiento_status_id_Sort"] == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></a>
<?php } ?>
		</span></td>
		<td width="74" valign="top"><span>
<?php if ($sExport <> "") { ?>
Fecha
<?php }else{ ?>
	<a href="php_vencimientolist_respaldo.php?credito_id=<?php echo $x_credito_id; ?>&order=<?php echo urlencode("fecha_vencimiento"); ?>">Fecha<?php if (@$_SESSION["vencimiento_x_fecha_vencimiento_Sort"] == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif (@$_SESSION["vencimiento_x_fecha_vencimiento_Sort"] == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></a>
<?php } ?>
		</span></td>
   
						                
		<td width="59" valign="top" align="right"><span>
Capital		
	  </span></td>				
		<td width="68" valign="top" align="right"><span>
<?php if ($sExport <> "") { ?>
Importe
<?php }else{ ?>
	<a href="php_vencimientolist_respaldo.php?credito_id=<?php echo $x_credito_id; ?>&order=<?php echo urlencode("importe"); ?>">Importe<?php if (@$_SESSION["vencimiento_x_importe_Sort"] == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif (@$_SESSION["vencimiento_x_importe_Sort"] == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></a>
<?php } ?>
		</span></td>
		<td width="80" valign="top" align="right"><span>
<?php if ($sExport <> "") { ?>
Interés
<?php }else{ ?>
	<a href="php_vencimientolist_respaldo.php?credito_id=<?php echo $x_credito_id; ?>&order=<?php echo urlencode("interes"); ?>">Interés<?php if (@$_SESSION["vencimiento_x_interes_Sort"] == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif (@$_SESSION["vencimiento_x_interes_Sort"] == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></a>
<?php } ?>
		</span></td>
		<td width="46" valign="top" align="right">IVA</td>
		<td width="61" valign="top"><span>
<?php if ($sExport <> "") { ?>
Moratorio
<?php }else{ ?>
	<a href="php_vencimientolist_respaldo.php?credito_id=<?php echo $x_credito_id; ?>&order=<?php echo urlencode("interes_moratorio"); ?>">Moratorios<?php if (@$_SESSION["vencimiento_x_interes_moratorio_Sort"] == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif (@$_SESSION["vencimiento_x_interes_moratorio_Sort"] == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></a>
<?php } ?>
		</span></td>
		<td width="39" valign="top">IVA M.</td>
		<td width="103" valign="top" align="right"><span>
Total		
		</span></td>						
	</tr>
<?php
...
$sSqlWrk = "SELECT importe FROM credito_respaldo where credito_respaldo_id = $x_credito_id";
...
<tr>
  <td colspan="4" align="right"><strong>SALDO VENCIDO:</strong></td>
  <td align="right">&nbsp;</td>
