...
//if (!empty($x_usuario_id )) $x_usuario_id  = (get_magic_quotes_gpc()) ? stripslashes($x_usuario_id ) : $x_usuario_id ;
// Get action
...
<form name="usuarioedit" id="usuarioedit" action="php_usuarioedit.php" method="post" onSubmit="return EW_checkMyForm(this);">
<p>
<input type="hidden" name="a_edit" value="U">
<table width="394">
	<tr>
		<td width="126" class="ewTableHeaderThin"><span>No</span></td>
		<td width="256" class="ewTableAltRow"><span>
<?php echo $x_usuario_id; ?><input type="hidden" id="x_usuario_id" name="x_usuario_id" value="<?php echo htmlspecialchars(@$x_usuario_id); ?>">
</span></td>
	</tr>
	<tr>
