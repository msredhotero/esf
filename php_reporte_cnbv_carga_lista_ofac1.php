...
<form enctype="multipart/form-data" action="php_reporte_cnbv_carga_lista_ofac1_importar.php" method="post" id="add-courses">
...
<table  width="800" border="0" align="center" cellpadding="1" cellspacing="0"  class="texto_normal_SIP">
  <tr>
     ...
     <tr >
       <td colspan="3" class="linea_sip"><input type="submit" name="uploadCSV" value="Upload" /></td>
     </tr>
...
<br />&nbsp;&nbsp;* Haga clic en el men� desplegable al lado de "Guardar como tipo de archivo" y elija "Todos los archivos."
<br />&nbsp;&nbsp;* Ir a la "Codificaci�n" y seleccione "UTF-8" en el men� desplegable. Haga clic en "Guardar".
