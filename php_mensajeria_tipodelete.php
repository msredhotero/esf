...
while ($i < count($arRecKey)){
	...
	// Build the SQL
	$sDbWhere .= "`mensajeria_tipo_id`=" . $sRecKey . " AND ";
...
<form action="php_mensajeria_tipodelete.php" method="post">
<p>
...
{
	global $x_mensajeria_tipo_id;
	$sSql = "Delete FROM `mensajeria_tipo`";
	$sSql .= " WHERE " . $sqlKey;
