...
if (empty($x_movimiento_cont_status_id)) {
	$bCopy = false;
}
...
<p><span class="phpmaker">Add to TABLE: Status de Movimientos<br><br><a href="php_movimiento_cont_statuslist.php">Back to List</a></span></p>
<form name="movimiento_cont_statusadd" id="movimiento_cont_statusadd" action="php_movimiento_cont_statusadd.php" method="post" onSubmit="return EW_checkMyForm(this);">
<p>
...
function AddData($conn)
{
	...
	if ((@$x_movimiento_cont_status_id == "") || (is_null($x_movimiento_cont_status_id))) {
		...
		$sTmp =  (get_magic_quotes_gpc()) ? stripslashes($x_movimiento_cont_status_id) : $x_movimiento_cont_status_id;			
		$sWhereChk .= "(`movimiento_cont_status_id` = " . addslashes($sTmp) . ")";
	}
	if ($bCheckKey) {
	...
	$sSql = "INSERT INTO `movimiento_cont_status` (";
