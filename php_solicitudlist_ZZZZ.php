	...
	<tr>
	  ...
	  <td><?php
		...
		if($_SESSION["php_project_esf_status_UserRolID"] == 7) {
			...
			$sSqlWrk = "SELECT sucursal.sucursal_id, nombre FROM sucursal join promotor on promotor.sucursal_id = sucursal.sucursal_id Where promotor.promotor_id = ".$_SESSION["php_project_esf_SucursalID"];
