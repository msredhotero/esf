...
if (empty($x_solicitud_status_id)) {
	$bCopy = false;
}
...
<p><span class="phpmaker">Add to TABLE: STATUS DE SOLICITUDES<br><br><a href="php_solicitud_statuslist.php">Back to List</a></span></p>
<form name="solicitud_statusadd" id="solicitud_statusadd" action="php_solicitud_statusadd.php" method="post" onSubmit="return EW_checkMyForm(this);">
<p>
...
function AddData($conn)
{
	...
	if ((@$x_solicitud_status_id == "") || (is_null($x_solicitud_status_id))) {
		...
		$sTmp =  (get_magic_quotes_gpc()) ? stripslashes($x_solicitud_status_id) : $x_solicitud_status_id;			
		$sWhereChk .= "(`solicitud_status_id` = " . addslashes($sTmp) . ")";
	}
	if ($bCheckKey) {
	...
	$sSql = "INSERT INTO `solicitud_status` (";
