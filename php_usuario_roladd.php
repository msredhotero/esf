...
<p><span class="phpmaker">Add to TABLE: PERMISOS DE USUARIOS<br><br><a href="php_usuario_rollist.php">Back to List</a></span></p>
<form name="usuario_roladd" id="usuario_roladd" action="php_usuario_roladd.php" method="post" onSubmit="return EW_checkMyForm(this);">
<p>
...
function AddData($conn)
{
	...
	if ((@$x_usuario_rol_id == "") || (is_null($x_usuario_rol_id))) {
		...
		$sTmp =  (get_magic_quotes_gpc()) ? stripslashes($x_usuario_rol_id) : $x_usuario_rol_id;			
		$sWhereChk .= "(`usuario_rol_id` = " . addslashes($sTmp) . ")";
	}
	if ($bCheckKey) {
