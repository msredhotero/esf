...
<form name="promotor_comisionedit" id="promotor_comisionedit" action="php_promotor_comisionedit.php" method="post" onSubmit="return EW_checkMyForm(this);">
<p>
...
?>
	...
	<tr>
	  ...
	  <td class="ewTableAltRow"><input type="text" name="x_comision_importe" class="importe" value="<?php echo htmlspecialchars(@$x_comision_importe) ?>" size="10" maxlength="10" onkeypress="return solonumeros(this,event)"/></td>
	  </tr>
	<tr>
...
button : "cx_fecha_registro" // ID of the button
	...
	<tr>
		...
		<td class="ewTableAltRow"><input type="text" name="x_referencia" id="x_referencia" size="30" maxlength="150" value="<?php echo htmlspecialchars(@$x_referencia) ?>" /></td>
	</tr>
	<tr>
		<td class="ewTableHeaderThin"><span>Status</span></td>
		<td class="ewTableAltRow"><?php if (!(!is_null($x_promotor_comision_status_id)) || ($x_promotor_comision_status_id == "")) { $x_promotor_comision_status_id = 0;} // Set default value ?>
          <?php
