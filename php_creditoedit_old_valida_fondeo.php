...
%</td>
  ...
  <tr>
    <td colspan="5" class="ewTableAltRow"><label>
  ...
  <tr>
    ...
    <iframe id="vencdesk" src="php_vencimientolist.php?credito_id=<?php echo $x_credito_id; ?>" name="vencimientos" frameborder="0"  style="margin-left:2px; width:700px; height:700px; border:0 " allowtransparency="true"></iframe>    </td>
  </tr>
</table>
<p>
<p>
