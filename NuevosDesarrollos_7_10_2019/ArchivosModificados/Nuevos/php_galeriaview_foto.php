...
$x_foto_persona_1 = $row["foto_persona_1"];
$x_foto_persona_2 = $row["foto_persona_2"];
$x_foto_persona_3 = $row["foto_persona_3"];
$x_foto_persona_4 = $row["foto_persona_4"];
$x_foto_persona_5 = $row["foto_persona_5"];
...
<table width="697" border="0">
  <tr>
    <td height="20" class="ewTableHeaderThin">Solicitud de Credito de <?php echo $x_nombre_galeria; ?></td>
   </tr>
    <?php

	  if(!empty($x_foto_persona_1)){?>
  <tr background="images/headTUpload1.jpg">
    <td height="27"><a href="<?php echo ewUploadPath(0) .$x_foto_persona_1 ?>"  target="_blank">Foto 1</a></td>
    </tr><?php }?>

     <?php

	   if(!empty($x_foto_persona_2)){?>
  <tr background="images/headTUpload2.jpg">
    <td height="27"><a href="<?php echo ewUploadPath(0) .$x_foto_persona_2 ?>"  target="_blank">Foto 2 </a></td>
    </tr><?php }?>

     <?php
	   if(!empty($x_foto_persona_3)){?>
     <tr background="images/headTUpload1.jpg">
    <td height="27"><a href="<?php echo ewUploadPath(0) .$x_foto_persona_3 ?>"  target="_blank">Foto 3</a></td>
    </tr><?php }?>

   <?php if(!empty($x_foto_persona_4)){?>
  <tr background="images/headTUpload2.jpg">
    <td height="27"><a href="<?php echo ewUploadPath(0) .$x_foto_persona_4 ?>"  target="_blank">Foto 4</a></td>
    </tr><?php }?>

     <?php  if(!empty($x_foto_persona_5)){?>
     <tr background="images/headTUpload1.jpg">
    <td height="27"><a href="<?php echo ewUploadPath(0) .$x_foto_persona_5 ?>"  target="_blank">Foto 5</a></td>
    </tr><?php }?>
