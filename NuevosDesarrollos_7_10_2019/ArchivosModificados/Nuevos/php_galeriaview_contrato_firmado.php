...
$sqlS = "SELECT contrato_firmado_1, contrato_firmado_2, contrato_firmado_3, contrato_firmado_4, contrato_firmado_5 FROM galeria_fotografica WHERE galeria_fotografica_id = $id AND ( contrato_firmado_1 IS NOT NULL || contrato_firmado_2 IS NOT NULL || contrato_firmado_3 IS NOT NULL || contrato_firmado_4 IS NOT NULL || contrato_firmado_5 IS NOT NULL )";

$rsS = phpmkr_query($sqlS, $conn) or die("Error al seleccionar IFE". phpmkr_error()."sql:".$sqlS);
$row = phpmkr_fetch_array($rsS);
$x_comprobante_propiedad_1 = $row["contrato_firmado_1"];
$x_comprobante_propiedad_2 = $row["contrato_firmado_2"];
$x_comprobante_propiedad_3 = $row["contrato_firmado_3"];
$x_comprobante_propiedad_4 = $row["contrato_firmado_4"];
$x_comprobante_propiedad_5 = $row["contrato_firmado_5"];
...
<table width="697" border="0">
  ...
  <tr background="images/headTUpload1.jpg">
    <td height="27"><a href="<?php echo ewUploadPath(0) .$x_comprobante_propiedad_1 ?>"  target="_blank">Contrato Firmado 1</a></td>
    </tr><?php }?>
  ...
  <tr background="images/headTUpload2.jpg">
    <td height="27"><a href="<?php echo ewUploadPath(0) .$x_comprobante_propiedad_2 ?>"  target="_blank">Contrato Firmado 2 </a></td>
    </tr><?php }?>

     <?php
	   if(!empty($x_comprobante_propiedad_3)){?>
     <tr background="images/headTUpload1.jpg">
    <td height="27"><a href="<?php echo ewUploadPath(0) .$x_comprobante_propiedad_3 ?>"  target="_blank">Contrato Firmado 3</a></td>
    </tr><?php }?>

   <?php if(!empty($x_comprobante_propiedad_4)){?>
  <tr background="images/headTUpload2.jpg">
    <td height="27"><a href="<?php echo ewUploadPath(0) .$x_comprobante_propiedad_4 ?>"  target="_blank">Contrato Firmado 4</a></td>
    </tr><?php }?>

     <?php  if(!empty($x_comprobante_propiedad_5)){?>
     <tr background="images/headTUpload1.jpg">
    <td height="27"><a href="<?php echo ewUploadPath(0) .$x_comprobante_propiedad_5 ?>"  target="_blank">Contrato Firmado 5</a></td>
    </tr><?php }?>
