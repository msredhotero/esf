...
<?php }else{ ?>
	...
	<a href="php_creditolist.php?order=<?php echo urlencode("credito_id"); ?>">Cr�dito No<?php if (@$_SESSION["credito_x_credito_id_Sort"] == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif (@$_SESSION["credito_x_credito_id_Sort"] == "ASC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></a>
...
while (($row = @phpmkr_fetch_array($rs)) && ($nRecCount < $nStopRec)) {
	...
	if ($nRecCount >= $nStartRec) {
		...
		$sqlComteC = "SELECT * FROM puntaje WHERE solicitud_id = $x_solicitud_id ";
		...
		$x_puntaje_id = 0;
		$x_pld = $rowPLD["grado"];
		$x_puntaje_id = $rowPLD["puntaje_id"];
		if(($_SESSION["php_project_esf_status_UserRolID"] == 20) || ($_SESSION["php_project_esf_status_UserRolID"] == 1)){
			$x_pld = '<a href="php_puntajeedit.php?puntaje_id='.urlencode($x_puntaje_id).'" target="_blank">'.$rowPLD["grado"].'</a>';
			}
