...
$x_identificacion_oficial_1 = $row["identificacion_oficial_1"];
$x_identificacion_oficial_2 = $row["identificacion_oficial_2"];
$x_identificacion_oficial_3 = $row["identificacion_oficial_3"];
$x_identificacion_oficial_4 = $row["identificacion_oficial_4"];
$x_identificacion_oficial_5 = $row["identificacion_oficial_5"];
...
<table width="697" border="0">
  <tr>
    <td height="20" class="ewTableHeaderThin">Identificaci&oacute;an oficial de <?php echo $x_nombre_galeria; ?></td>
   </tr>
    <?php

	  if(!empty($x_identificacion_oficial_1)){?>
  <tr background="images/headTUpload1.jpg">
    <td height="27"><a href="<?php echo ewUploadPath(0) .$x_identificacion_oficial_1 ?>"  target="_blank">Identificaci&oacute;n Oficial 1</a></td>
    </tr><?php }?>
   
     <?php 
	 
	   if(!empty($x_identificacion_oficial_2)){?>
  <tr background="images/headTUpload2.jpg">
    <td height="27"><a href="<?php echo ewUploadPath(0) .$x_identificacion_oficial_2 ?>"  target="_blank">Identificaci&oacute;n Oficial 2 </a></td>
    </tr><?php }?>
    
     <?php
	   if(!empty($x_identificacion_oficial_3)){?>
     <tr background="images/headTUpload1.jpg">
    <td height="27"><a href="<?php echo ewUploadPath(0) .$x_identificacion_oficial_3 ?>"  target="_blank">Identificaci&oacute;n Oficial 3</a></td>
    </tr><?php }?>
    
   <?php if(!empty($x_identificacion_oficial_4)){?>
  <tr background="images/headTUpload2.jpg">
    <td height="27"><a href="<?php echo ewUploadPath(0) .$x_identificacion_oficial_4 ?>"  target="_blank">Identificaci&oacute;n Oficial 4</a></td>
    </tr><?php }?>
    
     <?php  if(!empty($x_identificacion_oficial_5)){?>
     <tr background="images/headTUpload1.jpg">
    <td height="27"><a href="<?php echo ewUploadPath(0) .$x_identificacion_oficial_5 ?>"  target="_blank">Identificaci&oacute;n Oficial 5</a></td>
    </tr><?php }?>
