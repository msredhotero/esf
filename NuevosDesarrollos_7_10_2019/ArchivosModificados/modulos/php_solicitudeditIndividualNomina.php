...
?>
    ...
    <tr>
	  ...
	  if($x_readonly2){
		   ...
		   echo "<input type=\"hidden\" name=\"x_entidad_domicilio\" id=\"x_entidad_domicilio\" value=\"$x_entidad_domicilio\" >";
		  }else{
			$x_entidad_idList = "<select name=\"x_entidad_domicilio\" id=\"x_entidad_domicilio\" onchange=\"showHint2(this,'txtHint1', 'x_delegacion_id' ,'x_entidad_domicilio')\" >";
			$x_entidad_idList .= "<option value=''>Seleccione</option>";
			$sSqlWrk = "SELECT `estado_id`, `descripcion_s` FROM `inegi_estado`";
			$rswrk = phpmkr_query($sSqlWrk,$conn) or die("Failed to execute query" . phpmkr_error() . ' SQL:' . $sSqlWrk);
			if ($rswrk) {
			   ...
			   echo "<input type=\"hidden\" name=\"x_delegacion_id\" id=\"x_delegacion_id\" value=\"$x_delegacion_id\" >";
				...
				if ($rswrk) {
					...
					while ($datawrk = phpmkr_fetch_array($rswrk)) {
						...
						$x_delegacion_idList .= ">" . htmlentities($datawrk["descripcion_s"]) . "</option>";
						$rowcntwrk++;
					}
				}
				@phpmkr_free_result($rswrk);
  ...
  <tr>
    ...
    <tr>
      ...
      <td colspan="4"><?php
	   ...
	   if($x_readonly2){
		   ...
		   echo "<input type=\"hidden\" name=\"x_entidad_negocio\" id=\"x_entidad_negocio\" value=\"$x_entidad_negocio\" >";
		  }else{
    ...
    <tr>
	  ...
	  if($x_readonly2){
		   ...
		   echo "<input type=\"hidden\" name=\"x_localidad_id2\" id=\"x_localidad_id2\" value=\"$x_localidad_id2\" >";
		  }else{
...
$theValue = ($GLOBALS["x_nacionalidad_id"] != "") ? intval($GLOBALS["x_nacionalidad_id"]) : "0";
	...
	if(in_array($GLOBALS["x_entidad_nacimiento"], $x_array_edo_5)){
