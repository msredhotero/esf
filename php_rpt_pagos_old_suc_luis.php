...
?>
&nbsp;&nbsp;<a href="php_rpt_pagos.php?export=excel&x_credito_num_filtro=<?php echo $x_credito_num_filtro; ?>&x_fecha_desde=<?php echo ConvertDateToMysqlFormat(@$filter['x_fecha_desde']); ?>&x_fecha_hasta=<?php echo ConvertDateToMysqlFormat(@$filter['x_fecha_hasta']); ?>&x_gestor=<?php echo $filter["x_gestor"];?>&x_promo_srch=<?php echo $filter["x_promo_srch"];?>&x_sucursal_srch=<?php echo$filter['x_sucursal_srch']  ?>&x_fecha_desde_2=<?php echo ConvertDateToMysqlFormat(@$filter['x_fecha_desde_2']); ?>&x_fecha_hasta_2=<?php echo ConvertDateToMysqlFormat(@$filter['x_fecha_hasta_2']); ?>">Exportar a Excel</a><?php } ?><?php } ?>
</span></p>
<p>
<?php
if (@$_SESSION["ewmsg"] <> "") {
...
?></td>
    ...
    <tr>
      ...
      <td>&nbsp;</td>
      <td><span>
		<input name="x_fecha_desde_2" type="text" id="x_fecha_desde_2" value="<?php echo FormatDateTime(@$_SESSION["x_fecha_desde_2"],7); ?>" size="11">
      ...
      <td>&nbsp;</td>
      <td><span>
		<input name="x_fecha_hasta_2" type="text" id="x_fecha_hasta_2" value="<?php echo FormatDateTime(@$_SESSION["x_fecha_hasta_2"],7); ?>" size="11">
