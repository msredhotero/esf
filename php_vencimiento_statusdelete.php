...
while ($i < count($arRecKey)){
	...
	// Build the SQL
	$sDbWhere .= "`vencimiento_status_id`=" . $sRecKey . " AND ";
...
<p><span class="phpmaker">Delete from TABLE: STATUS DE VENCIMIENOS<br><br><a href="php_vencimiento_statuslist.php">Back to List</a></span></p>
<form action="php_vencimiento_statusdelete.php" method="post">
<p>
...
while ($i < count($arRecKey)) {
	...
	$x_vencimiento_status_id = $sRecKey;
	if (LoadData($conn)) {
?>
...
{
	global $x_vencimiento_status_id;
	$sSql = "Delete FROM `vencimiento_status`";
	$sSql .= " WHERE " . $sqlKey;
