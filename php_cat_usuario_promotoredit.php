...
if (empty($x_promotor_id)) {
	...
	$sSql = "select usuario_id from promotor where promotor_id = $x_promotor_id";
...
switch ($sAction)
{
	...
	case "A": // Add
		...
		if (EditData($conn, $x_promotor_id)) { // Add New Record
			echo "
...
<form name="usuarioadd" id="usuarioadd" action="php_cat_usuario_promotoredit.php" method="post" onSubmit="return EW_checkMyForm(this);">
<p>
