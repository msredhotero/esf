...
#echo "año_anterior".$año_anterior;
#echo $anio;




$fecha_inicio =  $año_anterior."-"."10"."-01";
$fecha_fin = $año_anterior."-"."12"."-31";

$año_nombre_reporte = substr($arra_fecha[0],2,4);
$año_nombre_reporte = substr($año_anterior,2,4);

#echo "=>".$año_nombre_reporte;
$nombre_archivo =  "1069119".$año_nombre_reporte."12.002";
...
$rs2 = phpmkr_query($SQLInsert,$conn) or die("Error al seleccionar los datos de la solicitud".phpmkr_error()."sql :".$SQLInsert);
	...
	echo "<center>
	ARCHIVO GENERADO CORRECTAMENTE <br><BR> TRIMESTRE 4 DEL A&Ntilde;O ".$año_anterior."</B><BR>".$nombre_archivo."<br></center>";
