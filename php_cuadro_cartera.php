...
$x_rango_vig_0 = 0;
$sSql = "
select credito.credito_id from credito where credito_status_id in ($x_credito_status) and credito_id not in (15)  order by credito.credito_id 
";
...
$x_sucursal_srch = 	$_SESSION["php_project_esf_SucursalID"];
