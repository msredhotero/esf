...
<p><span class="phpmaker">Add to TABLE: PORTAFOLIO<br><br><a href="php_credito_tipolist.php">Back to List</a></span></p>
<form name="credito_tipoadd" id="credito_tipoadd" action="php_credito_tipoadd.php" method="post" onSubmit="return EW_checkMyForm(this);">
<p>
...
function AddData($conn)
{
	...
	if ((@$x_credito_tipo_id == "") || (is_null($x_credito_tipo_id))) {
		...
		$sTmp =  (get_magic_quotes_gpc()) ? stripslashes($x_credito_tipo_id) : $x_credito_tipo_id;			
		$sWhereChk .= "(`credito_tipo_id` = " . addslashes($sTmp) . ")";
	}
	if ($bCheckKey) {
