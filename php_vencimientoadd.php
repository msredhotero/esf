...
switch ($sAction)
{
	...
	case "A": // Add
		if (AddData($conn)) { // Add New Record
			...
			phpmkr_db_close($conn);
			ob_end_clean();
			header("Location: php_restructura.php?credito_id=$x_credito_id");
			exit();
		}
		break;
}
...
<p><span class="phpmaker">Agregar Vencimiento<br><br><a href="php_restructura.php?credito_id=<?php echo $x_credito_id; ?>">Cancelar</a></span></p>
<form name="vencimientoadd" id="vencimientoadd" action="php_vencimientoadd.php" method="post" onSubmit="return EW_checkMyForm(this);">
<p>
