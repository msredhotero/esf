...
<p><span class="phpmaker">CREDITO ORIGINAL<br>
  <br>
...
?>
  ...
  <tr>
    ...
    <input type="radio" name="x_garantia_liquida" value="1" <?php if($x_garantia_liquida == 1){ echo "checked";} ?> />&nbsp;SI
      &nbsp;&nbsp;
      <input type="radio" name="x_garantia_liquida" value="0" <?php if($x_garantia_liquida == 0){ echo "checked";} ?>/>&nbsp;NO</td>
    <td class="ewTableAltRow">&nbsp;</td>
	...
	<tr>
		<td colspan="5" class="ewTableAltRow"><iframe id="vencdesk2" name="vencdesk2" src="php_vencimientolist_respaldo.php?credito_id=<?php echo $id; ?>" style="margin-left:2px; width:700px; height:750px; border:0 " allowtransparency="true" frameborder="0"></iframe></td>
	</tr>	
</table>
</form>
<p>
...
{
	global $x_credito_id;
	$sSql = "SELECT * FROM `credito_respaldo`";
	$sWhere = "";
	$sGroupBy = "";
	$sHaving = "";
	$sOrderBy = "";
	...
	$sWhere .= "(`credito_respaldo_id` = " . addslashes($sTmp) . ")";
	$sSql .= " WHERE " . $sWhere;
	if ($sGroupBy <> "") {
