...
<p><span class="phpmaker">Add to TABLE: STATUS DE USUARIOS<br><br><a href="php_usuario_statuslist.php">Back to List</a></span></p>
<form name="usuario_statusadd" id="usuario_statusadd" action="php_usuario_statusadd.php" method="post" onSubmit="return EW_checkMyForm(this);">
<p>
...
function AddData($conn)
{
	...
	if ((@$x_usuario_status_id == "") || (is_null($x_usuario_status_id))) {
		...
		$sTmp =  (get_magic_quotes_gpc()) ? stripslashes($x_usuario_status_id) : $x_usuario_status_id;			
		$sWhereChk .= "(`usuario_status_id` = " . addslashes($sTmp) . ")";
	}
	if ($bCheckKey) {
	...
	$sSql = "INSERT INTO `usuario_status` (";
