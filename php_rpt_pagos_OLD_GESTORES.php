...
// Build SQL
$sSql = "SELECT credito.credito_num, vencimiento.vencimiento_num, vencimiento.importe as impvenc, vencimiento.interes, vencimiento.iva, vencimiento.interes_moratorio, vencimiento.iva_mor, vencimiento.total_venc, recibo.*, solicitud.solicitud_id,  solicitud.promotor_id
...
<tr>
	  <td width="137">Tipo de Credito</td>
	  <td width="11">&nbsp;</td>
	  <td width="98"><?php
		$conn = phpmkr_db_connect(HOST, USER, PASS, DB, PORT);  
