...
while ($i < count($arRecKey)){
	...
	// Build the SQL
	$sDbWhere .= "`forma_pago_id`=" . $sRecKey . " AND ";
...
<form action="php_forma_pagodelete.php" method="post">
<p>
...
<table class="ewTable">
	<tr class="ewTableHeader">
		<td width="52" valign="top"><span>No</span></td>
		<td width="321" valign="top"><span>Descripcion</span></td>
		<td width="611" valign="top"><span>Num. Dias</span></td>
	</tr>
<?php
$nRecCount = 0;
$i = 0;
