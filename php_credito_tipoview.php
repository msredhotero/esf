...
//$x_credito_tipo_id = (get_magic_quotes_gpc()) ? stripslashes($x_credito_tipo_id) : $x_credito_tipo_id;
// Get action
...
<p><span class="phpmaker">View TABLE: PORTAFOLIO<br><br>
<a href="php_credito_tipolist.php">Back to List</a>&nbsp;
<a href="<?php if ($x_credito_tipo_id <> "") {echo "php_credito_tipoedit.php?credito_tipo_id=" . urlencode($x_credito_tipo_id); } else { echo "javascript:alert('Invalid Record! Key is null');";} ?>">Edit</a>&nbsp;
<a href="<?php if ($x_credito_tipo_id <> "") {echo "php_credito_tipoadd.php?credito_tipo_id=" . urlencode($x_credito_tipo_id); } else { echo "javascript:alert('Invalid Record! Key is null');";} ?>">Copy</a>&nbsp;
<a href="<?php if ($x_credito_tipo_id <> "") {echo "php_credito_tipodelete.php?credito_tipo_id=" . urlencode($x_credito_tipo_id); } else { echo "javascript:alert('Invalid Record! Key is null');";} ?>">Delete</a>&nbsp;
</span></p>
<p>
<form>
<table class="ewTable">
