...
if($_POST["x_fecha_desde_2"]){
	$_SESSION["x_fecha_desde_2"] = $_POST["x_fecha_desde_2"];
	$_SESSION["x_fecha_hasta_2"] = $_POST["x_fecha_hasta_2"];		
}else{
	if(empty($_SESSION["x_fecha_desde_2"])){
		$_SESSION["x_fecha_desde_2"] = $currdate;
		$_SESSION["x_fecha_hasta_2"] = $currdate;		
	}
}
...
if($_SESSION["x_fecha_desde_2"] != ""){
	$sDbWhere .= "(recibo.fecha_registro >= '".ConvertDateToMysqlFormat($_SESSION["x_fecha_desde_2"])."') AND ";
	$sDbWhere .= "(recibo.fecha_registro <= '".ConvertDateToMysqlFormat($_SESSION["x_fecha_hasta_2"])."') AND ";	
}
...
<table width="660" class="phpmaker">
	<tr>
	  <td width="95">credito num:</td>
	  <td width="49"><input name="x_credito_num_filtro" type="text" id="x_credito_num_filtro" value="<?php echo $_SESSION["x_credito_num_filtro"]; ?>" size="10" maxlength="10" /></td>
		<td width="44"></td>
...
?>
	...
	<tr>
	  <td>Fecha Pago</td>
	  <td>&nbsp;</td>
	  <td><div align="right"><span class="phpmaker">
		  Desde:
		  </span> </div></td>
	  <td width="122"><span>
	  ...
	  <td width="45"><div align="right"><span class="phpmaker">
		  Hasta:
		  </span> </div></td>
	  <td width="137"><span>
	  ...
	  <td width="39">&nbsp;</td>
	  <td width="93"><a href="php_recibolist.php?cmd=reset"></a></td>
	  </tr>
...
?>
    ...
    <td><strong><?php echo $x_total;?></strong></td>
    </tr>
<?php
