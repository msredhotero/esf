...
$x_comprobante_domicilio_1 = $row["comprobante_domicilio_1"];
$x_comprobante_domicilio_2 = $row["comprobante_domicilio_2"];
$x_comprobante_domicilio_3 = $row["comprobante_domicilio_3"];
$x_comprobante_domicilio_4 = $row["comprobante_domicilio_4"];
$x_comprobante_domicilio_5 = $row["comprobante_domicilio_5"];
...
<table width="697" border="0">
  <tr>
    <td height="20" class="ewTableHeaderThin">Comprobante de domicilio <?php echo $x_nombre_galeria; ?></td>
   </tr>
    <?php

	  if(!empty($x_comprobante_domicilio_1)){?>
  <tr background="images/headTUpload1.jpg">
    <td height="27"><a href="<?php echo ewUploadPath(0) .$x_comprobante_domicilio_1 ?>"  target="_blank">Comprobante domicilio 1</a></td>
    </tr><?php }?>
   
     <?php 
	 
	   if(!empty($x_comprobante_domicilio_2)){?>
  <tr background="images/headTUpload2.jpg">
    <td height="27"><a href="<?php echo ewUploadPath(0) .$x_comprobante_domicilio_2 ?>"  target="_blank">Comprobante domicilio 2 </a></td>
    </tr><?php }?>
    
     <?php
	   if(!empty($x_comprobante_domicilio_3)){?>
     <tr background="images/headTUpload1.jpg">
    <td height="27"><a href="<?php echo ewUploadPath(0) .$x_comprobante_domicilio_3 ?>"  target="_blank">Comprobante domicilio 3</a></td>
    </tr><?php }?>
    
   <?php if(!empty($x_comprobante_domicilio_4)){?>
  <tr background="images/headTUpload2.jpg">
    <td height="27"><a href="<?php echo ewUploadPath(0) .$x_comprobante_domicilio_4 ?>"  target="_blank">Comprobante domicilio 4</a></td>
    </tr><?php }?>
    
     <?php  if(!empty($x_comprobante_domicilio_5)){?>
     <tr background="images/headTUpload1.jpg">
    <td height="27"><a href="<?php echo ewUploadPath(0) .$x_comprobante_domicilio_5 ?>"  target="_blank">Comprobante domicilio 5</a></td>
    </tr><?php }?>
