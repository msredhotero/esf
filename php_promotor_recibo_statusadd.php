...
if (empty($x_promotor_recibo_status_id)) {
	$bCopy = false;
}
...
<p><span class="phpmaker">Add to TABLE: Status Recibos de Comision<br><br><a href="php_promotor_recibo_statuslist.php">Back to List</a></span></p>
<form name="promotor_recibo_statusadd" id="promotor_recibo_statusadd" action="php_promotor_recibo_statusadd.php" method="post" onSubmit="return EW_checkMyForm(this);">
<p>
...
function AddData($conn)
{
	...
	if ((@$x_promotor_recibo_status_id == "") || (is_null($x_promotor_recibo_status_id))) {
		...
		$sTmp =  (get_magic_quotes_gpc()) ? stripslashes($x_promotor_recibo_status_id) : $x_promotor_recibo_status_id;			
		$sWhereChk .= "(`promotor_recibo_status_id` = " . addslashes($sTmp) . ")";
	}
	if ($bCheckKey) {
	...
	$sSql = "INSERT INTO `promotor_recibo_status` (";
