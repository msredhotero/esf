...
if (empty($x_promotor_comision_status_id)) {
	$bCopy = false;
}
...
<p><span class="phpmaker">Add to TABLE: Status de Comisiones<br><br><a href="php_promotor_comision_statuslist.php">Back to List</a></span></p>
<form name="promotor_comision_statusadd" id="promotor_comision_statusadd" action="php_promotor_comision_statusadd.php" method="post" onSubmit="return EW_checkMyForm(this);">
<p>
...
function AddData($conn)
{
	...
	if ((@$x_promotor_comision_status_id == "") || (is_null($x_promotor_comision_status_id))) {
		...
		$sTmp =  (get_magic_quotes_gpc()) ? stripslashes($x_promotor_comision_status_id) : $x_promotor_comision_status_id;			
		$sWhereChk .= "(`promotor_comision_status_id` = " . addslashes($sTmp) . ")";
	}
	if ($bCheckKey) {
	...
	$sSql = "INSERT INTO `promotor_comision_status` (";
