...
<form name="parentesco_tipoadd" id="parentesco_tipoadd" action="php_parentesco_tipoadd.php" method="post" onSubmit="return EW_checkMyForm(this);">
<p>
...
function AddData($conn)
{
	...
	if ((@$x_parentesco_tipo_id == "") || (is_null($x_parentesco_tipo_id))) {
		...
		$sTmp =  (get_magic_quotes_gpc()) ? stripslashes($x_parentesco_tipo_id) : $x_parentesco_tipo_id;			
		$sWhereChk .= "(`parentesco_tipo_id` = " . addslashes($sTmp) . ")";
	}
	if ($bCheckKey) {
	...
	$sSql = "INSERT INTO `parentesco_tipo` (";
