...
function ArchivaRecibo(recibo_qr_id) 	
...

{
  ...
  if (xmlHttp.readyState == 4 || xmlHttp.readyState == 0)
  {
	...
	//tipo de solicitud 
	var url = "concilia_recibo.php?x_recibo_qr_id="+recibo_qr_id+"";	
...
function handleServerResponse() 
{
  ...
  if (xmlHttp.readyState == 4) 
  {
	...
	document.getElementById("capaReciboArchivado_"+recibo_qr_id+"").value = "";
	document.getElementById("capaReciboArchivado_"+recibo_qr_id+"").innerHTML=xmlHttp.responseText;
   } 
