...
while ($i < count($arRecKey)){
	...
	// Build the SQL
	$sDbWhere .= "`entidad_id`=" . $sRecKey . " AND ";
...
<form action="php_entidaddelete.php" method="post">
<p>
...
<table class="ewTable_small">
	<tr class="ewTableHeader">
		<td width="73" valign="top"><span>No</span></td>
		<td width="915" valign="top"><span>Nombre</span></td>
	</tr>
<?php
$nRecCount = 0;
$i = 0;
