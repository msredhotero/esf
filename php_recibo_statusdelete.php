...
while ($i < count($arRecKey)){
	...
	// Build the SQL
	$sDbWhere .= "`recibo_status_id`=" . $sRecKey . " AND ";
...
<p><span class="phpmaker">Delete from TABLE: Status de Recibos<br><br><a href="php_recibo_statuslist.php">Back to List</a></span></p>
<form action="php_recibo_statusdelete.php" method="post">
<p>
...
{
	global $x_recibo_status_id;
	$sSql = "Delete FROM `recibo_status`";
	$sSql .= " WHERE " . $sqlKey;
