...
if ($sExport == "excel") {
	...
	header('Content-Disposition: attachment; filename=reporte_tpcv.xls');
}
?>
<?php include ("db.php") ?>
...
<p><span class="phpmaker">REPORTE DE TASA PROMEDIO DE CARTERA VIGENTE
<?php if ($sExport == "") { ?>
&nbsp;&nbsp;<a href="php_rpt_tpcv.php?export=excel&x_fecha_desde=<?php echo FormatDateTime(@$x_fecha_desde,7); ?>&x_fecha_hasta=<?php echo FormatDateTime(@$x_fecha_hasta,7); ?>">Exportar a Excel</a><?php } ?>
</span></p>

<?php if ($sExport == "") { ?>
<p><span class="phpmaker">
<form action="php_rpt_tpcv.php" name="filtro" id="filtro" method="post">
