...
if(!empty($filter["x_tipo_srch"])){
	//echo "enra a filro sucursal";
		if((!empty($filter["x_tipo_srch"])) && ($filter["x_tipo_srch"] != "1000")){
			...
			foreach($solicitudes as $credito =>$solicitud){
				...
				$sqlDatosCliente = "SELECT cliente.cliente_id FROM cliente JOIN solicitud_cliente ON solicitud_cliente.cliente_id = cliente.cliente_id AND solicitud_cliente.solicitud_id = $solicitud ";
	...
	$_SESSION["ewmsg"] = "- MENSAJE ENVIADO -";
...
?>
<p><span class="phpmaker">Envio masivo de mensajes
  <?php if ($sExport == "") { ?><?php } ?>
</span></p>
<?php if ($sExport == "") { ?>
<p>
...
<table width="640" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
	  <td>Mensaje </td>
	  <td>&nbsp;</td>
	  <td><textarea name="x_mensaje" id="x_mensaje" cols="114" rows="1"> Escriba el mensaje aqui</textarea></td>
	  <td>&nbsp;</td>
	  <td>&nbsp;</td>
	  </tr>
	<tr>
