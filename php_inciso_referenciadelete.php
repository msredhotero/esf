...
while ($i < count($arRecKey)){
	...
	// Build the SQL
	$sDbWhere .= "`inciso_referencia`=" . $sRecKey . " AND ";
...
<p><span class="phpmaker">Delete from TABLE: inciso referencia<br><br><a href="php_inciso_referencialist.php">Back to List</a></span></p>
<form action="php_inciso_referenciadelete.php" method="post">
<p>
...
<table class="ewTable">
	<tr class="ewTableHeader">
		...
		<td valign="top"><span>Inciso</span></td>
...
{
	global $x_inciso_referencia;
	$sSql = "Delete FROM `inciso_referencia`";
	$sSql .= " WHERE " . $sqlKey;
