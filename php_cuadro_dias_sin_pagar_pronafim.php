...
if ($sExport == "excel") {
	...
	header('Content-Disposition: attachment; filename=cuadro_dias_sin_pagar_pronafim.xls');
}
?>
<?php include ("db.php") ?>
...
?>
  &nbsp;&nbsp;<a href="php_cuadro_dias_sin_pagar_pronafim.php?export=excel&x_credito_status=<?php echo $x_credito_status; ?>&x_sucursal_srch=<?php echo $_SESSION["x_sucursal_srch"]; ?>&x_promo_srch=<?php echo $_SESSION["x_promo_srch"];?>&x_gestor_srch=<?php echo $x_gestor_srch;?>">Exportar a Excel</a>
  <?php } ?>
    <?php } ?>
</span></p>
