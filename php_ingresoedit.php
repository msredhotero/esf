...
//if (!empty($x_ingreso_id )) $x_ingreso_id  = (get_magic_quotes_gpc()) ? stripslashes($x_ingreso_id ) : $x_ingreso_id ;
// Get action
...
<p><span class="phpmaker">Edit TABLE: ingreso<br><br><a href="php_ingresolist.php">Back to List</a></span></p>
<form name="ingresoedit" id="ingresoedit" action="php_ingresoedit.php" method="post" onSubmit="return EW_checkMyForm(this);">
<p>
...
<?php echo $x_ingreso_id; ?><input type="hidden" id="x_ingreso_id" name="x_ingreso_id" value="<?php echo htmlspecialchars(@$x_ingreso_id); ?>">
</span></td>
	</tr>
	<tr>
...
?>
	...
	<tr>
		...
		<td class="ewTableAltRow"><span>
<input type="text" name="x_ingresos_negocio" id="x_ingresos_negocio" size="30" value="<?php echo htmlspecialchars(@$x_ingresos_negocio) ?>">
</span></td>
	</tr>
	<tr>
		<td class="ewTableHeader"><span>Ingresos familiares 1</span></td>
		<td class="ewTableAltRow"><span>
<input type="text" name="x_ingresos_familiar_1" id="x_ingresos_familiar_1" size="30" value="<?php echo htmlspecialchars(@$x_ingresos_familiar_1) ?>">
</span></td>
	</tr>
	<tr>
...
?>
	...
	<tr>
		...
		<td class="ewTableAltRow"><span>
<input type="text" name="x_ingresos_familiar_2" id="x_ingresos_familiar_2" size="30" value="<?php echo htmlspecialchars(@$x_ingresos_familiar_2) ?>">
</span></td>
	</tr>
	<tr>
		<td class="ewTableHeader"><span>Parentesco</span></td>
...
?>
	...
	<tr>
		...
		<td class="ewTableAltRow"><span>
<input type="text" name="x_otros_ingresos" id="x_otros_ingresos" size="30" value="<?php echo htmlspecialchars(@$x_otros_ingresos) ?>">
</span></td>
	</tr>
</table>
<p>
