...
//echo "sDbWhereEncargado".$sDbWhereEncargado."<br>";
					...
					$x_link_print = "";
					 ...
					 if($x_formato_nuevo == 1){
						 ...
						 if($x_formato_nuevo == 1){
								...
								$x_link_view = "modulos/php_solicitudviewPyme.php";
...
if(($_SESSION["php_project_esf_status_UserRolID"] == 1) || ($_SESSION["php_project_esf_status_UserRolID"] == 2) || ($_SESSION["php_project_esf_status_UserRolID"] == 12)){?>
<td>
<?php if (($_SESSION["php_project_esf_status_UserRolID"] == 12)){
...
<?php if(($x_solicitud_status_id == 6) && (($_SESSION["php_project_esf_status_UserRolID"] == 1) || ($_SESSION["php_project_esf_status_UserRolID"] == 2) || ($_SESSION["php_project_esf_status_UserRolID"] == 12) || ($_SESSION["php_project_esf_status_UserRolID"] == 7))) {?>
...
<?php if(($x_solicitud_status_id == 10) && (($_SESSION["php_project_esf_status_UserRolID"] == 1) || ($_SESSION["php_project_esf_status_UserRolID"] == 2))){  if ($x_dia_otorga_credito <= $today){?>
<td style="color:#F00"><span class="phpmaker"><a href="<?php if ($x_solicitud_id <> "") {echo "php_creditoadd.php?x_solicitud_id=" . urlencode($x_solicitud_id); } else { echo "javascript:alert('Invalid Record! Key is null');";} ?>" target="_self">Otrogar Cr&eacute;dito</a></span> <?php echo "\n".FormatDateTime($x_dia_otorga_credito,7);?></td>
<?php }else{?>
	<td style="color:#999999"><span class="phpmaker"><a href="<?php if ($x_solicitud_id <> "") {echo "php_creditoadd.php?x_solicitud_id=" . urlencode($x_solicitud_id); } else { echo "javascript:alert('Invalid Record! Key is null');";} ?>" target="_self">Otrogar Cr&eacute;dito</a></span> <?php echo "\n".FormatDateTime($x_dia_otorga_credito,7);?></td>
<?php	}?>
<?php }else{ ?>
<td><span class="phpmaker">&nbsp;</span></td>
<?php } ?>
...
<?php if(($x_solicitud_status_id == 3) && (($_SESSION["php_project_esf_status_UserRolID"] == 1) || ($_SESSION["php_project_esf_status_UserRolID"] == 2))) {?>
<br /><br />
