...
<br />
<p>&nbsp;</p>
<span class="phpmaker" style="color:#F00"> Para descargar el archivo</span> <span class="phpmaker" style="color:#F00"> <?php echo "LISTADO_NOTAS_$x_todayy.txt";?> </span><span class="phpmaker" style="color:#F00">  use la liga al final de la tabla.</span><br />
<p>&nbsp;</p>
...
$file=fopen("LISTADO_NOTAS_$x_todayy.txt","w+") or die("Problemas");
$x_contador = 1;
