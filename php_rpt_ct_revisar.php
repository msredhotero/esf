...
#echo $sSql;
	...
	$x_interes_devengado_no_pagado = $row["interes_devengado_no_pagado"];
	$x_credito_id_c = $row["credito_id"];
	$x_fecha_ven_c  = $row["fecha_ven"];
	$x_vencimiento_id_c = $row["vencimiento_id"];
