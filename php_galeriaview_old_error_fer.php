...
<table width="697" border="0">
  ...
  <tr background="images/headTUpload2.jpg">
    <td height="27"><a href="php_galeriaview_foto.php?x_galeria_fotografica_id=<?php echo $x_galeria_fotografica_id;?>" target="_blank">Fotograf&iacute;a Personal </a></td>
    </tr><?php }?>
    
     <?php
	   if($x_liga_domicilio == 1){?>
     <tr background="images/headTUpload1.jpg">
    <td height="27"><a href="php_galeriaview_domicilio.php?x_galeria_fotografica_id=<?php echo $x_galeria_fotografica_id;?>" target="_blank">Domicilio</a></td>
    </tr><?php }?>
  ...
  <tr background="images/headTUpload2.jpg">
    <td height="27"><a href="php_galeriaview_comp_dom.php?x_galeria_fotografica_id=<?php echo $x_galeria_fotografica_id;?>" target="_blank">Comprobante Domicilio</a></td>
     ...
     <tr background="images/headTUpload1.jpg">
    <td height="27"><a href="php_galeriaview_comp_prop.php?x_galeria_fotografica_id=<?php echo $x_galeria_fotografica_id;?>" target="_blank">Comprobante Propiedad</a></td>
    </tr><?php }?>
    
     <?php  if($x_liga_negocio == 1){?>
  <tr background="images/headTUpload2.jpg">
    <td height="27"><a href="php_galeriaview_negocio.php?x_galeria_fotografica_id=<?php echo $x_galeria_fotografica_id;?>" target="_blank">Negocio</a></td>
    </tr><?php }?>
