...
<b>N�mero de pago o vencimiento</b>
...
<b>Inter�s ordinario pagado en cada vencimiento</b>
...
while ($row = @phpmkr_fetch_array($rs)) {
	...
	if ($nRecCount >= $nStartRec) {
		...
		$x_fecha_vto= $x_fecha_vencimiento_tab; // tu sabr�s como la obtienes, solo asegurate que tenga este formato

		//$dias= 2; // los d�as a restar
