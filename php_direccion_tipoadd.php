...
<p><span class="phpmaker">Add to TABLE: TIPOS DE DIRECCION<br><br><a href="php_direccion_tipolist.php">Back to List</a></span></p>
<form name="direccion_tipoadd" id="direccion_tipoadd" action="php_direccion_tipoadd.php" method="post" onSubmit="return EW_checkMyForm(this);">
<p>
...
function AddData($conn)
{
	...
	if ((@$x_direccion_tipo_id == "") || (is_null($x_direccion_tipo_id))) {
		...
		$sTmp =  (get_magic_quotes_gpc()) ? stripslashes($x_direccion_tipo_id) : $x_direccion_tipo_id;			
		$sWhereChk .= "(`direccion_tipo_id` = " . addslashes($sTmp) . ")";
	}
	if ($bCheckKey) {
	...
	$sSql = "INSERT INTO `direccion_tipo` (";
