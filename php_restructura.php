...
?>
<?php if ($nTotalRecs > 0)  { ?>
<form method="post" name="principal" action="php_restructura.php">
...
<tr>
<td>
<input type="button" name="cancelar" value="Cancelar" onclick="javascript: window.location = 'php_vencimientolist.php?credito_id=<?php echo $x_credito_id; ?>';"  /></td>
<td>
<input type="button" name="aplicar" value="Aplicar restructura" onclick="javascript: document.principal.submit();" /></td>
</tr>
<tr>
  <td><a href="php_vencimientoadd.php?credito_id=<?php echo $x_credito_id; ?>" target="_self">Agregar Vencmiento</a></td>
  <td>&nbsp;</td>
</tr>
</table>
<br />
...
<?php $x_vencimiento_status_id = $ox_vencimiento_status_id; // Restore Original Value ?>
        ...
        ?>
        <a href="php_vencimientodelete.php?credito_id=<?php echo $x_credito_id; ?>&vencimiento_id=<?php echo $x_vencimiento_id; ?>" target="_self">Eliminar</a>
		<?php 
		}
        ?>
