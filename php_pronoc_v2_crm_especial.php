...
where credito.credito_status_id in (1,4) and vencimiento.fecha_vencimiento < '$currdate' and vencimiento.vencimiento_status_id in (1,3,6) and credito.credito_id in (6301) order by vencimiento.fecha_vencimiento";
...
//seleccionamo la fecha de otorgamiento del credito
	...
	echo "fecha promesa de pago" .$x_fecha_promesa_pago_c3_pp_u."<br>";
...
$x_comision_generada = 0;
	...
	if(($x_carta_1 > 0) &&($x_comision_generada < 1)){
		...
		#verificamos que no tenga ninguna PP con status de pendiente;
			...
			echo "ENTRA AL CICLO PP CARTA 1 ";
...
#	echo "TAREAS ASIGNADAS ".$x_tareas_asignadas_del_caso."<br>";
	...
	if((($x_comision_generada + 0) > 0) && ($x_carta_2 == 0)){
		...
		echo "<BR> ENTRA A PROCESO GENERA CARATA 2 <BR>";
