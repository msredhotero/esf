...
//if (!empty($x_movimiento_cont_id )) $x_movimiento_cont_id  = (get_magic_quotes_gpc()) ? stripslashes($x_movimiento_cont_id ) : $x_movimiento_cont_id ;
// Get action
...
<p><span class="phpmaker">Edit TABLE: Contabilidad Movimientos<br><br><a href="php_movimiento_contlist.php">Back to List</a></span></p>
<form name="movimiento_contedit" id="movimiento_contedit" action="php_movimiento_contedit.php" method="post" onSubmit="return EW_checkMyForm(this);">
<p>
...
<?php echo $x_movimiento_cont_id; ?><input type="hidden" id="x_movimiento_cont_id" name="x_movimiento_cont_id" value="<?php echo htmlspecialchars(@$x_movimiento_cont_id); ?>">
</span></td>
	</tr>
	<tr>
...
function EditData($conn)
{
	...
	if (phpmkr_num_rows($rs) == 0) {
		...
		// update
		$sSql = "UPDATE `movimiento_cont` SET ";
