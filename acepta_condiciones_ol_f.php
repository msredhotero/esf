...
if($x_credito_id > 0) {
		...
		$sql  = "UPDATE `credito_condiciones` SET status = 1 WHERE credito_id= $x_credito_id";
		$rsv = phpmkr_query($sql, $conn) or die("Error al seleccin".phpmkr_error()."sql :".$sql);
			...
			$x_result .= "CONDICIONES DE CR&Eacute;DITO ACEPTADAS USTED NO PODRA EDITAR ESTE CR&Eacute;DITO";
