...
?>
  ...
  <tr>
    ...
    <tr>
      <td width="71" class="texto_normal" >Titular</td>
     ...
     <tr>
      ...
      <td width="80"><label>
       ...
       <td width="148">Lugar de nacimiento</td>
      <td width="185" colspan="5"><?php
    ...
    <tr>
      ...
      <td width="48">CURP</td>
      <td width="80"><div id="txtHintcurp"><input type="text" name="x_curp" id="x_curp" size="20" maxlength="150" value="<?php echo htmlentities(@$x_curp) ?>" /></div></td>
...
echo $x_delegacion_idList;
    ...
    <tr>
      ...
      <td width="105"><?php if(!empty($x_telefono_domicilio)){?><input type="text" name="x_telefono_domicilio" id="x_telefono_domicilio"  value="<?php echo htmlspecialchars(@$x_telefono_domicilio) ?>" maxlength="50" size="25"/><?php } ?></td>
      <td width="63"><?php if(!empty( $x_otro_tel_domicilio_1)){?>Otro Tel<?php }?></td>
      <td colspan="2"><?php if(!empty($x_otro_tel_domicilio_1 )){?><input type="text" name="x_otro_tel_domicilio_1" id="x_otro_tel_domicilio_1"  value="<?php echo htmlspecialchars(@$x_otro_tel_domicilio_1) ?>" maxlength="50" size="25"/><?php }?></td>
      <td>Renta Mensual</td>
    ...
    <tr>
      ...
      <td><?php if(!empty($x_celular)){?><input type="text" name="x_celular" id="x_celular" value="<?php echo $x_celular;?>"  maxlength="10" size="25"/><?php } ?></td>
    ...
    <tr>
      ...
      <td><?php if(!empty($x_otro_telefono_domicilio_2)){?><input type="text" name="x_otro_telefono_domicilio_2" id="x_otro_telefono_domicilio_2"  value="<?php echo $x_otro_telefono_domicilio_2;?>" maxlength="50" size="25"/><?php }?></td>
  ...
  <tr>
    ...
    <tr>
      <td height="36" colspan="2"><table width="250"><tr>
        <td width="48">1.-</td>
        <td width="276"><input type="text" name="x_referencia_com_1" id="x_referencia_com_1" value="<?php echo htmlspecialchars(@$x_referencia_com_1) ?>"  maxlength="250" size="60"/></td></tr></table></td>
    ...
    <tr>
      <td colspan="2"><table width="250"><tr>
        <td width="48">2.-</td>
        <td width="277"><input type="text" name="x_referencia_com_2" id="x_referencia_com_2"  value="<?php echo htmlspecialchars(@$x_referencia_com_2) ?>" maxlength="250" size="60"/></td></tr></table></td>
    ...
    <tr>
      <td colspan="2"><table width="250"><tr>
        <td width="48">3.-</td>
      <td width="276"><input type="text" name="x_referencia_com_3" id="x_referencia_com_3"  value="<?php echo htmlspecialchars(@$x_referencia_com_3) ?>" maxlength="250" size="60"/></td></tr></table></td>
    ...
    <tr>
      <td colspan="2"><table width="250"><tr>
        <td width="48">4.-</td>
      <td width="276"><input type="text" name="x_referencia_com_4" id="x_referencia_com_4"  value="<?php echo htmlspecialchars(@$x_referencia_com_4) ?>" maxlength="250" size="60"/></td></tr></table></td>
     <td colspan="2"><table width="160"><tr>
        <td width="17">Tel</td>
   ...
   <tr>
    <td>&nbsp;   </td>
    <td>&nbsp;   </td>
    <td colspan="6" align="center"><textarea cols="100" rows="5" name="x_resultado_visita_pro_th" id=""><?php echo $x_resultado_visita_pro_th; ?> </textarea></td>
    <td>&nbsp;   </td>
    <td>&nbsp;   </td>
    <td>&nbsp;   </td>
   </tr>
   ...
   <tr>
    <td>&nbsp;   </td>
    <td>&nbsp;   </td>
    <td colspan="6" align="center"><textarea cols="100" rows="5" name="x_resultado_visita_pro_aval" id=""><?php echo $x_resultado_visita_pro_aval; ?> </textarea></td>
    <td>&nbsp;   </td>
    <td>&nbsp;   </td>
    <td>&nbsp;   </td>
   </tr>
   ...
   <tr>
    <td>&nbsp;   </td>
    <td>&nbsp;   </td>
    <td colspan="6" align="center"><textarea cols="100" rows="5" name="x_resultado_visita_sup_th" id=""><?php echo $x_resultado_visita_sup_th; ?></textarea></td>
    <td>&nbsp;   </td>
    <td>&nbsp;   </td>
    <td>&nbsp;   </td>
   </tr>
   ...
   <tr>
    <td>&nbsp;   </td>
    <td>&nbsp;   </td>
    <td colspan="6" align="center"><textarea cols="100" rows="5" name="x_resultado_visita_sup_aval" id=""><?php echo $x_resultado_visita_sup_aval;?> </textarea></td>
    <td>&nbsp;   </td>
    <td>&nbsp;   </td>
    <td>&nbsp;   </td>
   </tr>
...
<?php if(($_SESSION["php_project_esf_status_UserRolID"] == 1) || ($_SESSION["php_project_esf_status_UserRolID"] == 2) || ($_SESSION["php_project_esf_status_UserRolID"] == 3) ||($_SESSION["php_project_esf_status_UserRolID"] == 7)){ ?>
 ...
 <input name="Action2" type="button"class="boton_medium" value="Editar1" <?php if(!empty($GLOBALS["x_editar"])){?>disabled="disabled"<?php }?> onclick="EW_checkMyForm();" /><?php } else { ?>
 <input name="Action3" disabled="disabled" type="button" class="boton_medium" value="Editar2"  /><?php }
 }else {?>
