...
?>
  ...
  <tr>
    ...
    <tr>
      ...
      <td colspan="10"><input type="text" name="x_giro_negocio" id="x_giro_negocio" size="80" value="<?php echo htmlspecialchars(@$x_giro_negocio) ?>"></td>
    </tr>
    <tr>
      <td>Giro Negocio</td>
      <td colspan="4"> <?php
    ...
    <tr>
      ...
      <td colspan="5"><input type="text" name="x_antiguedad_ubicacion" id="x_antiguedad_ubicacion"  maxlength="50" size="20" onKeyPress="return solonumeros(this,event)" value="<?php echo $x_antiguedad_ubicacion ?>"/></td>
    </tr>
...
<table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <tr>
          <td colspan="19"  align="center" valign="top" bgcolor="#FFE6E6" class="texto_normal_bold">&nbsp;</td>
        </tr>
        <tr>
          <td colspan="19" id="tableHead2"><p></p></td>
        </tr>
        ...
        <tr><br />
          <br />
          <td  colspan="19" id="declaracione" ><p>&nbsp;</p></td>
        </tr>
        <tr>
...
<table align="center">
<tr><td> <input name="button" type="button" class="boton_medium" onclick="window.open('/esf/modulos/tipoCuenta/formatos/php_solicitudPYME_print.php?solicitud_id=<?php echo $x_solicitud_id; ?>','Solicitud','width=700,height=500,left=150,top=150,scrollbars=yes');" value="Imprimir" /></td></tr>
</table>
</form>
</body>
</html>
...
function EditData($conn){
	...
	if (phpmkr_num_rows($rs) == 0) {
		...
		if($GLOBALS["x_garantia_id"] != ""){
			...
			//echo "valor descripcion = ". $GLOBALS["x_garantia_desc"]."-";
			//echo "vlor garantia =".$GLOBALS["x_garantia_valor"]."-";
	...
	$fieldList = NULL;
		...
		$theValue = ($GLOBALS["x_antiguedad_ubicacion"] != "") ? " '" . doubleval($GLOBALS["x_antiguedad_ubicacion"]). "'" : "NULL";
