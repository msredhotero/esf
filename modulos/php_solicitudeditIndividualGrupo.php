...
?>
  ...
  <tr>
   ...
   <td colspan="3"  align="left" valign="top"class="texto_normal_bold"><iframe name="aval" src="php_visor_galeria_cliente.php?key=<?php echo $x_solicitud_id;?>" scrolling="no" style="margin-left:0px; width:150px; height:35px; margin-top:-5px" frameborder="0" allowtransparency="true" id="contenido"></iframe><iframe name="aval" src="php_visor_galeria_aval.php?key=<?php echo $x_solicitud_id;?>" scrolling="no" style="margin-left:0px; width:150px; height:35px; margin-top:-5px" frameborder="0" allowtransparency="true" id="contenido"></iframe></td>
  <tr>
...
<tr>
  ...
  <tr>
    <td>&nbsp;</td>
    <td><div align="center"><?php if(($_SESSION["php_project_esf_status_UserRolID"] == 1) || ($_SESSION["php_project_esf_status_UserRolID"] == 2) || ($_SESSION["php_project_esf_status_UserRolID"] == 3) ||($_SESSION["php_project_esf_status_UserRolID"] == 7)){ ?>
