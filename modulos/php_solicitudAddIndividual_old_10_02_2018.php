...
if (validada == true && EW_this.x_destino_credito_id && !EW_hasValue(EW_this.x_destino_credito_id, "SELECT" )) {
	if (!EW_onError(EW_this, EW_this.x_destino_credito_id, "SELECT", "Por favor indique el destino del credito"))
		validada = false;
}
*//*
if (validada == true && EW_this.x_ppe && !EW_hasValue(EW_this.x_ppe, "SELECT" )) {
...
if (Evalidada == true && W_this.x_parentesco_ppe && !EW_hasValue(EW_this.x_parentesco_ppe, "SELECT" )) {
	if (!EW_onError(EW_this, EW_this.x_parentesco_ppe, "SELECT", "Por favor indique la relacion en la seccion PPE "))
		validada = false;
}	
	
if (validada == true && EW_this.x_nombre_ppe && !EW_hasValue(EW_this.x_nombre_ppe, "TEXT" )) {
	if (!EW_onError(EW_this, EW_this.x_nombre_ppe, "TEXT", "Por indique el nombre de la seccion PPE"))
		validada = false;
}	

if (validada == true && EW_this.x_apellido_paterno_ppe && !EW_hasValue(EW_this.x_apellido_paterno_ppe, "TEXT" )) {
...
if (validada == true && EW_this.x_codigo_postal_domicilio && !EW_checkinteger(EW_this.x_codigo_postal_domicilio.value)) {
...
if (validada == true && EW_this.x_ubicacion_domicilio && !EW_hasValue(EW_this.x_ubicacion_domicilio, "TEXT" )) {
	if (!EW_onError(EW_this, EW_this.x_ubicacion_domicilio, "TEXT", "Por favor introduzca el campo requerido - ubicacion domicilio"))
		validada = false;
}
if (validada == true && EW_this.x_tipo_vivienda && !EW_hasValue(EW_this.x_tipo_vivienda, "TEXT" )) {
	if (!EW_onError(EW_this, EW_this.x_tipo_vivienda, "TEXT", "Por favor introduzca el campo requerido - tipo vivienda"))
		validada = false;
}
if (validada == true && EW_this.x_renta_mensula_domicilio && !EW_checknumber(EW_this.x_renta_mensula_domicilio.value)) {
...
/*if (validada == true && EW_this.x_giro_negocio_id && !EW_hasValue(EW_this.x_giro_negocio_id, "SELECT" )) {
	if (!EW_onError(EW_this, EW_this.x_giro_negocio_id, "SELECT", "Por debe seleccionar un valor para el campo giro negocio"))
		validada = false;
}

if (validada == true && EW_this.x_tipo_inmueble_id && !EW_hasValue(EW_this.x_tipo_inmueble_id, "SELECT" )) {
	if (!EW_onError(EW_this, EW_this.x_tipo_inmueble_id, "SELECT", "Por debe seleccionar un valor para el campo tipo negocio"))
		validada = false;
}
if (validada == true && EW_this.x_atiende_titular && !EW_hasValue(EW_this.x_atiende_titular, "SELECT" )) {
	if (!EW_onError(EW_this, EW_this.x_atiende_titular, "SELECT", "Por debe seleccionar un valor para el campo atiende titular"))
		validada = false;
}
if (validada == true && EW_this.x_personas_trabajando && !EW_hasValue(EW_this.x_personas_trabajando, "TEXT" )) {
...
if (validada == true && EW_this.x_personas_trabajando && !EW_checkinteger(EW_this.x_personas_trabajando.value)) {
	if (!EW_onError(EW_this, EW_this.x_personas_trabajando, "TEXT", "Valor incorrecto, se espera un entero. - personas trabajando"))
		validada = false; 
}


if (validada == true && EW_this.x_ingreso_semanal && !EW_hasValue(EW_this.x_ingreso_semanal, "TEXT" )) {
...
?></td>
      ...
      <tr>
        ...
        <td width="111" colspan="2"><div align="left">
          ...
          <span class="texto_normal">
          <input type="text" name="x_plazo_id" id="x_plazo_idS"  value="<?php echo $x_plazo_id;?>" maxlength="3" size="15" onkeypress="return solonumeros(this,event)" onchange="valorMax();" <?php echo $x_readonly;?> />
...
<table align="center">
<tr><td>
<input name="Action2" type="button"class="boton_medium" value="Agregar Solicitud" onclick="EW_checkMyForm();" /><?php ?></td></tr>
</table>
</form>
</body>
</html>
...
$x_mensaje = "FINANCIERA CREA: SU SOLICITUS HA SIDO RECIBIDA POR EL AREA DE ANALISIS DE MANERA EXITOSA TEL.(55) 51350259";	
...
$para  = 'sms@financieracrea.com'; // atención a la coma
 ...
 $sqlInsertsms =  "INSERT INTO `sms_enviados` (`id_sms_enviado`, `id_tipo_mensaje`, `contenido`, `no_credito`, `no_celular`, `fecha_registro`, `tipo_envio`, `destino`) VALUES (NULL, '17','" .$x_mensaje."', '0', '".$x_no_celular."', '".$x_fecha."', '1', '1')";
