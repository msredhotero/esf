...
<input type="hidden" name="temp_x_monto_solicitado" id="temp_x_monto_solicitado" value="<?php echo $x_monto_solicitado?>" />
...
?>
      ...
      <tr>
        ...
        <td><input type="text" name="x_monto_maximo_aprobado" value="<?php echo $x_monto_maximo_aprobado;?>"  onchange="muestraMontoSolicitado();" /> </td>
        <td>&nbsp;</td>
      ...
      <tr>
        ...
        <td><input type="text" name="x_monto_solicitado" id="x_monto_solicitado" value="<?php if ($x_solicitud_status_id < 2 and $_SESSION["php_project_esf_status_UserRolID"] != 2 ){echo "----";}else{ echo $x_monto_solicitado?>" /></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
