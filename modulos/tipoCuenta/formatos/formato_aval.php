...
<p>&nbsp;</p>
<form name="datos_avaladd" id="datos_avaladd" action="formato_aval.php" method="post" onSubmit="return EW_checkMyForm(this);">
<p>
  ...
  <td><table width="91%">
    ...
    <tr>
      ...
      <td colspan="8" align="center"><table width="98%">
        <tr>
          <td><input type="text" name="x_nombre_completo" id="x_nombre_completo"  maxlength="250" size="35"/></td>
    ...
    <tr>
      ...
      <td colspan="6"><span class="phpmaker">
        <input type="text" name="x_correo_electronico" id="x_correo_electronico"  />
      </span></td>
    </tr>
    <tr>
      <td>Esposo(a)</td>
      <td colspan="10"><input type="text" name="x_nombre_conyuge" id="x_nombre_conyuge"  maxlength="250" size="100"/></td>
    </tr>
    <tr>
      <td colspan="11" id="tableHead"></td>
    </tr>
    ...
    <tr>
      <td>Calle</td>
      <td colspan="10"><input type="text" name="x_calle" id="x_calle"  maxlength="100" size="100"/></td>
    </tr>
    <tr>
      <td>Colonia</td>
      <td colspan="4"><input type="text" name="x_colonia" id="x_colonia"  maxlength="100" size="50"/></td>
      <td>C&oacute;digo Postal</td>
      <td colspan="5"><input type="text" name="x_codigo_postal" id="x_codigo_postal"  maxlength="10" size="20" onKeyPress="return solonumeros(this,event)"/></td>
    </tr>
    <tr>
      <td>Entidad</td>
    ...
    <tr>
      <td>Ubicacion</td>
      <td colspan="10"><input type="text" name="x_ubicacion" id="x_ubicacion"  maxlength="250" size="50"/></td>
    </tr>
    <tr>
      <td>Tipo Vivienda</td>
      <td colspan="4">
      ...
      <td>Antiguedad</td>
      <td colspan="5"><input type="text" name="x_antiguedad_v" id="x_antiguedad_v"  maxlength="10" size="20"/></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td colspan="4">&nbsp;</td>
      <td>Tel Arrendatario</td>
      <td colspan="5"><input type="text" name="x_tel_arrendatario_v" id="x_tel_arrendatario_v"  maxlength="20" size="20"/></td>
    </tr>
    <tr>
      <td height="24">Tel Domicilio</td>
      <td width="133"><input type="text" name="x_telefono_p" id="x_telefono_p"  maxlength="50" size="25"/></td>
      <td width="76">Otro Tel</td>
      <td colspan="2"><input type="text" name="x_telefono_o" id="x_telefono_o"  maxlength="50" size="25"/></td>
      <td>Renta Mensual</td>
      <td colspan="5"><input type="text" name="x_renta_mensual_v" id="x_renta_mensual_v"  maxlength="25" size="20" onKeyPress="return solonumeros(this,event)"/></td>
    </tr>
    <tr>
      <td>Celular</td>
      <td><input type="text" name="x_telefono_c" id="x_telefono_c"  maxlength="50" size="25"/></td>
      <td>&nbsp;</td>
      <td colspan="2"></td>
      <td colspan="6">&nbsp;</td>
    </tr>
    ...
    <tr>
      <td>Calle</td>
      <td colspan="10"><input type="text" name="x_calle_2" id="x_calle_2"  maxlength="250" size="100"/></td>
    </tr>
    <tr>
      <td>Colonia</td>
      <td colspan="4"><input type="text" name="x_colonia_2" id="x_colonia_2"  maxlength="250" size="70"/></td>
      <td><p>C&oacute;digo Postal</p></td>
      <td colspan="5"><input type="text" name="x_codigo_postal_2" id="x_codigo_postal_2"  maxlength="25" size="20" onKeyPress="return solonumeros(this,event)"/></td>
    </tr>
    <tr>
      <td>Entidad</td>
    ...
    <tr>
      <td>Ubicacion</td>
      <td colspan="10"><input type="text" name="x_ubicacion_2" id="x_ubicacion_2"  maxlength="250" size="100"/></td>
    </tr>
    <tr>
      <td>Tipo Local</td>
      <td colspan="4">
      ...
      <td colspan="5"><input type="text" name="x_antiguedad_n" id="x_antiguedad_n"  maxlength="10" size="20"/></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td colspan="4">&nbsp;</td>
      <td>Tel. Arrendatario</td>
      <td colspan="5"><input type="text" name="x_tel_arrendatario_n" id="x_tel_arrendatario_n"  maxlength="20" size="20"/></td>
    </tr>
    <tr>
      <td>Tel Negocio</td>
      <td colspan="4"><input type="text" name="x_telefono_p_2" id="x_telefono_p_2"  maxlength="50" size="25"/></td>
      <td>Renta Mensual</td>
      <td colspan="5"><input type="text" name="x_renta_mesual_n" id="renta_mesual_n"  maxlength="50" size="20" onKeyPress="return solonumeros(this,event)"/></td>
    </tr>
      <tr>
      <td colspan="11" id="tableHead"><p></td>
    </tr>
    ...
    <tr>
      <td colspan="11"><center><textarea cols="80" rows="4" id="x_garantia_desc" name="x_garantia_desc"></textarea></center></td>
    </tr>
    <tr>
  ...
  <tr>
    ...
    <tr>
      <td height="36" colspan="2"><table width="300"><tr>
        <td width="48">1.-</td>
        <td width="276"><input type="text" name="x_referencia_1" id="x_referencia_com_1"  maxlength="250" size="40"/></td></tr></table></td>
      <td colspan="2"><table width="160" height="29"><tr>
        <td width="36">Tel</td>
        <td width="137"><input type="text" name="x_telefono_ref_1" id="x_telefono_ref_1"  maxlength="20" size="30"/></td></tr></table></td>
    ...
    <tr>
      <td colspan="2"><table width="300"><tr>
        <td width="48">2.-</td>
        <td width="277"><input type="text" name="x_referencia_2" id="x_referencia_2"  maxlength="250" size="40"/></td></tr></table></td>
      <td colspan="2"><table width="160"><tr>
        <td width="36">Tel</td>
        <td width="137"><input type="text" name="x_telefono_ref_2" id="x_telefono_ref_2"  maxlength="20" size="30"/></td></tr></table></td>
      <td>Parentesco</td>
      <td colspan="6">
       <?php
    ...
    <tr>
      <td colspan="2"><table width="300"><tr>
        <td width="48">3.-</td>
        <td width="276"><input type="text" name="x_referencia_3" id="x_referencia_3"  maxlength="250" size="40"/></td></tr></table></td>
      <td colspan="2"><table width="183"><tr>
        <td width="34">Tel</td>
        <td width="137"><input type="text" name="x_telefono_ref_3" id="x_telefono_ref_3"  maxlength="20" size="30"/></td></tr></table></td>
      <td>Parentesco</td>
      <td colspan="6">
      <?php
    ...
    <tr>
      <td colspan="2"><table width="300"><tr>
        <td width="48">4.-</td>
        <td width="276"><input type="text" name="x_referencia_4" id="x_referencia_4"  maxlength="250" size="40"/></td></tr></table></td>
     <td colspan="2"><table width="160"><tr>
        <td width="35">Tel</td>
        <td width="137"><input type="text" name="x_telefono_ref_4" id="x_telefono_ref_4"  maxlength="20" size="30"/></td></tr></table></td>
      <td>Parentesco</td>
      <td colspan="6">
      <?php
...
<tr>
  <td height="748"><table width="90%" >
    ...
    <tr>
      ...
      <td colspan="4"><input type="text" name="x_ing_fam_negocio" id="x_ing_fam_negocio"  maxlength="30" size="35" onKeyPress="return solonumeros(this,event)"/></td>
      <td colspan="2">&nbsp;</td>
      <td width="76">&nbsp;</td>
      <td width="52">&nbsp;</td>
      <td width="69">&nbsp;</td>
    ...
    <tr>
      ...
      <td colspan="4"><input type="text" name="x_ing_fam_otro_th" id="x_ing_fam_otro_th"  maxlength="30" size="35"onKeyPress="return solonumeros(this,event)"/></td>
      <td colspan="2">Cu&aacute;l</td>
      <td colspan="4"><input type="text" name="x_ing_fam_cuales_1" id="x_ing_fam_cuales_1"  maxlength="250" size="35"/></td>
      <td width="127">&nbsp;</td>
      <td colspan="10">&nbsp;</td>
    </tr>
     <tr>
      <td width="147">Ingreso Familiar 1</td>
      <td colspan="4"><input type="text" name="x_ing_fam_1" id="x_ing_fam_1"  maxlength="30" size="35" onKeyPress="return solonumeros(this,event)"/></td>
      <td colspan="2">Cu&aacute;l</td>
      <td colspan="4"><input type="text" name="x_ing_fam_cuales_2" id="x_ing_fam_cuales_2"  maxlength="250" size="35"/></td>
      <td width="127">&nbsp;</td>
      <td colspan="10">&nbsp;</td>
    </tr>
     <tr>
      <td width="147">Ingreso Familiar 2</td>
      <td colspan="4"><input type="text" name="x_ing_fam_2" id="x_ing_fam_2"  maxlength="30" size="35" onKeyPress="return solonumeros(this,event)"/></td>
      <td colspan="2">Cu&aacute;l</td>
      <td colspan="4"><input type="text" name="x_ing_fam_cuales_13" id="x_ing_fam_cuales_13"  maxlength="250" size="35"/></td>
      <td width="127">&nbsp;</td>
      <td colspan="10">&nbsp;</td>
    </tr>
     <tr>
      <td width="147">Deuda 1</td>
      <td colspan="4"><input type="text" name="x_ing_fam_deuda_1" id="x_ing_fam_deuda_1"  maxlength="30" size="35" onKeyPress="return solonumeros(this,event)"/></td>
      <td colspan="2">Cu&aacute;l</td>
      <td colspan="4"><input type="text" name="x_ing_fam_cuales_4" id="x_ing_fam_cuales_4"  maxlength="250" size="35"/></td>
      <td width="127">&nbsp;</td>
      <td colspan="10">&nbsp;</td>
    </tr>
     <tr>
      <td width="147">Deuda 2</td>
      <td colspan="4"><input type="text" name="x_ing_fam_deuda_2" id="x_ing_fam_deuda_2"  maxlength="30" size="35" onKeyPress="return solonumeros(this,event)"/></td>
      <td colspan="2">Cu&aacute;l</td>
      <td colspan="4"><input type="text" name="x_ing_fam_cuales_5" id="x_ing_fam_cuales_5"  maxlength="250" size="35"/></td>
      <td width="127">&nbsp;</td>
      <td colspan="10">&nbsp;</td>
    </tr>
     <tr>
      <td width="147">Total</td>
      <td colspan="4"><input type="text" name="x_ing_fam_total" id="x_ing_fam_total"  maxlength="30" size="35" onKeyPress="return solonumeros(this,event)"/></td>
      <td colspan="2">&nbsp;</td>
      <td width="76">&nbsp;</td>
      <td width="52">&nbsp;</td>
      <td width="69">&nbsp;</td>
...
function LoadData($sKey,$conn)
{
	...
	$sSql .= " WHERE `datos_aval_id` = " . $sKeyWrk;
	$sGroupBy = "";
	$sHaving = "";
	$sOrderBy = "";
	if ($sGroupBy <> "") {
	...
	if (phpmkr_num_rows($rs) == 0) {
		...
		$GLOBALS["x_giro_negocio"] = $row["x_giro_negocio"];
		$GLOBALS["x_ubicacion"] = $row["x_ubicacion"];
		$GLOBALS["x_ubicacion_2"] = $row["x_ubicacion_2"];
	}
...
echo "entro a add data";
	...
	$strsql = "INSERT INTO `datos_aval` (";
	$strsql .= implode(",", array_keys($fieldList));
	$strsql .= ") VALUES (";
	$strsql .= implode(",", array_values($fieldList));
	$strsql .= ")";
	phpmkr_query($strsql, $conn) or die("error".phpmkr_error().$strsql);
