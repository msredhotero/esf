...
function aMayus(){
	...
	//mayuscula la primer letra de cada palabra	
	function aMayusFirstLetterOfWord() {
        val = this.value;
        newVal = '';
        val = val.split(' ');
		...
		//mayuscula la primer letra del texto
	 function aMayusFirstLetterOfText() {
         var txt = this.value;
         this.value = txt.substring(0,1).toUpperCase() + txt.substring(1,txt.length);
		}
