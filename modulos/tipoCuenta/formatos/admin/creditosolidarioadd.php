...
<p><span class="phpmaker">Add to TABLE: creditosolidario<br><br><a href="creditosolidariolist.php">Back to List</a></span></p>
<form name="creditosolidarioadd" id="creditosolidarioadd" action="creditosolidarioadd.php" method="post" onSubmit="return EW_checkMyForm(this);">
<p>
