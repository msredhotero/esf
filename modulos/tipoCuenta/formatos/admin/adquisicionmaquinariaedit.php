...
<p><span class="phpmaker">Edit TABLE: adquisicionmaquinaria<br><br><a href="adquisicionmaquinarialist.php">Back to List</a></span></p>
<form name="adquisicionmaquinariaedit" id="adquisicionmaquinariaedit" action="adquisicionmaquinariaedit.php" method="post" onSubmit="return EW_checkMyForm(this);">
<p>
...
<?php echo $x_adquisicionMaquinaria_id; ?><input type="hidden" name="x_adquisicionMaquinaria_id" value="<?php echo $x_adquisicionMaquinaria_id; ?>">
</span></td>
	</tr>
	<tr>
...
&nbsp;<input type="image" src="images/ew_calendar.gif" alt="Pick a Date" onClick="popUpCalendar(this, this.form.x_fecha,'yyyy/mm/dd');return false;">
</span></td>
	</tr>
</table>
<p>
