...
function process(tipoSolicitud)
{
  ...
  if (xmlHttp.readyState == 4 || xmlHttp.readyState == 0)
  {
	...
	if(tipoSol == 1) {
	alert("tipo unoc");
	var url="tipoCuenta/formatos/formatoIndividualPRenovacion.php";
	}
	//var url="tipoCuenta/formatos/formatoIndividual.php";	
	else if(tipoSol == 2)
		var url="tipoCuenta/formatos/formatoIndividualGRenovacion.php";
		else if(tipoSol == 3)
			var url="tipoCuenta/formatos/formatoAdquisicionMaquinariaRenovacion.php";
			else if(tipoSol == 4)
				var url="tipoCuenta/formatos/formatoPYMERenovacion.php";
				else
				 var url = "tipoCuenta/formatos/formatoIndividualPRenovacion.php";	
