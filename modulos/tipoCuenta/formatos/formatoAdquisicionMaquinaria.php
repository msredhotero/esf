...
?>
    ...
    <?php }
?> 
<!-- este formulario noes necesario esta pagina sera cargada mediante ajax    
<form id="frmAdqui" name="frmAdqui"  action="formatoAdquisicionMaquinaria.php" method="post"> -->
<div id="paginaUno">
...
<tr>
  <td><table width="91%" >
    ...
    <tr>
      <td width="223"  class="texto_normal" >Titular</td>
    ...
    <tr>
      ...
      <td colspan="2"><span class="texto_normal">
              <input name="x_fecha_nacimiento" type="text" id="x_fecha_nacimiento" value="" size="25"  />
    ...
    <tr>
      ...
      <td colspan="5"> <input type="text" name="x_codigo_postal_negocio" id="x_codigo_postal_negocio"  maxlength="25" size="30" onKeyPress="return solonumeros(this,event)"/></td>
    </tr>
    <tr>
      <td>Entidad</td>
      <td colspan="4">
  ...
  <td height="748"><table width="90%" >
    ...
    <tr>
     ...
     <tr>
      ...
      <td colspan="2">Cu&aacute;l</td>
      <td colspan="4"><input type="text" name="x_ing_fam_cuales_3" id="x_ing_fam_cuales_3"  maxlength="250" size="35"/></td>
      <td width="127">&nbsp;</td>
      <td colspan="10">&nbsp;</td>
    </tr>
     <tr>
    ...
    <tr><td id="tablePag" style="display:none"><div id="paginacion">
<div ><a href="#" id="anterior" style="display:none">Anterior</a></div>
</div></td>


    <tr align="right"><td colspan="19" style="display:none"> <input type="button" name="enviar" id="enviar" value="ENVIAR"/></td></tr>
    </table>
