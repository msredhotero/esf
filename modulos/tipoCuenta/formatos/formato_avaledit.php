  ...
  <td><table width="91%">
    ...
    <tr>
      ...
      <td colspan="8" align="center"><table width="98%">
        <tr>
          <td><input type="text" name="x_nombre_completo" id="x_nombre_completo"  maxlength="250" size="35" value="<?php echo htmlentities($x_nombre_completo); ?>" <?php echo $x_readonly;?> /></td>
          <td><input type="text" name="x_apellido_paterno" id="x_apellido_paterno" maxlength="250" size="35" value="<?php echo htmlentities($x_apellido_paterno); ?>"  <?php echo $x_readonly;?> /></td>
          <td><input type="text" name="x_apellido_materno" id="x_apellido_materno" maxlength="250" size="35" value="<?php echo htmlentities($x_apellido_materno); ?>"   <?php echo $x_readonly;?>/></td>
          </tr>
        <tr>
          <td>Nombre</td>
      ...
      <tr>
        <td>RFC</td>
        <td colspan="4"><input type="text" name="x_rfc" id="x_rfc"  maxlength="30" size="25" value="<?php echo htmlentities($x_rfc); ?>" <?php echo $x_readonly;?> /></td>
        <td width="172">CURP</td>
        <td colspan="5"><input type="text" name="x_curp" id="x_curp"  maxlength="30" size="25" value="<?php echo htmlentities($x_curp); ?>" <?php echo $x_readonly;?>/></td>
      </tr>
    <tr>
      <td>Fecha Nacimiento</td>
      <td colspan="2"><span class="texto_normal">
              <input name="x_fecha_nacimiento" type="text" id="x_fecha_nacimiento" value="<?php echo FormatDateTime(@$x_fecha_nacimiento,7); ?>" size="25"  <?php echo $x_readonly;?> /> 
      ...
      <td colspan="5"><input type="text" name="x_integrantes_familia" id="x_integrantes_familia"  maxlength="30" size="25" onKeyPress="return solonumeros(this,event)" value="<?php echo htmlentities($x_integrantes_familia);?> " <?php echo $x_readonly;?>/></td>
    </tr>
    <tr>
      <td>Dependientes</td>
      <td colspan="2"><input type="text" name="x_dependientes" id="x_dependientes"  maxlength="30" size="30" onKeyPress="return solonumeros(this,event)" value="<?php echo htmlentities($x_dependientes);?> " <?php echo $x_readonly;?>/></td>
      <td colspan="2">Correo Electronico</td>
      <td colspan="6"><span class="phpmaker">
        <input type="text" name="x_correo_electronico" id="x_correo_electronico"  value="<?php echo htmlentities($x_correo_electronico); ?>"  <?php echo $x_readonly;?>/>
      </span></td>
    </tr>
    <tr>
      <td>Esposo(a)</td>
      <td colspan="10"><input type="text" name="x_nombre_conyuge" id="x_nombre_conyuge"  maxlength="250" size="100" value="<?php echo htmlentities($x_nombre_conyuge); ?>" <?php echo $x_readonly;?> /></td>
    </tr>
    <tr>
      <td colspan="11" id="tableHead"></td>
    </tr>
    ...
    <tr>
      <td>Calle</td>
      <td colspan="10"><input type="text" name="x_calle" id="x_calle"  maxlength="100" size="100" value="<?php echo htmlentities($x_calle); ?>" <?php echo $x_readonly;?>/></td>
    </tr>
    <tr>
      <td>Colonia</td>
      <td colspan="4"><input type="text" name="x_colonia" id="x_colonia"  maxlength="100" size="50" value="<?php echo htmlentities($x_colonia); ?>" <?php echo $x_readonly;?> /></td>
      <td>C&oacute;digo Postal</td>
      <td colspan="5"><input type="text" name="x_codigo_postal" id="x_codigo_postal"  maxlength="10" size="20" onKeyPress="return solonumeros(this,event)" value="<?php echo htmlentities($x_codigo_postal); ?>" <?php echo $x_readonly;?>/></td>
    </tr>
    <tr>
      <td>Entidad</td>
      <td colspan="4"><!-- <input type="text" name="x_entidad_domicilio" id="x_entidad_domicilio"  maxlength="250" size="50"/> -->
      <?php
		$x_entidad_idList = "<select name=\"x_entidad\" id=\"x_entidad\"  $x_readonly2 class=\"texto_normal\" onchange=\"showHint(this,'txtHint1', 'x_delegacion')\" >";
      ...
      <td><div align="left"><span class="texto_normal">
        ...
        <?php
	if($x_entidad > 0) {
		$x_delegacion_idList = "<select name=\"x_delegacion\" $x_readonly2  class=\"texto_normal\">";
    ...
    <tr>
      <td>Ubicacion</td>
      <td colspan="10"><input type="text" name="x_ubicacion" id="x_ubicacion"  maxlength="250" size="100" value="<?php echo htmlentities($x_ubicacion); ?>" <?php echo $x_readonly;?> /></td>
    </tr>
    <tr>
      <td>Tipo Vivienda</td>
      <td colspan="4">
      <?php
		$x_vivienda_tipo_idList = "<select name=\"x_vivienda_tipo\" $x_readonly2 id=\"x_vivienda_tipo\"  class=\"texto_normal\" onchange=\"viviendatipo('1')\">";
      ...
      <td>Antiguedad</td>
      <td colspan="5"><input type="text" name="x_antiguedad_v" id="x_antiguedad_v"  maxlength="10" size="20" value="<?php echo htmlentities($x_antiguedad_v); ?>" <?php echo $x_readonly;?>/></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td colspan="4">&nbsp;</td>
      <td>Tel Arrendatario</td>
      <td colspan="5"><input type="text" name="x_tel_arrendatario_v" id="x_tel_arrendatario_v"  maxlength="20" size="20" value="<?php echo htmlentities($x_tel_arrendatario_v); ?>" <?php echo $x_readonly;?> /></td>
    </tr>
    <tr>
      <td height="24">Tel Domicilio</td>
      <td width="133"><input type="text" name="x_telefono_p" id="x_telefono_p"  maxlength="50" size="25" value="<?php echo htmlentities($x_telefono_p); ?>"  <?php echo $x_readonly;?>/></td>
      <td width="76">Otro Tel</td>
      <td colspan="2"><input type="text" name="x_telefono_o" id="x_telefono_o"  maxlength="50" size="25" value="<?php echo htmlentities($x_telefono_o); ?>"  <?php echo $x_readonly;?> /></td>
      <td>Renta Mensual</td>
      <td colspan="5"><input type="text" name="x_renta_mensual_v" id="x_renta_mensual_v"  maxlength="25" size="20" onKeyPress="return solonumeros(this,event)" value="<?php echo number_format(@$x_renta_mensual_v, 0, '.', '') ?>" <?php echo $x_readonly;?>/></td>
    </tr>
    <tr>
      <td>Celular</td>
      <td><input type="text" name="x_telefono_c" id="x_telefono_c"  maxlength="50" size="25" value="<?php echo htmlentities($x_telefono_c); ?>"<?php echo $x_readonly;?>  /></td>
      <td>&nbsp;</td>
      <td colspan="2"></td>
      <td colspan="6">&nbsp;</td>
    </tr>
    ...
    <tr>
      <td>Giro Negocio</td>
      <td colspan="10"><input type="text" name="x_giro_negocio" id="x_giro_negocio"  maxlength="250" size="100" value="<?php echo htmlentities($x_giro_negocio); ?>" <?php echo $x_readonly;?> /></td>
    </tr>
    <tr>
      <td>Calle</td>
      <td colspan="10"><input type="text" name="x_calle_2" id="x_calle_2"  maxlength="250" size="100" value="<?php echo htmlentities($x_calle_2); ?>"  <?php echo $x_readonly;?> /></td>
    </tr>
    <tr>
      <td>Colonia</td>
      <td colspan="4"><input type="text" name="x_colonia_2" id="x_colonia_2"  maxlength="250" size="70" value="<?php echo htmlentities($x_colonia_2); ?>" <?php echo $x_readonly;?> /></td>
      <td><p>C&oacute;digo Postal</p></td>
      <td colspan="5"><input type="text" name="x_codigo_postal_2" id="x_codigo_postal_2"  maxlength="25" size="20" onKeyPress="return solonumeros(this,event)" value="<?php echo htmlentities($x_codigo_postal_2); ?>" <?php echo $x_readonly;?> /></td>
    </tr>
    <tr>
      <td>Entidad</td>
      <td colspan="4"><!-- <input type="text" name="x_entidad_negocio" id="x_entidad_negocio"  maxlength="250" size="70"/> -->
      <?php
		$x_entidad_idList2 = "<select name=\"x_entidad_2\" $x_readonly2  id=\"x_entidad_2\" class=\"texto_normal\" onchange=\"showHint(this,'txtHint2', 'x_delegacion_2')\" >";
      ...
      <td><div align="left"><span class="texto_normal">
        ...
        <?php
		if($x_entidad_2 > 0) {
		$x_delegacion_idList = "<select name=\"x_delegacion_2\"  $x_readonly2 class=\"texto_normal\">";
		$x_delegacion_idList .= "<option value=''>Seleccione</option>";
		$sSqlWrk = "SELECT delegacion_id, descripcion FROM delegacion where entidad_id = $x_entidad";
		$rswrk = phpmkr_query($sSqlWrk,$conn) or die("Failed to execute query" . phpmkr_error() . ' SQL:' . $sSqlWrk);
		if ($rswrk) {
    ...
    <tr>
      <td>Ubicacion</td>
      <td colspan="10"><input type="text" name="x_ubicacion_2" id="x_ubicacion_2"  maxlength="250" size="100" value="<?php echo htmlentities($x_ubicacion_2); ?>"  <?php echo $x_readonly;?> /></td>
    </tr>
    <tr>
      <td>Tipo Local</td>
      <td colspan="4">
      <?php
		$x_vivienda_tipo_idList = "<select name=\"x_vivienda_tipo_2\" $x_readonly2  id=\"x_vivienda_tipo_2\"  class=\"texto_normal\" onchange=\"viviendatipo('1')\">";
		$x_vivienda_tipo_idList .= "<option value=''>Seleccione</option>";
		$sSqlWrk = "SELECT `vivienda_tipo_id`, `descripcion` FROM `vivienda_tipo`";
		$rswrk = @phpmkr_query($sSqlWrk,$conn) or die("Failed to execute query" .phpmkr_error(). ' SQL:' . $sSqlWrk);
		if ($rswrk) {
      ...
      <td colspan="5"><input type="text" name="x_antiguedad_n" id="x_antiguedad_n"  maxlength="10" size="20" value="<?php echo htmlentities($x_antiguedad_n); ?>" <?php echo $x_readonly;?>/></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td colspan="4">&nbsp;</td>
      <td>Tel. Arrendatario</td>
      <td colspan="5"><input type="text" name="x_tel_arrendatario_n" id="x_tel_arrendatario_n"  maxlength="20" size="20" value="<?php echo htmlentities($x_tel_arrendatario_n); ?>" <?php echo $x_readonly;?>/></td>
    </tr>
    <tr>
      <td>Tel Negocio</td>
      <td colspan="4"><input type="text" name="x_telefono_p_2" id="x_telefono_p_2"  maxlength="50" size="25" value="<?php echo htmlentities($x_telefono_p_2); ?>" <?php echo $x_readonly;?>/></td>
      <td>Renta Mensual</td>
      <td colspan="5"><input type="text" name="x_renta_mesual_n" id="renta_mesual_n"  maxlength="50" size="20" onKeyPress="return solonumeros(this,event)" value="<?php echo number_format(@$x_renta_mesual_n, 0, '.', '') ?>" <?php echo $x_readonly;?>/></td>
    </tr>
      <tr>
      <td colspan="11" id="tableHead"><p></td>
    </tr>
    ...
    <tr>
      <td colspan="11"><center><textarea cols="80" rows="4" id="x_garantia_desc" name="x_garantia_desc" <?php echo $x_readonly;?>><?php echo htmlentities($x_garantia_desc); ?></textarea></center></td>
    </tr>
    <tr>
      <td colspan="11"><table width="80%">
        <tr>
          <td>Valor</td>
          <td><input type="text" name="x_garantia_valor" id="x_garantia_valor" onKeyPress="return solonumeros(this,event)" value="<?php echo number_format(@$x_garantia_valor, 0, '.', '') ?>"  <?php echo $x_readonly;?> /></td>
        </tr>
      </table></td>
    </tr>
    <tr>
  ...
  <tr>
    ...
    <tr>
      <td height="36" colspan="2"><table width="300"><tr>
        <td width="48">1.-</td>
        <td width="276"><input type="text" name="x_referencia_1" id="x_referencia_com_1"  maxlength="250" size="40" value="<?php echo htmlentities($x_referencia_1); ?>" <?php echo $x_readonly;?> /></td></tr></table></td>
      <td colspan="2"><table width="160" height="29"><tr>
        <td width="36">Tel</td>
        <td width="137"><input type="text" name="x_telefono_ref_1" id="x_telefono_ref_1"  maxlength="20" size="30" value="<?php echo htmlentities($x_telefono_ref_1); ?>" <?php echo $x_readonly;?> /></td></tr></table></td>
      <td width="107">Parentesco</td>
      <td colspan="6">
      <?php
		$x_parentesco_tipo_idList = "<select name=\"x_relacion_1\"  $x_readonly2 id=\"x_relacion_1\" class=\"texto_normal\">";
    ...
    <tr>
      <td colspan="2"><table width="300"><tr>
        <td width="48">2.-</td>
        <td width="277"><input type="text" name="x_referencia_2" id="x_referencia_2"  maxlength="250" size="40" value="<?php echo htmlentities($x_referencia_2); ?>"  <?php echo $x_readonly;?>/></td></tr></table></td>
      <td colspan="2"><table width="160"><tr>
        <td width="36">Tel</td>
        <td width="137"><input type="text" name="x_telefono_ref_2" id="x_telefono_ref_2"  maxlength="20" size="30" value="<?php echo htmlentities($x_telefono_ref_2); ?>"  <?php echo $x_readonly;?> /></td></tr></table></td>
      <td>Parentesco</td>
      <td colspan="6">
       <?php
		$x_parentesco_tipo_idList = "<select name=\"x_relacion_2\" $x_readonly2  id=\"x_relacion_2\" class=\"texto_normal\">";
		$x_parentesco_tipo_idList .= "<option value=''>Seleccione</option>";
		$sSqlWrk = "SELECT `parentesco_tipo_id`, `descripcion` FROM `parentesco_tipo`";
		$rswrk = phpmkr_query($sSqlWrk,$conn) or die("Failed to execute query" . phpmkr_error() . ' SQL:' . $sSqlWrk);
		if ($rswrk) {
    ...
    <tr>
      <td colspan="2"><table width="300"><tr>
        <td width="48">3.-</td>
        <td width="276"><input type="text" name="x_referencia_3" id="x_referencia_3"  maxlength="250" size="40" value="<?php echo htmlentities($x_referencia_3); ?>" <?php echo $x_readonly;?> /></td></tr></table></td>
      <td colspan="2"><table width="183"><tr>
        <td width="34">Tel</td>
        <td width="137"><input type="text" name="x_telefono_ref_3" id="x_telefono_ref_3"  maxlength="20" size="30" value="<?php echo htmlentities($x_telefono_ref_3); ?>"  <?php echo $x_readonly;?> /></td></tr></table></td>
      <td>Parentesco</td>
      <td colspan="6">
      <?php
		$x_parentesco_tipo_idList = "<select name=\"x_relacion_3\" $x_readonly2  id=\"x_relacion_3\" class=\"texto_normal\">";
		$x_parentesco_tipo_idList .= "<option value=''>Seleccione</option>";
		$sSqlWrk = "SELECT `parentesco_tipo_id`, `descripcion` FROM `parentesco_tipo`";
		$rswrk = phpmkr_query($sSqlWrk,$conn) or die("Failed to execute query" . phpmkr_error() . ' SQL:' . $sSqlWrk);
		if ($rswrk) {
    ...
    <tr>
      <td colspan="2"><table width="300"><tr>
        <td width="48">4.-</td>
        <td width="276"><input type="text" name="x_referencia_4" id="x_referencia_4"  maxlength="250" size="40" value="<?php echo htmlentities($x_referencia_4); ?>" <?php echo $x_readonly;?> /></td></tr></table></td>
     <td colspan="2"><table width="160"><tr>
        <td width="35">Tel</td>
        <td width="137"><input type="text" name="x_telefono_ref_4" id="x_telefono_ref_4"  maxlength="20" size="30" value="<?php echo htmlentities($x_telefono_ref_4); ?>"<?php echo $x_readonly;?>  /></td></tr></table></td>
      <td>Parentesco</td>
      <td colspan="6">
      <?php
		$x_parentesco_tipo_idList = "<select name=\"x_relacion_4\" $x_readonly2  id=\"x_relacion_4\" class=\"texto_normal\">";
		$x_parentesco_tipo_idList .= "<option value=''>Seleccione</option>";
		$sSqlWrk = "SELECT `parentesco_tipo_id`, `descripcion` FROM `parentesco_tipo`";
		$rswrk = phpmkr_query($sSqlWrk,$conn) or die("Failed to execute query" . phpmkr_error() . ' SQL:' . $sSqlWrk);
		if ($rswrk) {
...
<tr>
  <td height="748"><table width="90%" >
    ...
    <tr>
      ...
      <td colspan="4"><input type="text" name="x_ing_fam_negocio" id="x_ing_fam_negocio"  maxlength="30" size="35" onKeyPress="return solonumeros(this,event)" value="<?php echo number_format(@$x_ing_fam_negocio, 0, '.', '') ?>" <?php echo $x_readonly;?> /></td>
      <td colspan="2">&nbsp;</td>
      <td width="76">&nbsp;</td>
      <td width="52">&nbsp;</td>
      <td width="69">&nbsp;</td>
    ...
    <tr>
      ...
      <td colspan="4"><input type="text" name="x_ing_fam_otro_th" id="x_ing_fam_otro_th"  maxlength="30" size="35"onKeyPress="return solonumeros(this,event)" value="<?php echo number_format(@$x_ing_fam_otro_th, 0, '.', '') ?>"  <?php echo $x_readonly;?> /></td>
      <td colspan="2">Cu&aacute;l</td>
      <td colspan="4"><input type="text" name="x_ing_fam_cuales_1" id="x_ing_fam_cuales_1"  maxlength="250" size="35" value="<?php echo htmlentities($x_ing_fam_cuales_1); ?>"  <?php echo $x_readonly;?> /></td>
      <td width="127">&nbsp;</td>
      <td colspan="10">&nbsp;</td>
    </tr>
     <tr>
      <td width="147">Ingreso Familiar 1</td>
      <td colspan="4"><input type="text" name="x_ing_fam_1" id="x_ing_fam_1"  maxlength="30" size="35" onKeyPress="return solonumeros(this,event)" value="<?php echo number_format(@$x_ing_fam_1, 0, '.', '') ?>" <?php echo $x_readonly;?> /></td>
      <td colspan="2">Cu&aacute;l</td>
      <td colspan="4"><input type="text" name="x_ing_fam_cuales_2" id="x_ing_fam_cuales_2"  maxlength="250" size="35" value="<?php echo htmlentities($x_ing_fam_cuales_2); ?>"  <?php echo $x_readonly;?>/></td>
      <td width="127">&nbsp;</td>
      <td colspan="10">&nbsp;</td>
    </tr>
     <tr>
      <td width="147">Ingreso Familiar 2</td>
      <td colspan="4"><input type="text" name="x_ing_fam_2" id="x_ing_fam_2"  maxlength="30" size="35" onKeyPress="return solonumeros(this,event)" value="<?php echo number_format(@$x_ing_fam_2, 0, '.', '') ?>"  <?php echo $x_readonly;?>/></td>
      <td colspan="2">Cu&aacute;l</td>
      <td colspan="4"><input type="text" name="x_ing_fam_cuales_13" id="x_ing_fam_cuales_13"  maxlength="250" size="35" value="<?php echo htmlentities($x_ing_fam_cuales_13); ?>"  <?php echo $x_readonly;?>/></td>
      <td width="127">&nbsp;</td>
      <td colspan="10">&nbsp;</td>
    </tr>
     <tr>
      <td width="147">Deuda 1</td>
      <td colspan="4"><input type="text" name="x_ing_fam_deuda_1" id="x_ing_fam_deuda_1"  maxlength="30" size="35" onKeyPress="return solonumeros(this,event)" value="<?php echo number_format(@$x_ing_fam_deuda_1, 0, '.', '') ?>" <?php echo $x_readonly;?> /></td>
      <td colspan="2">Cu&aacute;l</td>
      <td colspan="4"><input type="text" name="x_ing_fam_cuales_4" id="x_ing_fam_cuales_4"  maxlength="250" size="35" value="<?php echo htmlentities($x_ing_fam_cuales_4); ?>" <?php echo $x_readonly;?>/></td>
      <td width="127">&nbsp;</td>
      <td colspan="10">&nbsp;</td>
    </tr>
     <tr>
      <td width="147">Deuda 2</td>
      <td colspan="4"><input type="text" name="x_ing_fam_deuda_2" id="x_ing_fam_deuda_2"  maxlength="30" size="35" onKeyPress="return solonumeros(this,event)" value="<?php echo number_format(@$x_ing_fam_deuda_2, 0, '.', '') ?>" <?php echo $x_readonly;?>/></td>
      <td colspan="2">Cu&aacute;l</td>
      <td colspan="4"><input type="text" name="x_ing_fam_cuales_5" id="x_ing_fam_cuales_5"  maxlength="250" size="35" value="<?php echo htmlentities($x_ing_fam_cuales_5); ?>" <?php echo $x_readonly;?>/></td>
      <td width="127">&nbsp;</td>
      <td colspan="10">&nbsp;</td>
    </tr>
     <tr>
      <td width="147">Total</td>
      <td colspan="4"><input type="text" name="x_ing_fam_total" id="x_ing_fam_total"  maxlength="30" size="35" onKeyPress="return solonumeros(this,event)" value="<?php echo number_format(@$x_ing_fam_total, 0, '.', '') ?>" <?php echo $x_readonly;?>/></td>
      <td colspan="2">&nbsp;</td>
      <td width="76">&nbsp;</td>
      <td width="52">&nbsp;</td>
      <td width="69">&nbsp;</td>
    ...
    <tr>
      ...
      <td colspan="4"><input type="text" name="x_flujos_neg_ventas" id="x_flujos_neg_ventas"  maxlength="30" size="35" onKeyPress="return solonumeros(this,event)" value="<?php echo number_format(@$x_flujos_neg_ventas, 0, '.', '') ?>" <?php echo $x_readonly;?> /></td>
      <td colspan="2">&nbsp;</td>
      <td width="76">&nbsp;</td>
      <td width="52">&nbsp;</td>
      <td width="69">&nbsp;</td>
    ...
    <tr>
      ...
      <td colspan="4"><input type="text" name="x_flujos_neg_proveedor_1" id="x_flujos_neg_proveedor_1"  maxlength="250" size="35" onKeyPress="return solonumeros(this,event)" value="<?php echo number_format(@$x_flujos_neg_proveedor_1, 0, '.', '') ?>" <?php echo $x_readonly;?> /></td>
      <td colspan="2">Cu&aacute;l</td>
      <td colspan="4"><input type="text" name="x_flujos_neg_cual_1" id="x_flujos_neg_cual_1"  maxlength="100" size="35" value="<?php echo htmlentities($x_flujos_neg_cual_1); ?>" <?php echo $x_readonly;?> /></td>
      <td width="127">&nbsp;</td>
      <td colspan="10">&nbsp;</td>
    </tr>
     <tr>
      <td width="147">Proveedor 2</td>
      <td colspan="4"><input type="text" name="x_flujos_neg_proveedor_2" id="x_flujos_neg_proveedor_2"  maxlength="250" size="35" onKeyPress="return solonumeros(this,event)" value="<?php echo number_format(@$x_flujos_neg_proveedor_2, 0, '.', '') ?>" <?php echo $x_readonly;?> /></td>
      <td colspan="2">Cu&aacute;l</td>
      <td colspan="4"><input type="text" name="x_flujos_neg_cual_2" id="x_flujos_neg_cual_2"  maxlength="100" size="35" value="<?php echo htmlentities($x_flujos_neg_cual_2); ?>" <?php echo $x_readonly;?> /></td>
      <td width="127">&nbsp;</td>
      <td colspan="10">&nbsp;</td>
    </tr>
     <tr>
      <td width="147">Proveedor 3</td>
      <td colspan="4"><input type="text" name="x_flujos_neg_proveedor_3" id="x_flujos_neg_proveedor_3"  maxlength="250" size="35" onKeyPress="return solonumeros(this,event)" value="<?php echo number_format(@$x_flujos_neg_proveedor_3, 0, '.', '') ?>"<?php echo $x_readonly;?> /></td>
      <td colspan="2">Cu&aacute;l</td>
      <td colspan="4"><input type="text" name="x_flujos_neg_cual_3" id="x_flujos_neg_cual_3"  maxlength="100" size="35" value="<?php echo htmlentities($x_flujos_neg_cual_3); ?>" <?php echo $x_readonly;?>/></td>
      <td width="127">&nbsp;</td>
      <td colspan="10">&nbsp;</td>
    </tr>
     <tr>
      <td width="147">Proveedor 4</td>
      <td colspan="4"><input type="text" name="x_flujos_neg_proveedor_4" id="x_flujos_neg_proveedor_4"  maxlength="250" size="35" onKeyPress="return solonumeros(this,event)" value="<?php echo number_format(@$x_flujos_neg_proveedor_4, 0, '.', '') ?>" <?php echo $x_readonly;?>/></td>
      <td colspan="2">Cu&aacute;l</td>
      <td colspan="4"><input type="text" name="x_flujos_neg_cual_4" id="x_flujos_neg_cual_4"  maxlength="100" size="35" value="<?php echo htmlentities($x_flujos_neg_cual_4); ?>" <?php echo $x_readonly;?>/></td>
      <td width="127">&nbsp;</td>
      <td colspan="10">&nbsp;</td>
    </tr>
     <tr>
      <td width="147">Gasto 1</td>
      <td colspan="4"><input type="text" name="x_flujos_neg_gasto_1" id="x_flujos_neg_gasto_1"  maxlength="250" size="35" onKeyPress="return solonumeros(this,event)" value="<?php echo number_format(@$x_flujos_neg_gasto_1, 0, '.', '') ?>" <?php echo $x_readonly;?> /></td>
      <td colspan="2">Cu&aacute;l</td>
      <td colspan="4"><input type="text" name="x_flujos_neg_cual_5" id="x_flujos_neg_cual_5"  maxlength="100" size="35" value="<?php echo htmlentities($x_flujos_neg_cual_5); ?>" <?php echo $x_readonly;?> /></td>
      <td width="127">&nbsp;</td>
      <td colspan="10">&nbsp;</td>
    </tr>
     <tr>
      <td width="147">Gasto 2</td>
      <td colspan="4"><input type="text" name="x_flujos_neg_gasto_2" id="x_flujos_neg_gasto_2"  maxlength="250" size="35" onKeyPress="return solonumeros(this,event)" value="<?php echo number_format(@$x_flujos_neg_gasto_2, 0, '.', '') ?>" <?php echo $x_readonly;?> /></td>
      <td colspan="2">Cu&aacute;l</td>
      <td colspan="4"><input type="text" name="x_flujos_neg_cual_6" id="x_flujos_neg_cual_6"  maxlength="100" size="35" value="<?php echo htmlentities($x_flujos_neg_cual_6); ?>" <?php echo $x_readonly;?> /></td>
      <td width="127">&nbsp;</td>
      <td colspan="10">&nbsp;</td>
    </tr>
    <tr>
      <td width="147">Gasto 3</td>
      <td colspan="4"><input type="text" name="x_flujos_neg_gasto_3" id="x_flujos_neg_gasto_3"  maxlength="250" size="35" onKeyPress="return solonumeros(this,event)" value="<?php echo number_format(@$x_flujos_neg_gasto_3, 0, '.', '') ?>" <?php echo $x_readonly;?> /></td>
      <td colspan="2">Cu&aacute;l</td>
      <td colspan="4"><input type="text" name="x_flujos_neg_cual_7" id="x_flujos_neg_cual_7"  maxlength="100" size="35" value="<?php echo htmlentities($x_flujos_neg_cual_7); ?>"  <?php echo $x_readonly;?> /></td>
      <td width="127">&nbsp;</td>
      <td colspan="10">&nbsp;</td>
    </tr>
    <tr>
      <td width="147">Ingreso Negocio</td>
      <td colspan="4"><input type="text" name="x_ingreso_negocio" id="x_ingreso_negocio"  maxlength="250" size="35" onKeyPress="return solonumeros(this,event)" value="<?php echo number_format(@$x_ingreso_negocio, 0, '.', '') ?>"  <?php echo $x_readonly;?> /></td>
      <td colspan="2">&nbsp;</td>
      <td colspan="4">&nbsp;</td>
      <td width="127">&nbsp;</td>
      <td colspan="10">&nbsp;</td>
    ...
    <tr>
     ...
     <tr>
      <td width="226"><input type="text" name="x_inv_neg_fija_conc_1" id="x_inv_neg_fija_conc_1"  maxlength="250" size="35" value="<?php echo htmlentities($x_inv_neg_fija_conc_1); ?>" <?php echo $x_readonly;?> /></td>
      <td colspan="4"><input type="text" name="x_inv_neg_fija_valor_1" id="x_inv_neg_fija_valor_1"  maxlength="250" size="25" onKeyPress="return solonumeros(this,event)" value="<?php echo number_format(@$x_inv_neg_fija_valor_1, 0, '.', '') ?>"  <?php echo $x_readonly;?>/></td>
      <td colspan="2">&nbsp;</td>
      <td><input type="text" name="x_inv_neg_var_conc_1" id="x_inv_neg_var_conc_1"  maxlength="250" size="35" value="<?php echo htmlentities($x_inv_neg_var_conc_1); ?>"  <?php echo $x_readonly;?> /></td>
      <td width="171" colspan="-2"><input type="text" name="x_inv_neg_var_valor_1" id="x_inv_neg_var_valor_1"  maxlength="250" size="25" onKeyPress="return solonumeros(this,event)" value="<?php echo number_format(@$x_inv_neg_var_valor_1, 0, '.', '') ?>"  <?php echo $x_readonly;?> /></td>
      <td colspan="10">&nbsp;</td>
    </tr>
     <tr>
      <td width="226"><input type="text" name="x_inv_neg_fija_conc_2" id="x_inv_neg_fija_conc_2"  maxlength="250" size="35" value="<?php echo htmlentities($x_inv_neg_fija_conc_2); ?>"  <?php echo $x_readonly;?>/></td>
      <td colspan="4"><input type="text" name="x_inv_neg_fija_valor_2" id="x_inv_neg_fija_valor_2"  maxlength="250" size="25" onKeyPress="return solonumeros(this,event)" value="<?php echo number_format(@$x_inv_neg_fija_valor_2, 0, '.', '') ?>"  <?php echo $x_readonly;?> /></td>
      <td colspan="2">&nbsp;</td>
      <td><input type="text" name="x_inv_neg_var_conc_2" id="x_inv_neg_var_conc_2"  maxlength="250" size="35" value="<?php echo htmlentities($x_inv_neg_var_conc_2); ?>"  <?php echo $x_readonly;?> /></td>
      <td width="171" colspan="-2"><input type="text" name="x_inv_neg_var_valor_2" id="x_inv_neg_var_valor_2"  maxlength="250" size="25" onKeyPress="return solonumeros(this,event)" value="<?php echo number_format(@$x_inv_neg_var_valor_2, 0, '.', '') ?>" <?php echo $x_readonly;?> /></td>
      <td colspan="10">&nbsp;</td>
    </tr>
     <tr>
      <td width="226"><input type="text" name="x_inv_neg_fija_conc_3" id="x_inv_neg_fija_conc_3"  maxlength="250" size="35" value="<?php echo htmlentities($x_inv_neg_fija_conc_3); ?>"  <?php echo $x_readonly;?> /></td>
      <td colspan="4"><input type="text" name="x_inv_neg_fija_valor_3" id="x_inv_neg_fija_valor_3"  maxlength="250" size="25" onKeyPress="return solonumeros(this,event)" value="<?php echo number_format(@$x_inv_neg_fija_valor_3, 0, '.', '') ?>" <?php echo $x_readonly;?> /></td>
      <td colspan="2">&nbsp;</td>
      <td><input type="text" name="x_inv_neg_var_conc_3" id="x_inv_neg_var_conc_3"  maxlength="250" size="35" value="<?php echo htmlentities($x_inv_neg_var_conc_3);?>" <?php echo $x_readonly;?>/></td>
      <td width="171" colspan="-2"><input type="text" name="x_inv_neg_var_valor_3" id="x_inv_neg_var_valor_3"  maxlength="250" size="25" onKeyPress="return solonumeros(this,event)" value="<?php echo number_format(@$x_inv_neg_var_valor_3, 0, '.', '') ?>"  <?php echo $x_readonly;?>/></td>
      <td colspan="10">&nbsp;</td>
    </tr>
     <tr>
      <td width="226"><input type="text" name="x_inv_neg_fija_conc_4" id="x_inv_neg_fija_conc_4"  maxlength="250" size="35" value="<?php echo htmlentities($x_inv_neg_fija_conc_4); ?>"  <?php echo $x_readonly;?>/></td>
      <td colspan="4"><input type="text" name="x_inv_neg_fija_valor_4" id="x_inv_neg_fija_valor_4"  maxlength="250" size="25" onkeypress="return solonumeros(this,event)" value="<?php echo number_format(@$x_inv_neg_fija_valor_4, 0, '.', '') ?>"  <?php echo $x_readonly;?>/></td>
      <td colspan="2">&nbsp;</td>
      <td><input type="text" name="x_inv_neg_var_conc_4" id="x_inv_neg_var_conc_4"  maxlength="250" size="35" value="<?php echo htmlentities($x_inv_neg_var_conc_4); ?>"  <?php echo $x_readonly;?>/></td>
      <td width="171" colspan="-2"><input type="text" name="x_inv_neg_var_valor_4" id="x_inv_neg_var_valor_4"  maxlength="250" size="25" onKeyPress="return solonumeros(this,event)" value="<?php echo number_format(@$x_inv_neg_var_valor_4, 0, '.', '') ?>"  <?php echo $x_readonly;?>/></td>
      <td colspan="10">&nbsp;</td>
    </tr>
     <tr>
      <td width="226" align="right">Total</td>
      <td colspan="4"><input type="text" name="x_inv_neg_total_fija" id="x_inv_neg_total_fija"  maxlength="250" size="25" onKeyPress="return solonumeros(this,event)" value="<?php echo number_format(@$x_inv_neg_total_fija, 0, '.', '') ?>"  <?php echo $x_readonly;?>/></td>
      <td colspan="2">&nbsp;</td>
      <td align="right">Total</td>
      <td width="171" colspan="-2"><input type="text" name="x_inv_neg_total_var" id="x_inv_neg_total_var"  maxlength="250" size="25" onKeyPress="return solonumeros(this,event)" value="<?php echo number_format(@$x_inv_neg_total_var, 0, '.', '') ?>"  <?php echo $x_readonly;?>/></td>
      <td colspan="10">&nbsp;</td>
    </tr>
     <tr>
      <td width="226">&nbsp;</td>
    ...
    <tr>
      ...
      <td width="171" colspan="-2"><input type="text" name="x_inv_neg_activos_totales" id="x_inv_neg_activos_totales"  maxlength="250" size="25" onKeyPress="return solonumeros(this,event)" value="<?php echo number_format(@$x_inv_neg_activos_totales, 0, '.', '') ?>" <?php echo $x_readonly;?> /></td>
      <td colspan="10">&nbsp;</td>
      <tr>
      <td colspan="19" id="tableHead"><p></td>
    </tr>
  ...
  <tr>
    ...
    <td  colspan="11" align="left" valign="top">
	  <div align="center">
	    <textarea name="x_comentario_promotor" cols="60" rows="5" <?php echo $x_readonly;?>><?php echo htmlentities($x_comentario_promotor); ?></textarea>
	      </div></td>
  ...
  <tr>
    ...
    <td  colspan="11" align="left" valign="top">
	  <div align="center">
	    <textarea name="x_comentario_comite" cols="60" rows="5" <?php echo $x_readonly;?>><?php echo htmlentities($x_comentario_comite); ?></textarea>
	      </div></td>
