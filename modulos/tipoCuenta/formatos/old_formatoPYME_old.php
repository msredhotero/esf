...
if($_POST["datos"] == "enviados"){	
	...
	$strsql .= ")";
	phpmkr_query($strsql, $conn) or die ("ERROR AL EJECUTAR QUERY 1 INSERT :" .phpmkr_error()."SENETENCIA :".$strsql);
...
<form id="frmPYME" name="frmPYME"  action="old_formatoPYME_old.php" method="post">
<div id="paginaUno">
...
<tr>
  <td><table width="91%">
    ...
    <tr>
      <td colspan="11" id="tableHead"><img src="images/Grantias.png" /></td>
    </tr>
     <tr>
      <td colspan="11" id="tableHead"><p></td>
    </tr>
