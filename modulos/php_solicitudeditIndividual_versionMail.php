...
?>
        ...
        <td colspan="2"><?php
		$x_estado_civil_idList = "<select name=\"x_zona_id\" $x_readonly2 class=\"texto_normal\">";
		$x_estado_civil_idList .= "<option value=''>Seleccione</option>";
...
?></td>
      ...
      <tr>
        <td><span class="texto_normal"><?php if ($x_solicitud_status_id < 2){ echo "Importe solicitado:";}else{ echo "Monto otorgado";}?> </span></td>
      ...
      <tr>
        <td><span class="texto_normal">Monto max aprobado</span></td>
        <td><input type="text" class="importe"  size="10" maxlength="10" name="x_monto_maximo_aprobado" value="<?php echo  FormatNumber($x_monto_maximo_aprobado,0,0,0,0);?>"  onchange="muestraMontoSolicitado();" /> </td>
        <td>&nbsp;</td>
      ...
      <tr>
        ...
        <td><input class="importe"  size="10" maxlength="10" type="text" name="x_monto_solicitado" id="x_monto_solicitado" value="<?php if ($x_solicitud_status_id == 2 and $_SESSION["php_project_esf_status_UserRolID"] != 2 ){echo "----";}else{ echo  FormatNumber(@$x_monto_solicitado,0,0,0,0);}?>" /></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
...
<?php if(($_SESSION["php_project_esf_status_UserRolID"] == 1) || ($_SESSION["php_project_esf_status_UserRolID"] == 2) || ($_SESSION["php_project_esf_status_UserRolID"] == 3) ||($_SESSION["php_project_esf_status_UserRolID"] == 4) ||($_SESSION["php_project_esf_status_UserRolID"] == 7)){ ?>
...
function EditData($conn){
	...
	if (phpmkr_num_rows($rs) == 0) {
		...
		// Field fecha_investigacion
		$theValue = ($GLOBALS["x_fecha_investigacion"] != "") ? " '" . ConvertDateToMysqlFormat($GLOBALS["x_fecha_supervision"]) . "'" : "NULL";
		...
		$x_mensaje .= "<BR><BR> http://financieracrea.com/esf/modulos/php_solicitudviewIndividual.php?solicitud_id=".$x_solicitud_id."<BR><BR>";
		// Mail it						
		//mail($para, $titulo, $x_mensaje, $cabeceras);
		echo "para ".$para;
		echo "<br> titulo : ".$titulo."<br>";
		echo "cabeceras ".$cabeceras."<br>";
		#echo "cuerpo del mail ".$x_mensaje."<br>";
		...
		if((intval($GLOBALS["x_solicitud_status_id"]) == 3) || (intval($GLOBALS["x_solicitud_status_id"]) == 4)){	
		...
		$x_mensaje = "";
		$tiposms = "";
		if ((intval($GLOBALS["x_solicitud_status_id"]) == 3)){
		...
		echo "fecha aprobado ".$theValue."<br>";
		...
		echo "fecha rechazada ".$theValue."<br>";								
				}
