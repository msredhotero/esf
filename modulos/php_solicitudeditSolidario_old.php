...
?>
      ...
      <tr>
        ...
        <td width="111"><div align="left">
            <input class="importe" name="x_importe_solicitado" type="text" id="x_importe_solicitado" value="<?php echo FormatNumber(@$x_importe_solicitado,0,0,0,0) ?>" size="10" maxlength="10" onKeyPress="return solonumeros(this,event)" onBlur="validaimporte()"  <?php if($x_solicitud_status_id == 6){?> readonly="readonly" <?php }?> />
        </div></td>
        <td width="10">&nbsp;</td>
  ...
  <td width="9%" ><?php
    ...
    <td width="47%"><input type="text" id="x_integrante_1" name="x_integrante_1" maxlength="250"  value="<?php echo htmlentities($x_integrante_1);?>" size="80" /></td>
    ...
    <td><?php if(!empty($x_integrante_1)) { ?><iframe name="comentarios" src="php_visor_integrantes.php?key=<?php echo $x_cliente_id_1;?>&nombre=<?php echo htmlentities($x_integrante_1)?>&monto=<?php echo number_format($x_monto_1, 0, '.', '');?>&rol=<?php echo $x_rol_integrante_1;?>&numero=1&sol_id=<?php echo($x_solicitud_id);?>&grupo_id=<?php echo $x_grupo_id ;?>" scrolling="no" style="margin-left:0px; width:100px; height:30px; margin-top:-5px" frameborder="0" allowtransparency="true" id="contenido"></iframe><?php } ?></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
  ...
  <td ><?php
    ...
    <td>&nbsp;</td>
    <td>Integrante 2</td>
    <td><input type="text" id="x_integrante_2" name="x_integrante_2" maxlength="250" size="80"  value="<?php echo htmlentities($x_integrante_2);?>"/></td>
  ...
  <td ><?php
    ...
    <td>&nbsp;</td>
    <td>Integrante 3</td>
    <td><input type="text" id="x_integrante_3" name="x_integrante_3" maxlength="250" size="80"  value="<?php echo htmlentities($x_integrante_3);?>" /></td>
    ...
    <td><?php if(!empty($x_integrante_3)) { ?><iframe name="comentarios" src="php_visor_integrantes.php?key=<?php echo $x_cliente_id_3;?>&nombre=<?php echo htmlentities($x_integrante_3)?>&monto=<?php echo number_format($x_monto_3, 0, '.', '');?>&rol=<?php echo $x_rol_integrante_3;?>&numero=3&sol_id=<?php echo($x_solicitud_id);?>&grupo_id=<?php echo $x_grupo_id ;?>" scrolling="no" style="margin-left:0px; width:100px; height:30px; margin-top:-5px" frameborder="0" allowtransparency="true" id="contenido"></iframe><?php }?></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
  ...
  <td ><?php
    ...
    <td>&nbsp;</td>
    <td>Integrante 4</td>
    <td><input type="text" id="x_integrante_4" name="x_integrante_4" maxlength="250" size="80"  value="<?php echo htmlentities($x_integrante_4);?>" /></td>
    ...
    <td><?php if(!empty($x_integrante_4)) { ?><iframe name="comentarios" src="php_visor_integrantes.php?key=<?php echo $x_cliente_id_4;?>&nombre=<?php echo htmlentities($x_integrante_4)?>&monto=<?php echo number_format($x_monto_4, 0, '.', '');?>&rol=<?php echo $x_rol_integrante_4;?>&numero=4&sol_id=<?php echo($x_solicitud_id);?>&grupo_id=<?php echo $x_grupo_id ;?>" scrolling="no" style="margin-left:0px; width:100px; height:30px; margin-top:-5px" frameborder="0" allowtransparency="true" id="contenido"></iframe><?php }?></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
  ...
  <td ><?php
    ...
    <td>&nbsp;</td>
    <td>Integrante 5</td>
    <td><input type="text" id="x_integrante_5" name="x_integrante_5" maxlength="250" size="80"  value="<?php echo htmlentities($x_integrante_5);?>" /></td>
    ...
    <td><?php if(!empty($x_integrante_5)) { ?><iframe name="comentarios" src="php_visor_integrantes.php?key=<?php echo $x_cliente_id_5;?>&nombre=<?php echo htmlentities($x_integrante_5)?>&monto=<?php echo number_format($x_monto_5, 0, '.', '');?>&rol=<?php echo $x_rol_integrante_5;?>&numero=5&sol_id=<?php echo($x_solicitud_id);?>&grupo_id=<?php echo $x_grupo_id ;?>" scrolling="no" style="margin-left:0px; width:100px; height:30px; margin-top:-5px" frameborder="0" allowtransparency="true" id="contenido"></iframe><?php }?></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
  ...
  <td ><?php
    ...
    <td>&nbsp;</td>
    <td>Integrante 6</td>
    <td><input type="text" id="x_integrante_6" name="x_integrante_6" maxlength="250" size="80"   value="<?php echo htmlentities($x_integrante_6);?>"/></td>
    ...
    <td><?php if(!empty($x_integrante_6)) { ?><iframe name="comentarios" src="php_visor_integrantes.php?key=<?php echo $x_cliente_id_6;?>&nombre=<?php echo htmlentities($x_integrante_6)?>&monto=<?php echo number_format($x_monto_6, 0, '.', '');?>&rol=<?php echo $x_rol_integrante_6;?>&numero=6&sol_id=<?php echo($x_solicitud_id);?>&grupo_id=<?php echo $x_grupo_id ;?>" scrolling="no" style="margin-left:0px; width:100px; height:30px; margin-top:-5px" frameborder="0" allowtransparency="true" id="contenido"></iframe><?php }?></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
  ...
  <td ><?php
    ...
    <td>&nbsp;</td>
    <td>Integrante 7</td>
    <td><input type="text" id="x_integrante_7" name="x_integrante_7" maxlength="250" size="80"  value="<?php echo htmlentities($x_integrante_7);?>" /></td>
    ...
    <td><?php if(!empty($x_integrante_7)) { ?><iframe name="comentarios" src="php_visor_integrantes.php?key=<?php echo $x_cliente_id_7;?>&nombre=<?php echo htmlentities($x_integrante_7)?>&monto=<?php echo number_format($x_monto_7, 0, '.', '');?>&rol=<?php echo $x_rol_integrante_7;?>&numero=7&sol_id=<?php echo($x_solicitud_id);?>&grupo_id=<?php echo $x_grupo_id ;?>" scrolling="no" style="margin-left:0px; width:100px; height:30px; margin-top:-5px" frameborder="0" allowtransparency="true" id="contenido"></iframe><?php }?></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
  ...
  <td ><?php
    ...
    <td>&nbsp;</td>
    <td>Integrante 8</td>
    <td><input type="text" id="x_integrante_8" name="x_integrante_8" maxlength="250" size="80"   value="<?php echo htmlentities($x_integrante_8);?>"/></td>
    ...
    <td><?php if(!empty($x_integrante_8)) { ?><iframe name="comentarios" src="php_visor_integrantes.php?key=<?php echo $x_cliente_id_8;?>&nombre=<?php echo htmlentities($x_integrante_8)?>&monto=<?php echo number_format($x_monto_8, 0, '.', '');?>&rol=<?php echo $x_rol_integrante_8;?>&numero=8&sol_id=<?php echo($x_solicitud_id);?>&grupo_id=<?php echo $x_grupo_id ;?>" scrolling="no" style="margin-left:0px; width:100px; height:30px; margin-top:-5px" frameborder="0" allowtransparency="true" id="contenido"></iframe><?php }?></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  ...
  <td ><?php
    ...
    <td>&nbsp;</td>
    <td>Integrante 9</td>
    <td><input type="text" id="x_integrante_9" name="x_integrante_9" maxlength="250" size="80"  value="<?php echo htmlentities($x_integrante_9);?>" /></td>
    ...
    <td><?php if(!empty($x_integrante_9)) { ?><iframe name="comentarios" src="php_visor_integrantes.php?key=<?php echo $x_cliente_id_9;?>&nombre=<?php echo htmlentities($x_integrante_9)?>&monto=<?php echo number_format($x_monto_9, 0, '.', '');?>&rol=<?php echo $x_rol_integrante_9;?>&numero=9&sol_id=<?php echo($x_solicitud_id);?>&grupo_id=<?php echo $x_grupo_id ;?>" scrolling="no" style="margin-left:0px; width:100px; height:30px; margin-top:-5px" frameborder="0" allowtransparency="true" id="contenido"></iframe><?php }?></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  ...
  <td ><?php
    ...
    <td>&nbsp;</td>
    <td>Integrante 10</td>
    <td><input type="text" id="x_integrante_10" name="x_integrante_10" maxlength="250" size="80"  value="<?php echo htmlentities($x_integrante_10);?>"/></td>
    ...
    <td><?php if(!empty($x_integrante_10)) { ?><iframe name="comentarios" src="php_visor_integrantes.php?key=<?php echo $x_cliente_id_10;?>&nombre=<?php echo htmlentities($x_integrante_10)?>&monto=<?php echo number_format($x_monto_10, 0, '.', '');?>&rol=<?php echo $x_rol_integrante_10;?>&numero=10&sol_id=<?php echo($x_solicitud_id);?>&grupo_id=<?php echo $x_grupo_id ;?>" scrolling="no" style="margin-left:0px; width:100px; height:30px; margin-top:-5px" frameborder="0" allowtransparency="true" id="contenido"></iframe> <?php }?> </td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
    <tr>
  ...
  <td >&nbsp;</td>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td ><input name="Action" type="button" class="boton_medium" value="Editar" onClick="EW_checkMyForm();" /></td>
  <td >&nbsp;</td>
  <td >&nbsp;</td>
  </tr>
</table>
