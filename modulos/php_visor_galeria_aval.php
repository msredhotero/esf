...
$sSqlWrk = "SELECT galeria_fotografica_id FROM galeria_fotografica Where solicitud_id = $x_solicitud_id  and tipo_galeria_id= 2";
	...
	if($x_galeria_fotografica_id > 0 ){
		echo "<a href='../php_galeriaview.php?x_galeria_fotografica_id=$x_galeria_fotografica_id' target='_blank'>Ir a galeria aval</a>";
	}else{
		echo " ";
