...
<table align="center">
	<tr>
		<td>
			<input name="ActionValidar" type="button" id="btnValidar" class="boton_medium_validar" value="Validar Lista Negra" />
		</td>
		<td>
			<img id="btnReporte" src="../images/pdf.png" width="48" style="cursor: pointer;">
		</td>
	</tr>
	<tr>
		<td>
			<input name="Action2" type="button" id="agregarSolicitud" class="boton_medium" value="Agregar Solicitud" onclick="EW_checkMyForm();" />
		</td>
	</tr>
</table>
</form>
