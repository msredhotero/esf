...
?>
      ...
      <tr>
        ...
        <?php if($x_solicitud_status_id < 5){?>
            <input class="importe" name="x_importe_solicitado" type="text" id="x_importe_solicitado" value="<?php echo FormatNumber(@$x_importe_solicitado,0,0,0,0) ?>" size="10" maxlength="10" onKeyPress="return solonumeros(this,event)" onBlur="validaimporte()" <?php echo $x_readonly;?>/><?php } else{
  ...
  <tr>
    ...
    <tr>
     ...
     <tr>
      ...
      <td width="48">Sexo</td>
      <td width="80"><label>
        <select name="x_sexo" id="x_sexo" <?php echo $x_readonly;?> onChange="generaCurpRfc(this,'txtHintcurp', 'txtHintrfc');">
    ...
    <tr>
      ...
      <td width="48">CURP</td>
      <td width="80"><div id="txtHintcurp"><input type="text" name="x_curp" id="x_curp" size="20" maxlength="150" value="<?php echo htmlentities(@$x_curp) ?>"  <?php echo $x_readonly;?>/></div></td>
    ...
    <tr>
      <td>Escolaridad</td>
      <td colspan="2"><?php
		$x_entidad_idList = "<select name=\"x_estudio_id\"  $x_readonly id=\"x_estudio_id\"  >";
		$x_entidad_idList .= "<option value=''>Seleccione</option>";
      ...
      <td colspan="6"><?php
		$x_entidad_idList = "<select name=\"x_rol_hogar_id\" id=\"x_rol_hogar_id\"   $x_readonly >";
		$x_entidad_idList .= "<option value=''>Seleccione</option>";
    ...
    <tr>
      ...
      <td colspan="6"><?php
		$x_entidad_idList = "<select name=\"x_destino_credito_id\"  $x_readonly id=\"x_destino_credito_id\"  >";
		$x_entidad_idList .= "<option value=''>Seleccione</option>";
    ...
    <tr>
      ...
      <td><select name="x_ppe" id="x_ppe" <?php echo $x_readonly;?> >
      ...
      <td colspan="6"><table width="341"  border="0" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td width="147" ><?php
		$x_parentesco_tipo_idList = "<select name=\"x_parentesco_ppe\"  $x_readonly; id=\"x_parentesco_ppe\" >";
    ...
    <tr>
      <td>Entidad</td>
      <td colspan="4"><?php
		$x_entidad_idList = "<select name=\"x_entidad_domicilio\" id=\"x_entidad_domicilio\" $x_readonly onchange=\"showHint(this,'txtHint1', 'x_delegacion_id')\" >";
		$x_entidad_idList .= "<option value=''>Seleccione</option>";
      ...
      <td colspan="6"><div align="left"><span class="texto_normal">
		...
		$x_delegacion_idList = "<select name=\"x_delegacion_id\"  echo $x_readonly>";
    ...
    <tr>
      ...
      <td colspan="4"><div id="txtHint3" class="texto_normal">
        <?php  
$x_delegacion_idList = "<select name=\"x_localidad_id\" $x_readonly >";
$x_delegacion_idList .= "<option value=''>Seleccione</option>";
...
echo $x_delegacion_idList;
    ...
    <tr>
      ...
      <td colspan="4">
      <?php
		$x_vivienda_tipo_idList = "<select name=\"x_tipo_vivienda\" $x_readonly id=\"x_tipo_vivienda\"  class=\"texto_normal\" onchange=\"viviendatipo('1')\">";
  ...
  <tr>
    ...
    <tr>
      <td>Giro Negocio</td>
      <td colspan="4"> <?php
		$x_entidad_idList = "<select name=\"x_giro_negocio_id\" $x_readonly id=\"x_giro_negocio_id\"  >";
		$x_entidad_idList .= "<option value=''>Seleccione</option>";
      ...
      <td colspan="5"> <?php
		$x_entidad_idList = "<select name=\"x_tipo_inmueble_id\" $x_readonly; id=\"x_tipo_inmueble_id\"  >";
		$x_entidad_idList .= "<option value=''>Seleccione</option>";
    ...
    <tr>
      ...
      <td colspan="4"><select name="x_atiende_titular" <?php echo $x_readonly;?>>
    ...
    <tr>
      <td>Calle</td>
      <td colspan="10"><input type="text" name="x_calle_negocio" id="x_calle_negocio" value="<?php echo htmlspecialchars(@$x_calle_negocio) ?>"  maxlength="250" size="100" <?php echo $x_readonly;?>/></td>
    </tr>
    <tr>
      <td>Colonia</td>
    ...
    <tr>
      <td>Entidad</td>
      <td colspan="4"><?php
		$x_entidad_idList2 = "<select name=\"x_entidad_negocio\" id=\"x_entidad_negocio\" $x_readonly  onchange=\"showHint(this,'txtHint2', 'x_delegacion_id2')\" >";
      ...
      <td colspan="6"><div align="left"><span class="texto_normal">
		...
		$x_delegacion_idList = "<select name=\"x_delegacion_id2\" $x_readonly >";
		$x_delegacion_idList .= "<option value=''>Seleccione</option>";
    ...
    <tr>
      ...
      <?php  
$x_delegacion_idList = "<select name=\"x_localidad_id2\" $x_readonly  >";
$x_delegacion_idList .= "<option value=''>Seleccione</option>";
$sSqlWrk = "SELECT localidad_id, descripcion FROM localidad where delegacion_id = $x_delegacion_id";
$rswrk = phpmkr_query($sSqlWrk,$conn) or die("Failed to execute query" . phpmkr_error() . ' SQL:' . $sSqlWrk);
if ($rswrk) {
...
echo $x_delegacion_idList;
    ...
    <tr>
      ...
      <td colspan="4">
      <?php
		$x_vivienda_tipo_idList = "<select name=\"x_tipo_local_negocio\" id=\"x_tipo_local_negocio\" $x_readonly   onchange=\"viviendatipo('1')\">";
		$x_vivienda_tipo_idList .= "<option value=''>Seleccione</option>";
		$sSqlWrk = "SELECT `vivienda_tipo_id`, `descripcion` FROM `vivienda_tipo`";
		$rswrk = phpmkr_query($sSqlWrk,$conn) or die("Failed to execute query" . phpmkr_error() . ' SQL:' . $sSqlWrk);
		if ($rswrk) {
  ...
  <tr>
    ...
    <tr>
      ...
      <td colspan="6">
         <?php
		$x_parentesco_tipo_idList = "<select name=\"x_parentesco_ref_1\" $x_readonly id=\"x_parentesco_ref_1\" >";
		$x_parentesco_tipo_idList .= "<option value=''>Seleccione</option>";
		$sSqlWrk = "SELECT `parentesco_tipo_id`, `descripcion` FROM `parentesco_tipo`";
		$rswrk = phpmkr_query($sSqlWrk,$conn) or die("Failed to execute query" . phpmkr_error() . ' SQL:' . $sSqlWrk);
		if ($rswrk) {
    ...
    <tr>
      ...
      <td colspan="6">
      <?php
		$x_parentesco_tipo_idList = "<select name=\"x_parentesco_ref_2\" id=\"x_parentesco_ref_2\"  $x_readonly >";
		$x_parentesco_tipo_idList .= "<option value=''>Seleccione</option>";
		$sSqlWrk = "SELECT `parentesco_tipo_id`, `descripcion` FROM `parentesco_tipo`";
		$rswrk = phpmkr_query($sSqlWrk,$conn) or die("Failed to execute query" . phpmkr_error() . ' SQL:' . $sSqlWrk);
		if ($rswrk) {
    ...
    <tr>
      ...
      <td colspan="6">
      <?php
		$x_parentesco_tipo_idList = "<select name=\"x_parentesco_ref_3\" id=\"x_parentesco_ref_3\"  $x_readonly >";
		$x_parentesco_tipo_idList .= "<option value=''>Seleccione</option>";
		$sSqlWrk = "SELECT `parentesco_tipo_id`, `descripcion` FROM `parentesco_tipo`";
		$rswrk = phpmkr_query($sSqlWrk,$conn) or die("Failed to execute query" . phpmkr_error() . ' SQL:' . $sSqlWrk);
		if ($rswrk) {
    ...
    <tr>
     ...
     <td colspan="2"><table width="160"><tr>
      ...
      <td colspan="6">
      <?php
		$x_parentesco_tipo_idList = "<select name=\"x_parentesco_ref_4\" id=\"x_parentesco_ref_4\" $x_readonly >";
		$x_parentesco_tipo_idList .= "<option value=''>Seleccione</option>";
		$sSqlWrk = "SELECT `parentesco_tipo_id`, `descripcion` FROM `parentesco_tipo`";
		$rswrk = phpmkr_query($sSqlWrk,$conn) or die("Failed to execute query" . phpmkr_error() . ' SQL:' . $sSqlWrk);
		if ($rswrk) {
    ...
    <td><select name="x_v_p_d_th" id="x_v_p_d_th" <?php echo $x_readonly;?>>
    <option value="0">Seleccione</option>
    ...
    <td><select name="x_v_p_n_th" id="x_v_p_n_th" <?php echo $x_readonly;?>>
    <option value="0">Seleccione</option>
   ...
   <tr>
    ...
    <td><select name="x_v_p_d_a" id="x_v_p_d_a" <?php echo $x_readonly;?>>
    <option value="0">Seleccione</option>
    ...
    <td><select name="x_v_p_n_a" id="x_v_p_n_a" <?php echo $x_readonly;?>>
    <option value="0">Seleccione</option>
   ...
   <tr>
    ...
    <td>&nbsp;   </td>
    <td colspan="4">Se realizo la visita a domicilio de TH            </td>
    <td><select name="x_v_s_d_th" id="x_v_s_d_th" <?php echo $x_readonly;?> >
    <option value="0">Seleccione</option>
    ...
    <td>&nbsp;   </td>
    <td colspan="4">Se realizo la visita a Negocio de TH             </td>
    <td><select name="x_v_s_n_th" id="x_v_s_n_th" <?php echo $x_readonly;?>>
    <option value="0">Seleccione</option>
   ...
   <tr>
    <td>&nbsp;   </td>
    <td>&nbsp;   </td>
    <td colspan="6" align="center"><textarea cols="100" rows="5" name="x_resultado_visita_sup_th" id="" <?php echo $x_readonly;?>><?php echo $x_resultado_visita_sup_th; ?></textarea></td>
    <td>&nbsp;   </td>
    <td>&nbsp;   </td>
    <td>&nbsp;   </td>
   </tr>
   ...
   <tr>
    ...
    <td>&nbsp;   </td>
    <td colspan="4">Se realizo la visita a domicilio de Aval</td>
    <td><select name="x_v_s_d_a" id="x_v_s_d_a" <?php echo $x_readonly;?>>
    <option value="0">Seleccione</option>
    ...
    <td>&nbsp;   </td>
    <td colspan="4">Se realizo la visita a Negocio de Aval</td>
    <td><select name="x_v_s_n_a" id="x_v_s_n_a" <?php echo $x_readonly;?>>
    <option value="0">Seleccione</option>
...
function LoadData($conn)
{
	...
	if (phpmkr_num_rows($rs) == 0) {
		...
		if($GLOBALS["x_solicitud_status_id"] == 3 ){
