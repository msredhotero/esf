  ...
  <tr>
     ...
     <td>2</td>
	  ...
	  if($x_tipo_id ==2 || $x_tipo_id == 3)
	   $x_periodo = (!empty($x_periodo)) ? $x_periodo:$temp_periodo2 ; 
	  ?>
...
function LoadData($conn, $cliente_id, $solicitud_id, $tipo_reporte_id, $id){
		...
		$sSql = " SELECT * FROM reporte_cnbv WHERE cliente_id = ".$cliente_id." AND solicitud_id = ".$solicitud_id." AND tipo_reporte_id = ".$tipo_reporte_id."";
		#33echo "<BR>".$sSql."==><BR>";
