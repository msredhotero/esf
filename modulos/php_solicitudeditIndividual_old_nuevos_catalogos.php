  ...
  <tr>
    ...
    <tr>
      <td colspan="11"><table width="80%">
        <tr>
          <td width="8%">Valor</td>
          <td width="92%"><input type="text" name="x_garantia_valor" id="x_garantia_valor"  value="<?php  echo number_format($x_garantia_valor, 0, '.', '');?>"onKeyPress="return solonumeros(this,event)" /></td>
        </tr>
      </table>  </td>
    </tr>
    <tr>
