      ...
      <tr>
        ...
        <td>
			...
			if($x_credito_tipo_id == 5){
				...
				$sSqlWrk = "SELECT `solicitud_status_id`, `descripcion` FROM `solicitud_status` where solicitud_status_id  in (3,10,4) ";
				$rswrk = phpmkr_query($sSqlWrk,$conn) or die("Failed to execute query" . phpmkr_error() . ' SQL:' . $sSqlWrk);
				if ($rswrk) {
					$rowcntwrk = 0;
