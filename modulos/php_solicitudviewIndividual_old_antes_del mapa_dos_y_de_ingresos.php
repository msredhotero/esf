...
?>
      ...
      <tr>
        ...
        <td><span class="texto_normal"><input type="text" name="x_plazo_id" id="x_plazo_id"  value="<?php echo $x_plazo_id;?>" maxlength="3" size="15" onKeyPress="return solonumeros(this,event)" onChange="valorMax();" />
          <?php
...
?>
      ...
      <div id="actividad1" class="TG_visible">Espec&acute;ficamente:bb</div>
...
<table align="center">
<tr>
  <td> <input name="button" type="button" class="boton_medium" onclick="window.open('/esf/modulos/tipoCuenta/formatos/php_solicitudIndividualP_print.php?solicitud_id=<?php echo $x_solicitud_id; ?>','Solicitud','width=700,height=500,left=150,top=150,scrollbars=yes');" value="Imprimir" />
    </div></td></td></tr>
</table>
</form>
</body>
