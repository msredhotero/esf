...
if (($sAction == "") || (is_null($sAction))) {
	...
	//visitas
	//vista promotor y supervisor.
	$x_visita_id_1 = $_POST["x_visita_id_1"];
	$x_v_p_d_th = $_POST["x_v_p_d_th"];
	$x_v_p_n_th = $_POST["x_v_p_n_th"];
	$x_resultado_visita_pro_th	= $_POST["x_resultado_visita_pro_th"];
	$x_visita_id_2 = $_POST["x_visita_id_2"];
	$x_v_p_d_a = $_POST["x_v_p_d_a"];
	$x_v_p_n_a = $_POST["x_v_p_n_a"];
	$x_resultado_visita_pro_aval = $_POST["x_resultado_visita_pro_aval"];	
	$x_visita_id_3 = $_POST["x_visita_id_3"];
	$x_v_s_d_th = $_POST["x_v_s_d_th"];
	$x_v_s_n_th = $_POST["x_v_s_n_th"];
	$x_resultado_visita_sup_th	 = $_POST["x_resultado_visita_sup_th"];
	$x_visita_id_4 = $_POST["x_visita_id_4"];
	$x_v_s_d_a = $_POST["x_v_s_d_a"];
	$x_v_s_n_a = $_POST["x_v_s_n_a"];
	$x_resultado_visita_sup_aval  = $_POST["x_resultado_visita_sup_aval"];
...
if (validada == true && EW_this.x_empresa_id && !EW_hasValue(EW_this.x_empresa_id, "SELECT" )) {
	if (!EW_onError(EW_this, EW_this.x_empresa_id, "TEXT", "Debe seleccionar un valor para el campo EMPRESA."))
		validada = false;
}
  ...
  if(EW_this.x_otro_telefono_domicilio_2.value.length > 0){
	 	 if((EW_this.x_otro_telefono_domicilio_2.value.length == 10)){			 
			 if (EW_this.x_compania_celular_id_2 && !EW_hasValue(EW_this.x_compania_celular_id_2, "SELECT" )) {
				if (!EW_onError(EW_this, EW_this.x_compania_celular_id_2, "SELECT", "Debe seleccionar una compañia de telefonos para el campo - Otro Celular"))
				validada = false;
				} 
...
<table width="715" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td colspan="3" align="left" valign="top"><table width="105%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td colspan="5" align="center" valign="top" bgcolor="#FFE6E6" class="texto_normal_bold">Solicitud       
          </td>
      </tr>
      <tr>
      ...
      <tr>
		...
		$x_estado_civil_idList = "<select name=\"x_solicitud_status_id\"  >";
...
<?php
      ...
      <tr>
        ...
        <td colspan="4"><div class="phpmaker">
            <?php
		$x_estado_civil_idList = "<select name=\"x_promotor_id\"  >";
		$x_estado_civil_idList .= "<option value=''>Seleccione</option>";
		if($_SESSION["crm_UserRolID"] == 7) {
...
?>
      ...
      <tr>
        ...
        <?php if($x_solicitud_status_id < 5){?>
            <input class="importe" name="x_importe_solicitado" type="text" id="x_importe_solicitado" value="<?php echo FormatNumber(@$x_importe_solicitado,0,0,0,0) ?>" size="10" maxlength="10" onKeyPress="return solonumeros(this,event)" onBlur="validaimporte()" /><?php } else{
        ...
        <td>
        <?php if($x_solicitud_status_id < 5){?>        
        <span class="texto_normal"><input type="text" name="x_plazo_id" id="x_plazo_id"  value="<?php echo $x_plazo_id;?>" maxlength="3" size="15" onKeyPress="return solonumeros(this,event)" onChange="valorMax();" /><?php } else {  echo $x_plazo_id; ?>
		<input type="hidden" name="x_plazo_id" id="x_plazo_id"  value="<?php echo $x_plazo_id;?>"   />
		<?php }		?>
        
        
          <?php
		/*$x_estado_civil_idList = "<select name=\"x_plazo_id\"  >";
		$x_estado_civil_idList .= "<option value=''>Seleccione</option>";
      ...
      <tr>
		...
		$x_estado_civil_idList = "<select name=\"x_forma_pago_id\"  >";
		$x_estado_civil_idList .= "<option value=''>Seleccione</option>";
  ...
  <tr>
    ...
    <tr>
      <td  colspan="11"  align="center" valign="top" bgcolor="#FFE6E6" class="texto_normal_bold"> Empresa</td>
    </tr>
    <tr>
      <td  colspan="11" >&nbsp; </td>
    </tr>
    <tr>
      ...
      <td  colspan="10" > <?php
		$x_entidad_idList = "<select name=\"x_empresa_id\" id=\"x_empresa_id\" class=\"texto_normal\" >";
		$x_entidad_idList .= "<option value=''>Seleccione</option>";
		$sSqlWrk = "SELECT `empresa_id`, `nombre` FROM `empresa`";
		$rswrk = phpmkr_query($sSqlWrk,$conn) or die("Failed to execute query" . phpmkr_error() . ' SQL:' . $sSqlWrk);
		if ($rswrk) {
			$rowcntwrk = 0;
			while ($datawrk = phpmkr_fetch_array($rswrk)) {
				$x_entidad_idList .= "<option value=\"" . htmlspecialchars($datawrk[0]) . "\"";
				if ($datawrk["empresa_id"] == @$x_empresa_id) {
  ...
  <tr>
    ...
    <tr>
      <td width="72" class="texto_normal" >Titular</td>
      <td colspan="8" align="center"><table width="98%">
        <tr>
          ...
          <td width="34%"><input type="text" name="x_apellido_paterno" id="x_apellido_parterno" value="<?php echo htmlentities(@$x_apellido_paterno) ?>" maxlength="250" size="35" /></td>
          <td width="33%"><input type="text" name="x_apellido_materno" id="x_apellido_materno" value="<?php echo htmlentities(@$x_apellido_materno) ?>" maxlength="250" size="35" /></td>
          </tr>
        <tr>
     ...
     <tr>
      ...
      <td colspan="2"><span class="texto_normal">
              <input name="x_fecha_nacimiento" type="text" id="x_fecha_nacimiento" value="<?php echo FormatDateTime(@$x_tit_fecha_nac,7); ?>" size="25" onChange="generaCurpRfc(this,'txtHintcurp', 'txtHintrfc');"  />
      ...
      <td width="56">Sexo</td>
      <td width="95"><label>
        <select name="x_sexo" id="x_sexo" onChange="generaCurpRfc(this,'txtHintcurp', 'txtHintrfc');">
       ...
       <td width="145">Lugar de nacimiento</td>
      <td width="196" colspan="5"><?php
		$x_entidad_idList = "<select name=\"x_entidad_nacimiento\" id=\"x_entidad_nacimiento\"  onchange=\"generaCurpRfc(this,'txtHintcurp', 'txtHintrfc')\" >";
		$x_entidad_idList .= "<option value=''>Seleccione</option>";
    ...
    <tr>
      <td>RFC</td>
      <td colspan="2"><div id="txtHintrfc"><input type="text" name="x_rfc" id="x_rfc" size="20" maxlength="150" value="<?php echo htmlentities(@$x_rfc) ?>" /></div></td>
      <td width="56">CURP</td>
      <td width="95"><div id="txtHintcurp"><input type="text" name="x_curp" id="x_curp" size="20" maxlength="150" value="<?php echo htmlentities(@$x_curp) ?>" /></div></td>
      <td>Correo Electronico</td>
      <td colspan="5"><input type="text" name="x_correo_electronico" id="x_correo_electronico" value="<?php echo htmlspecialchars(@$x_correo_electronico) ?>"  maxlength="100" size="35"/></td>
    </tr>
    
    <tr>
      <td>Integrantes Familia</td>
      <td colspan="2"><input type="text" name="x_integrantes_familia" id="x_integrantes_familia" value="<?php echo htmlspecialchars(@$x_integrantes_familia) ?>" maxlength="30" size="25"  onkeypress="return solonumeros(this,event)"/></td>
      <td colspan="2">Dependientes</td>
      <td colspan="6"><input type="text" name="x_dependientes" id="x_dependientes" value="<?php echo htmlspecialchars(@$x_dependientes) ?>"  maxlength="30" size="30"  onkeypress="return solonumeros(this,event)"/></td>
    </tr>
    <tr>
    ...
    <tr>
      <td>Escolaridad</td>
      <td colspan="2"><?php
		$x_entidad_idList = "<select name=\"x_estudio_id\" id=\"x_estudio_id\"  >";
		$x_entidad_idList .= "<option value=''>Seleccione</option>";
      ...
      <td colspan="6"><?php
		$x_entidad_idList = "<select name=\"x_rol_hogar_id\" id=\"x_rol_hogar_id\"   >";
		$x_entidad_idList .= "<option value=''>Seleccione</option>";
    ...
    <tr>
      ...
      <td colspan="2"><input type="text" name="x_fecha_ini_act_prod" id="x_fecha_ini_act_prod" value="<?php echo FormatDateTime(@$x_fecha_ini_act_prod,7);?>"   maxlength="100" size="30"/>
      ...
      <td colspan="6"><?php
		$x_entidad_idList = "<select name=\"x_destino_credito_id\" id=\"x_destino_credito_id\"   >";
		$x_entidad_idList .= "<option value=''>Seleccione</option>";
    ...
    <tr>
      ...
      <td colspan="6"><table width="341"  border="0" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td width="147" ><?php
		$x_parentesco_tipo_idList = "<select name=\"x_parentesco_ppe\" id=\"x_parentesco_ppe\"  >";
    ...
    <tr>
      <td colspan="11"  align="left"><table width="71%">
        <tr>
          <td width="26%"><input type="text" name="x_nombre_ppe" id="x_nombre_ppe"  value="<?php  echo $x_nombre_ppe; ?>" maxlength="250" size="35"/></td>
          <td width="25%"><input type="text" name="x_apellido_paterno_ppe"  value="<?php  echo $x_apellido_paterno_ppe; ?>" id="x_apellido_parterno_ppe" maxlength="250" size="35" /></td>
          <td width="49%"><input type="text" name="x_apellido_materno_ppe" value="<?php  echo $x_apellido_materno_ppe; ?>" id="x_apellido_materno_ppe" maxlength="250" size="35" /></td>
          </tr>
        <tr>
          <td>Nombre</td>
          <td>Apellido Paterno</td>
...
echo $x_delegacion_idList;
    ...
    <tr>
      ...
      <td colspan="4">
      <?php
		$x_vivienda_tipo_idList = "<select name=\"x_tipo_vivienda\" id=\"x_tipo_vivienda\"    onchange=\"viviendatipo('1')\">";
    ...
    <tr>
      ...
      <td width="107"><input type="text" name="x_telefono_domicilio" id="x_telefono_domicilio"  value="<?php echo htmlspecialchars(@$x_telefono_domicilio) ?>" maxlength="50" size="25"/></td>
      <td width="57">Otro Tel</td>
  ...
  <tr>
    ...
    <tr>
      <td>Giro Negocio</td>
      <td colspan="4"> <?php
		$x_entidad_idList = "<select name=\"x_giro_negocio_id\" id=\"x_giro_negocio_id\"   >";
		$x_entidad_idList .= "<option value=''>Seleccione</option>";
      ...
      <td colspan="5"> <?php
		$x_entidad_idList = "<select name=\"x_tipo_inmueble_id\" id=\"x_tipo_inmueble_id\"   >";
		$x_entidad_idList .= "<option value=''>Seleccione</option>";
    ...
    <tr>
      ...
      <td colspan="5"> <input type="text" name="x_codigo_postal_negocio" id="x_codigo_postal_negocio" value="<?php echo htmlspecialchars(@$x_codigo_postal_negocio)?>"  maxlength="25" size="30"  onKeyPress="return solonumeros(this,event)"/></td>
    </tr>
    <tr>
      <td>Entidad</td>
      <td colspan="4"><?php
		$x_entidad_idList2 = "<select name=\"x_entidad_negocio\" id=\"x_entidad_negocio\"   onchange=\"showHint(this,'txtHint2', 'x_delegacion_id2')\" >";
      ...
      <td><div align="left"><span class="texto_normal">
		...
		$x_delegacion_idList = "<select name=\"x_delegacion_id2\"  >";
		$x_delegacion_idList .= "<option value=''>Seleccione</option>";
    ...
    <tr>
      ...
      <?php  
$x_delegacion_idList = "<select name=\"x_localidad_id2\"   >";
$x_delegacion_idList .= "<option value=''>Seleccione</option>";
$sSqlWrk = "SELECT localidad_id, descripcion FROM localidad where delegacion_id = $x_delegacion_id";
$rswrk = phpmkr_query($sSqlWrk,$conn) or die("Failed to execute query" . phpmkr_error() . ' SQL:' . $sSqlWrk);
if ($rswrk) {
...
echo $x_delegacion_idList;
      ...
      <input type="text" name="x_ubicacion_negocio" id="x_ubicacion_negocio" value="<?php echo htmlspecialchars(@$x_ubicacion_negocio) ?>" maxlength="250" size="35"/></td>
    </tr>
    <tr>
      <td>Tipo Local</td>
      <td colspan="4">
      <?php
		$x_vivienda_tipo_idList = "<select name=\"x_tipo_local_negocio\" id=\"x_tipo_local_negocio\"    onchange=\"viviendatipo('1')\">";
		$x_vivienda_tipo_idList .= "<option value=''>Seleccione</option>";
		$sSqlWrk = "SELECT `vivienda_tipo_id`, `descripcion` FROM `vivienda_tipo`";
		$rswrk = phpmkr_query($sSqlWrk,$conn) or die("Failed to execute query" . phpmkr_error() . ' SQL:' . $sSqlWrk);
		if ($rswrk) {
    ...
    <tr>
      ...
      <td colspan="4"><input type="text" name="x_ingreso_semanal" id="x_ingreso_semanal" value="<?php echo $x_ingreso_semanal;?>"  maxlength="50" size="20" onKeyPress="return solonumeros(this,event)"/></td>
      <td>Tel. Arrendatario</td>
     ...
     <tr>
      <td colspan="11"  align="left"><table width="90%" height="26" border="0" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td width="444" ><input type="text" name="x_tipo_garantia"  value="<?php echo $x_tipo_garantia;?>" maxlength="500" size="60"/></td>
          <td width="172" >Modelo, A&ntilde;o</td>
          <td width="276"><input type="text" name="x_modelo_garantia" value="<?php echo $x_modelo_garantia; ?>"maxlength="500" size="60" /></td>
        </tr>
      </table></td>
    </tr>
    <tr>
      <td colspan="11"><center><textarea cols="80" rows="4" id="x_garantia_desc" name="x_garantia_desc"><?php echo @$x_garantia_desc; ?></textarea></center></td>
    </tr>
    <tr>
      <td colspan="11">&nbsp;</td>
  </tr>
  ...
  <tr>
      <td colspan="11"><table width="80%">
        <tr>
          ...
          <td><input type="text" name="x_garantia_valor" id="x_garantia_valor" value="<?php  echo number_format($x_garantia_valor, 0, '.', '');?>" onKeyPress="return solonumeros(this,event)" /></td>
          <td>Valor factura</td>
          <td><input type="text" name="x_garantia_valor_factura" id="x_garantia_valor_factura"  value="<?php  echo number_format($x_garantia_valor_factura, 0, '.', '');?>" onKeyPress="return solonumeros(this,event)" /></td>
        </tr>
      </table></td>
    </tr>
    <tr>
  ...
  <tr>
    ...
    <tr>
      ...
      <td colspan="2"><table width="160" height="29"><tr>
        <td width="19">Tel</td>
        <td width="129"><input type="text" name="x_tel_referencia_1" id="x_tel_referencia_1"  value="<?php echo htmlspecialchars(@$x_tel_referencia_1) ?>" maxlength="20" size="30"/></td></tr></table></td>
      <td width="80">Parentesco</td>
      <td colspan="6">
         <?php
		$x_parentesco_tipo_idList = "<select name=\"x_parentesco_ref_1\" id=\"x_parentesco_ref_1\"  >";
		$x_parentesco_tipo_idList .= "<option value=''>Seleccione</option>";
		$sSqlWrk = "SELECT `parentesco_tipo_id`, `descripcion` FROM `parentesco_tipo`";
		$rswrk = phpmkr_query($sSqlWrk,$conn) or die("Failed to execute query" . phpmkr_error() . ' SQL:' . $sSqlWrk);
		if ($rswrk) {
    ...
    <tr>
      ...
      <td colspan="2"><table width="160"><tr>
        <td width="19">Tel</td>
        <td width="129"><input type="text" name="x_tel_referencia_2" id="x_tel_referencia_2"  value="<?php echo htmlspecialchars(@$x_tel_referencia_2) ?>" maxlength="20" size="30"/></td></tr></table></td>
      <td>Parentesco</td>
      <td colspan="6">
      <?php
		$x_parentesco_tipo_idList = "<select name=\"x_parentesco_ref_2\" id=\"x_parentesco_ref_2\"  >";
		$x_parentesco_tipo_idList .= "<option value=''>Seleccione</option>";
		$sSqlWrk = "SELECT `parentesco_tipo_id`, `descripcion` FROM `parentesco_tipo`";
		$rswrk = phpmkr_query($sSqlWrk,$conn) or die("Failed to execute query" . phpmkr_error() . ' SQL:' . $sSqlWrk);
		if ($rswrk) {
    ...
    <tr>
      ...
      <td colspan="2"><table width="183"><tr>
        <td width="19">Tel</td>
        <td width="152"><input type="text" name="x_tel_referencia_3" id="x_tel_referencia_3"  value="<?php echo htmlspecialchars(@$x_tel_referencia_3) ?>"  maxlength="20" size="30"/></td></tr></table></td>
      <td>Parentesco</td>
      <td colspan="6">
      <?php
		$x_parentesco_tipo_idList = "<select name=\"x_parentesco_ref_3\" id=\"x_parentesco_ref_3\"  >";
		$x_parentesco_tipo_idList .= "<option value=''>Seleccione</option>";
		$sSqlWrk = "SELECT `parentesco_tipo_id`, `descripcion` FROM `parentesco_tipo`";
		$rswrk = phpmkr_query($sSqlWrk,$conn) or die("Failed to execute query" . phpmkr_error() . ' SQL:' . $sSqlWrk);
		if ($rswrk) {
    ...
    <tr>
     ...
     <td colspan="2"><table width="160"><tr>
        <td width="17">Tel</td>
        <td width="131"><input type="text" name="x_tel_referencia_4" id="x_tel_referencia_4"  value="<?php echo htmlspecialchars(@$x_tel_referencia_4) ?>" maxlength="20" size="30"/></td></tr></table></td>
      <td>Parentesco</td>
      <td colspan="6">
      <?php
		$x_parentesco_tipo_idList = "<select name=\"x_parentesco_ref_4\" id=\"x_parentesco_ref_4\"  >";
		$x_parentesco_tipo_idList .= "<option value=''>Seleccione</option>";
		$sSqlWrk = "SELECT `parentesco_tipo_id`, `descripcion` FROM `parentesco_tipo`";
		$rswrk = phpmkr_query($sSqlWrk,$conn) or die("Failed to execute query" . phpmkr_error() . ' SQL:' . $sSqlWrk);
		if ($rswrk) {
   ...
   <tr>
    ...
    <td><select name="x_v_p_d_th" id="x_v_p_d_th">
    <option value="0">Seleccione</option>
    ...
    <td><select name="x_v_p_n_th" id="x_v_p_n_th">
    <option value="0">Seleccione</option>
    ...
    <td>&nbsp;   </td>
    <td>&nbsp;   </td>
    <td colspan="6" align="left">Resultado de la visita al TH</td>
    <td>&nbsp;   </td>
    <td>&nbsp;   </td>
    <td>&nbsp;   </td>
   </tr>
   ...
   <tr>
    <td>&nbsp;   </td>
    <td>&nbsp;   </td>
    <td colspan="6" align="center"><textarea cols="100" rows="3" name="x_resultado_visita_pro_th" id=""><?php echo $x_resultado_visita_pro_th; ?> </textarea></td>
    <td>&nbsp;   </td>
    <td>&nbsp;   </td>
    <td>&nbsp;   </td>
   </tr>
   ...
   <tr>
    ...
    <td><select name="x_v_p_d_a" id="x_v_p_d_a">
    <option value="0">Seleccione</option>
    ...
    <td><select name="x_v_p_n_a" id="x_v_p_n_a">
    <option value="0">Seleccione</option>
    ...
    <td>&nbsp;   </td>
    <td>&nbsp;   </td>
    <td colspan="6" align="left">Resultado de la               visita al Aval</td>
    <td>&nbsp;   </td>
    <td>&nbsp;   </td>
    <td>&nbsp;   </td>
   </tr>
   ...
   <tr>
    <td>&nbsp;   </td>
    <td>&nbsp;   </td>
    <td colspan="6" align="center"><textarea cols="100" rows="3" name="x_resultado_visita_pro_aval" id=""><?php echo $x_resultado_visita_pro_aval; ?> </textarea></td>
    <td>&nbsp;   </td>
    <td>&nbsp;   </td>
    <td>&nbsp;   </td>
   </tr>
   ...
   <tr>
    ...
    <td>&nbsp;   </td>
    <td colspan="4">Se realizo la visita a domicilio de TH            </td>
    <td><select name="x_v_s_d_th" id="x_v_s_d_th">
    <option value="0">Seleccione</option>
    ...
    <td>&nbsp;   </td>
    <td colspan="4">Se realizo la visita a Negocio de TH             </td>
    <td><select name="x_v_s_n_th" id="x_v_s_n_th">
    <option value="0">Seleccione</option>
    ...
    <td>&nbsp;   </td>
    <td>&nbsp;   </td>
    <td colspan="6" align="left">Resultado de la               visita alTH</td>
    <td>&nbsp;   </td>
    <td>&nbsp;   </td>
    <td>&nbsp;   </td>
   </tr>
   ...
   <tr>
    <td>&nbsp;   </td>
    <td>&nbsp;   </td>
    <td colspan="6" align="center"><textarea cols="100" rows="3" name="x_resultado_visita_sup_th" id=""><?php echo $x_resultado_visita_sup_th; ?></textarea></td>
    <td>&nbsp;   </td>
    <td>&nbsp;   </td>
    <td>&nbsp;   </td>
   </tr>
   ...
   <tr>
    ...
    <td>&nbsp;   </td>
    <td colspan="4">Se realizo la visita a domicilio de Aval</td>
    <td><select name="x_v_s_d_a" id="x_v_s_d_a">
    <option value="0">Seleccione</option>
    ...
    <td>&nbsp;   </td>
    <td colspan="4">Se realizo la visita a Negocio de Aval</td>
    <td><select name="x_v_s_n_a" id="x_v_s_n_a">
    <option value="0">Seleccione</option>
   ...
   <tr>
    <td>&nbsp;   </td>
    <td>&nbsp;   </td>
    <td colspan="6" align="center"><textarea cols="100" rows="3" name="x_resultado_visita_sup_aval" id=""><?php echo $x_resultado_visita_sup_aval;?> </textarea></td>
    <td>&nbsp;   </td>
    <td>&nbsp;   </td>
    <td>&nbsp;   </td>
   </tr>
  ...
  <tr>
    <td colspan="3" bgcolor="#FFE6E6"><div align="center">Direcci&oacute;n en mapa</div></td>
    </tr>
  <tr>
    <td>&nbsp;</td>
...
<table align="center">
<tr><td>
<?php if(($_SESSION["php_project_esf_status_UserRolID"] == 1) || ($_SESSION["php_project_esf_status_UserRolID"] == 2) || ($_SESSION["php_project_esf_status_UserRolID"] == 3) ||($_SESSION["php_project_esf_status_UserRolID"] == 7)){ ?>
 <?php if(($x_solicitud_status_id != 6) || (($_SESSION["php_project_esf_status_UserRolID"] == 1) || ($_SESSION["php_project_esf_status_UserRolID"] == 2) || ($_SESSION["php_project_esf_status_UserRolID"] == 3)) ){ ?>
 <input name="Action2" type="button"class="boton_medium" value="Editar" <?php if(!empty($GLOBALS["x_editar"])){?>disabled="disabled"<?php }?> onclick="EW_checkMyForm();" /><?php } else { ?>
 <input name="Action3" disabled="disabled" type="button" class="boton_medium" value="Editar"  /><?php }
 }else {?>
 
 <input name="Action4" disabled="disabled" type="button" class="boton_medium" value="Editar"   /><?php }?></td></tr>
</table>
</form>
</body>
</html>
...
function LoadData($conn)
{
	...
	if (phpmkr_num_rows($rs) == 0) {
		...
		$GLOBALS["x_empresa_id"] = $row2["empresa_id"];
		...
		$GLOBALS["x_apellido_materno_ppe"] = $row2["a_materno"];	
			...
			//visita		
		$sSql = "select * from visita where solicitud_id = ".$GLOBALS["x_solicitud_id"]." and tipo_visita_id = 1 and tipo_domicilio_id = 1 ";
		$rs2 = phpmkr_query($sSql,$conn) or die("Failed to execute query: " . phpmkr_error() . '<br>SQL: ' . $sSql);
		$row2 = phpmkr_fetch_array($rs2);
		...
		$GLOBALS["x_resultado_visita_pro_th"] = $row2["resultado"];	
			...
			//visita		
		$sSql = "select * from visita where solicitud_id = ".$GLOBALS["x_solicitud_id"]." and tipo_visita_id = 1 and tipo_domicilio_id = 2 ";
		$rs2 = phpmkr_query($sSql,$conn) or die("Failed to execute query: " . phpmkr_error() . '<br>SQL: ' . $sSql);
		$row2 = phpmkr_fetch_array($rs2);
		...
		$GLOBALS["x_resultado_visita_pro_aval"] = $row2["resultado"];	
			...
			//visita		
		$sSql = "select * from visita where solicitud_id = ".$GLOBALS["x_solicitud_id"]." and tipo_visita_id = 2 and tipo_domicilio_id = 1 ";
		$rs2 = phpmkr_query($sSql,$conn) or die("Failed to execute query: " . phpmkr_error() . '<br>SQL: ' . $sSql);
		$row2 = phpmkr_fetch_array($rs2);
		...
		$GLOBALS["x_resultado_visita_sup_th"] = $row2["resultado"];	
			...
			//visita		
		$sSql = "select * from visita where solicitud_id = ".$GLOBALS["x_solicitud_id"]." and tipo_visita_id = 2 and tipo_domicilio_id = 2 ";
		$rs2 = phpmkr_query($sSql,$conn) or die("Failed to execute query: " . phpmkr_error() . '<br>SQL: ' . $sSql);
		$row2 = phpmkr_fetch_array($rs2);
...
function EditData($conn){
	...
	// eacolaridad
	$theValue = ($GLOBALS["x_empresa_id"] != "") ? intval($GLOBALS["x_empresa_id"]) : "0";
	$fieldList["`empresa_id`"] = $theValue;
