...
Crédito No
<?php }else{ ?>
	<a href="php_fondeo_creditolist.php?order=<?php echo urlencode("credito_id"); ?>">Crédiro No<?php if (@$_SESSION["credito_x_fondeo_credito_id_Sort"] == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif (@$_SESSION["credito_x_fondeo_credito_id_Sort"] == "ASC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></a>
<?php } ?>
		</span></td>
		<td valign="top"><span>
		  Empresa
