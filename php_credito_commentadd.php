...
<p align="center"><span class="phpmaker">Comentarios de Cobranza<br>
  <br>
    <a href="javascript: window.close();">Cerrar ventana</a></span></p>
<form name="credito_commentadd" id="credito_commentadd" action="php_credito_commentadd.php" method="post" onSubmit="return EW_checkMyForm(this);">
<p>
...
?>
	...
	<tr>
	  ...
	  <td class="ewTableAltRow" align="center"><textarea cols="50" rows="10" id="x_comentario_ext" name="x_comentario_ext"><?php echo @$x_comentario_ext; ?></textarea></td>
	</tr>
</table>
<p align="center">
