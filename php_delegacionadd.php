...
<form name="delegacionadd" id="delegacionadd" action="php_delegacionadd.php" method="post" onSubmit="return EW_checkMyForm(this);">
<p>
...
<table class="ewTable">
	<tr>
		<td width="151" class="ewTableHeaderThin"><span>Entidad Federativa </span></td>
...
?>
	...
	<tr>
		<td class="ewTableHeaderThin"><span>Delegacion o Municipio</span></td>
...
function AddData($conn)
{
	...
	if ((@$x_delegacion_id == "") || (is_null($x_delegacion_id))) {
		...
		$sTmp =  (get_magic_quotes_gpc()) ? stripslashes($x_delegacion_id) : $x_delegacion_id;			
		$sWhereChk .= "(`delegacion_id` = " . addslashes($sTmp) . ")";
	}
	if ($bCheckKey) {
