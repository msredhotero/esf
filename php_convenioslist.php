...
?>
<p><span class="phpmaker">CREDITOS CON CONVENIO
<?php if ($sExport == "") { ?>
&nbsp;&nbsp;<a href="php_convenioslist.php?export=excel">Exportar a Excel</a>
&nbsp;&nbsp;<a href="php_convenioslist.php?export=word">Exportar a Word</a>
<?php } ?>
</span></p>
<?php if ($sExport == "") { ?>
<form action="php_convenioslist.php" name="filtros" method="post">
...
<div id="txtlineas" style=" float: left;">
	...
	<tr>
	  ...
	  <td>&nbsp;</td>
	  <td><span class="phpmaker"><a href="php_convenioslist.php?cmd=reset">Mostrar Todos</a>&nbsp;&nbsp; </span></td>
	  <td>&nbsp;</td>
	  <td>&nbsp;</td>
	  <td>&nbsp;</td>
	  <td>&nbsp;</td>
...
?>
<?php if ($sExport == "") { ?>
<form action="php_convenioslist.php" name="ewpagerform" id="ewpagerform">
...
if ($nTotalRecs > 0) {
	...
	if ($nTotalRecs > $nDisplayRecs) {
		...
		<a href="php_convenioslist.php?start=<?php echo $PrevStart; ?>&<?php echo $_QS; ?>"><b>Anterior</b></a>
		<?php
		}
		if ($isPrev || (!$rsEof)) {
			$x = 1;
		...
		<b><?php echo $y; ?></b>
					<?php } else { ?>
		<a href="php_convenioslist.php?start=<?php echo $x; ?>&<?php echo $_QS; ?>"><b><?php echo $y; ?></b></a>
					<?php }
					$x += $nDisplayRecs;
					$y += 1;
				} elseif (($x >= ($dx1-$nDisplayRecs*$nRecRange)) && ($x <= ($dx2+$nDisplayRecs*$nRecRange))) {
					if ($x+$nRecRange*$nDisplayRecs < $nTotalRecs) { ?>
		<a href="php_convenioslist.php?start=<?php echo $x; ?>&<?php echo $_QS; ?>"><b><?php echo $y; ?>-<?php echo ($y+$nRecRange-1);?></b></a>
					<?php } else {
						$ny=intval(($nTotalRecs-1)/$nDisplayRecs)+1;
							if ($ny == $y) { ?>
		<a href="php_convenioslist.php?start=<?php echo $x; ?>&<?php echo $_QS; ?>"><b><?php echo $y; ?></b></a>
							<?php } else { ?>
		<a href="php_convenioslist.php?start=<?php echo $x; ?>&<?php echo $_QS; ?>"><b><?php echo $y; ?>-<?php echo $ny; ?></b></a>
							<?php }
					}
		...
		if (!$rsEof) {
			...
			$isMore = True;  ?>
		<a href="php_convenioslist.php?start=<?php echo $NextStart; ?>&<?php echo $_QS; ?>"><b>Siguiente</b></a>
		<?php } else {
			$isMore = False;
		} ?>
		<br>
...
Crédito No
<?php }else{ ?>
	<a href="php_convenioslist.php?order=<?php echo urlencode("credito_id"); ?>">Cr&eacute;dito No<?php if (@$_SESSION["credito_x_credito_id_Sort"] == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif (@$_SESSION["credito_x_credito_id_Sort"] == "ASC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></a>
<?php } ?>
		</span></td>
		<td valign="top"><span>
Fondo
...
Cliente No
<?php }else{ ?>
	<a href="php_convenioslist.php?order=<?php echo urlencode("cliente_id"); ?>">Cliente No<?php if (@$_SESSION["credito_x_cliente_id_Sort"] == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif (@$_SESSION["credito_x_cliente_id_Sort"] == "ASC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></a>
<?php } ?>
		</span></td>
...
Cliente
<!---
	<a href="php_convenioslist.php?order=<?php //echo urlencode("cliente"); ?>">Cliente<?php //if (@$_SESSION["credito_x_cliente_Sort"] == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php //} elseif (@$_SESSION["credito_x_cliente_Sort"] == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php //} ?></a>
-->    
<?php } ?>
		</span></td>		
		<td valign="top"><span>        
...
Tipo
<?php }else{ ?>
	<a href="php_convenioslist.php?order=<?php echo urlencode("credito_tipo_id"); ?>">Tipo<?php if (@$_SESSION["credito_x_credito_tipo_id_Sort"] == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif (@$_SESSION["credito_x_credito_tipo_id_Sort"] == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></a>
<?php } ?>
		</span></td>
		<td valign="top"><span>
<?php if ($sExport <> "") { ?>
Status
<?php }else{ ?>
	<a href="php_convenioslist.php?order=<?php echo urlencode("credito_status_id"); ?>">Status<?php if (@$_SESSION["credito_x_credito_status_id_Sort"] == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif (@$_SESSION["credito_x_credito_status_id_Sort"] == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></a>
<?php } ?>
		</span></td>
		<td valign="top"><span>
<?php if ($sExport <> "") { ?>
...
<?php }else{ ?>
	<a href="php_convenioslist.php?order=<?php echo urlencode("fecha_otrogamiento"); ?>">Fecha de otrogamiento<?php if (@$_SESSION["credito_x_fecha_otrogamiento_Sort"] == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif (@$_SESSION["credito_x_fecha_otrogamiento_Sort"] == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></a>
<?php } ?>
		</span></td>
<td valign="top"><span>
<?php if ($sExport <> "") { ?>
...
Importe
<?php }else{ ?>
	<a href="php_convenioslist.php?order=<?php echo urlencode("importe"); ?>">Importe<?php if (@$_SESSION["credito_x_importe_Sort"] == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif (@$_SESSION["credito_x_importe_Sort"] == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></a>
<?php } ?>
		</span></td>
		<td valign="top"><span>
Forma de Pago		
...
Medio de pago
<?php }else{ ?>
	<a href="php_convenioslist.php?order=<?php echo urlencode("medio_pago_id"); ?>">Medio de pago<?php if (@$_SESSION["credito_x_medio_pago_id_Sort"] == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif (@$_SESSION["credito_x_medio_pago_id_Sort"] == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></a>
<?php } ?>
		</span></td>
		<td valign="top"><span>
<?php if ($sExport <> "") { ?>
Referencia de pago
<?php }else{ ?>
	<a href="php_convenioslist.php?order=<?php echo urlencode("referencia_pago"); ?>">Referencia de pago&nbsp;(*)<?php if (@$_SESSION["credito_x_referencia_pago_Sort"] == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif (@$_SESSION["credito_x_referencia_pago_Sort"] == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></a>
<?php } ?>
		</span></td>
...
<td><span class="phpmaker"><a href="<?php if ($x_credito_id <> "") {echo "php_creditoview.php?credito_id=" . urlencode($x_credito_id); } else { echo "javascript:alert('Invalid Record! Key is null');";} ?>" target='_blank'>Ver</a>
...
<td><span class="phpmaker"><a href="<?php if ($x_credito_id <> "") {echo "php_creditoedit.php?credito_id=" . urlencode($x_credito_id); } else { echo "javascript:alert('Invalid Record! Key is null');";} ?>" target='_blank'>Editar</a></span></td>
<?php }else{ ?>
