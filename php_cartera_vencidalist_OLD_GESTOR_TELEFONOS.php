...
<div id="txtlineas" style=" float: left;">
  ...
  <tr>
    ...
    <td><select name="x_gestor_srch" >
      ...
      <option value="4561" <?php if ($x_gestor_srch ==  4561){?> selected="selected"<?php }?> >Rodrigo Sanchez </option>
       <option value="6937" <?php if ($x_gestor_srch == 6937){?> selected="selected"<?php }?> >Mauricio Trejo </option>
       <option value="6891" <?php if ($x_gestor_srch == 6891){?> selected="selected"<?php }?>> Cesar Olvera</option>
    </select></td> 
    <td>&nbsp;</td>
