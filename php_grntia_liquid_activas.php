...
?>
<p><span class="phpmaker">GARANTIAS LIQUIDAS ACTIVAS <?php if ($sExport == "") { ?>
&nbsp;&nbsp;<a href="php_grntia_liquid_activas.php?export=excel">Exportar a Excel</a>
&nbsp;&nbsp;<a href="php_grntia_liquid_activas.php?export=word">Exportar a Word</a>
<?php } ?>
</span></p>
...
?>
<?php if ($sExport == "") { ?>
<form action="php_grntia_liquid_activas.php" name="ewpagerform" id="ewpagerform">
...
if ($nTotalRecs > 0) {
	...
	if ($nTotalRecs > $nDisplayRecs) {
		...
		<a href="php_grntia_liquid_activas.php?start=<?php echo $PrevStart; ?>&<?php echo $_QS; ?>"><b>Anterior</b></a>
		<?php
		}
		if ($isPrev || (!$rsEof)) {
			$x = 1;
		...
		<b><?php echo $y; ?></b>
					<?php } else { ?>
		<a href="php_grntia_liquid_activas.php?start=<?php echo $x; ?>&<?php echo $_QS; ?>"><b><?php echo $y; ?></b></a>
					<?php }
					$x += $nDisplayRecs;
					$y += 1;
				} elseif (($x >= ($dx1-$nDisplayRecs*$nRecRange)) && ($x <= ($dx2+$nDisplayRecs*$nRecRange))) {
					if ($x+$nRecRange*$nDisplayRecs < $nTotalRecs) { ?>
		<a href="php_grntia_liquid_activas.php?start=<?php echo $x; ?>&<?php echo $_QS; ?>"><b><?php echo $y; ?>-<?php echo ($y+$nRecRange-1);?></b></a>
					<?php } else {
						$ny=intval(($nTotalRecs-1)/$nDisplayRecs)+1;
							if ($ny == $y) { ?>
		<a href="php_grntia_liquid_activas.php?start=<?php echo $x; ?>&<?php echo $_QS; ?>"><b><?php echo $y; ?></b></a>
							<?php } else { ?>
		<a href="php_grntia_liquid_activas.php?start=<?php echo $x; ?>&<?php echo $_QS; ?>"><b><?php echo $y; ?>-<?php echo $ny; ?></b></a>
							<?php }
					}
		...
		if (!$rsEof) {
			...
			$isMore = True;  ?>
		<a href="php_grntia_liquid_activas.php?start=<?php echo $NextStart; ?>&<?php echo $_QS; ?>"><b>Siguiente</b></a>
		<?php } else {
			$isMore = False;
		} ?>
		<br>
...
<!--<td>&nbsp;</td>-->
<?php } ?>
		<td valign="top">STATUS GARANTIA</td>
		<td valign="top"><span>
MONTO
		</span></td>        
		<td valign="top"><span>
CREDITO NUM
		...
		<td valign="top">STATUS CREDITO</td>
        
		<td valign="top">CREDITO CON GAR</td>		
		</tr>
<?php
...
$nRecActual = 0;
echo "sql ".$sSql;
while (($rowGarania = @phpmkr_fetch_array($rs)) && ($nRecCount < $nStopRec)) {
...
<td >&nbsp;</td>
<td >&nbsp;</td>
<td><?php echo $x_garantia_liquida_id; ?></td>

<td><span class="phpmaker"><?php echo $x_monto;?> </span></td>
<td><span class="phpmaker"><?php echo $x_descripcion;?></span></td>
<td><span class="phpmaker"><?php echo $x_status;?> </span></td>
<td><span class="phpmaker"><?php echo $x_credito_num;?> </span></td>
<td><span class="phpmaker"><?php echo $x_credito_status;?> cres tu</span></td>
