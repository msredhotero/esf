...
//if (!empty($x_usuario_rol_id )) $x_usuario_rol_id  = (get_magic_quotes_gpc()) ? stripslashes($x_usuario_rol_id ) : $x_usuario_rol_id ;
// Get action
...
<p><span class="phpmaker">Edit TABLE: PERMISOS DE USUARIOS<br><br><a href="php_usuario_rollist.php">Back to List</a></span></p>
<form name="usuario_roledit" id="usuario_roledit" action="php_usuario_roledit.php" method="post" onSubmit="return EW_checkMyForm(this);">
<p>
...
<?php echo $x_usuario_rol_id; ?><input type="hidden" id="x_usuario_rol_id" name="x_usuario_rol_id" value="<?php echo htmlspecialchars(@$x_usuario_rol_id); ?>">
</span></td>
	</tr>
	<tr>
