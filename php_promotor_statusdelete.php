...
while ($i < count($arRecKey)){
	...
	// Build the SQL
	$sDbWhere .= "`promotor_status_id`=" . $sRecKey . " AND ";
...
<p><span class="phpmaker">Delete from TABLE: STATUS DE PROMOTORES<br><br><a href="php_promotor_statuslist.php">Back to List</a></span></p>
<form action="php_promotor_statusdelete.php" method="post">
<p>
...
{
	global $x_promotor_status_id;
	$sSql = "Delete FROM `promotor_status`";
	$sSql .= " WHERE " . $sqlKey;
