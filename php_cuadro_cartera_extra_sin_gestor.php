  ...
  <tr>
    ...
    <option value="0">Seleccionar</option>    
      ...
      <option value="7188" <?php if ($x_gestor_srch == 7188){?> selected="selected"<?php }?>>Cesar Olvera</option>
       <option value="7202" <?php if ($x_gestor_srch == 7188){?> selected="selected"<?php }?>>Jose Trejo</option>
      </select>
...
$x_rango_vig_0 = 0;
$sSql = "
select credito.credito_id from credito where credito_status_id in (4) and credito_id not in (15) and credito_id not in (select credito_id from gestor_credito )  order by credito.credito_id 
";
