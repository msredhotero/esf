...
switch ($sAction)
{
	case "A": // Add
		if (AddData($conn)) { // Add New Record
			echo "The file has been uploaded.<br><br><a href='javascript: window.close();'>Close this window</a>";
//			mail("jose@expocontacto.com","archivo hog","Se ha cargado un nuevo archivo hog","HOG","HOG WEB");
			exit();
		}
		break;
}
...
alert("Please wait for your file to be uploaded, press ok to continue.");
return true;
}
