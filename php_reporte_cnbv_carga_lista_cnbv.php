...
<form action="php_reporte_cnbv_carga_lista_cnbv_importar.php" enctype="multipart/form-data" method="post">
...
$x_archivo_cnbv_lin1 = "php_reporte_cnbv_descarga_ficheros.php?archivo=".$x_carpeta."PLANTILLAS/plantilla_lista_negra_cnbv.xlsx";
?>
<table  border="0" 
...
<table width="800" border="0" align="center" cellpadding="1" cellspacing="0"  class="texto_normal_SIP">
    <tr>
      <td colspan="7" valign="top"  class="encabezado_crea"> Cargar archivo .csv a la lista Negra de la CNBV </td>
    </tr>
...
<p><b>Ejemplo: </b>DOB 06 AUG 1981; ALT. DOB 23 JUN 1981; ALT. DOB 01 JAN 1980; NATIONALITY IRAN; ADDITIONAL SANCTIONS INFORMATION - SUBJECT TO SECONDARY SANCTIONS; A.K.A. H4MID@TM3L; LINKED TO: ITSEC TEAM.
<P>
...
<BR />2.-  Cuando se descarga se puede observar que viene un registro de ejemplo, el cual se debera sustituir por los registros que se desean agragar a la lista
