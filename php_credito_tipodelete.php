...
while ($i < count($arRecKey)){
	...
	// Build the SQL
	$sDbWhere .= "`credito_tipo_id`=" . $sRecKey . " AND ";
...
<p><span class="phpmaker">Delete from TABLE: PORTAFOLIO<br><br><a href="php_credito_tipolist.php">Back to List</a></span></p>
<form action="php_credito_tipodelete.php" method="post">
<p>
...
<table class="ewTable">
	<tr class="ewTableHeader">
		...
		<td valign="top"><span>Monto mínimo</span></td>
		<td valign="top"><span>Monto máximo</span></td>
