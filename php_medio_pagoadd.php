...
<form name="medio_pagoadd" id="medio_pagoadd" action="php_medio_pagoadd.php" method="post" onSubmit="return EW_checkMyForm(this);">
<p>
...
<table class="ewTable_small">
	<tr>
		<td width="89" class="ewTableHeader"><span>Descripción</span></td>
		<td width="899" class="ewTableAltRow"><span>
...
function AddData($conn)
{
	...
	if ((@$x_medio_pago_id == "") || (is_null($x_medio_pago_id))) {
		...
		$sTmp =  (get_magic_quotes_gpc()) ? stripslashes($x_medio_pago_id) : $x_medio_pago_id;			
		$sWhereChk .= "(`medio_pago_id` = " . addslashes($sTmp) . ")";
	}
	if ($bCheckKey) {
