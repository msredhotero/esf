...
$certificado = "gfo090825gv3_1103162027";
//$maquina = trim(`uname -n`);
echo "archivo".$certificado."<br>";
...
if ((int)substr($arr['fecha'],0,4) >= 2011) {
    openssl_sign($cadena_original, $crypttext, $pkeyid);
} else {
    openssl_sign($cadena_original, $crypttext, $pkeyid);
}
...
$x_file_xml .= 'fecha="2010-05-03T14:11:36" ' ;
$x_file_xml .= 'sello="'.$sello."\"";
$x_file_xml .= " certificado=\"".$certificado."\" ";
$x_file_xml .= "subTotal=\"".$arr['subTotal']."\" ";
$x_file_xml .= "total=\"".$arr['total']."\" ";
$x_file_xml .= "noAprobacion=\"".$arr['noAprobacion']."\" ";
$x_file_xml .= "anoAprobacion=\"".$arr['anoAprobacion']."\" ";
