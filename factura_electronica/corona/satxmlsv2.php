...
$cadena_original .='500|'; //folio
$cadena_original .='A|'; //folio
...
#$cadena_original .='0|'; // descuento
$cadena_original .='2320.00|'; // total
$cadena_original .='MCR070419KN2|'; // rfc ####  EMISOR #####
$cadena_original .='FINANCIERA CREA|'; // nombre
...
$cadena_original .='1|'; // noIdentificacion
...
echo "cadena original + sha1<BR>".$cadena_original."<br>";
/////////////////////////////////////////////////////
...
echo "llave privada".$pkeyid."<br>";
    ...
    openssl_sign($cadena_original, $cadena_firmada, $pkeyid, OPENSSL_ALGO_SHA1);
	$ok = openssl_sign($cadena_original, $cadena_firmada, $pkeyid, OPENSSL_ALGO_SHA1);
#} else {
 #   openssl_sign($cadena_original, $cadena_firmada, $pkeyid, OPENSSL_ALGO_MD5);
#}
...
$x_file_xml .= 'serie="A" '; 
$x_file_xml .= 'folio="500" ';
$x_file_xml .= 'fecha="2012-02-14T17:21:00" ' ;//02/14/12 17:21:00 
...
$x_file_xml .= 'subTotal="2000.00" ';
$x_file_xml .= 'total="2320.00" ';
...
$x_file_xml .= '<Concepto cantidad="1" unidad="Servicio" noIdentificacion="1" descripcion="Asesoria Fiscal y administrativa" valorUnitario="2000.00" importe="2000.00"/>';
$x_file_xml .= '</Conceptos>';
