...
while ($i < count($arRecKey)){
	...
	// Build the SQL
	$sDbWhere .= "`credito_status_id`=" . $sRecKey . " AND ";
...
<p><span class="phpmaker">Delete from TABLE: STATUS DE CREDITO<br><br><a href="php_credito_statuslist.php">Back to List</a></span></p>
<form action="php_credito_statusdelete.php" method="post">
<p>
...
{
	global $x_credito_status_id;
	$sSql = "Delete FROM `credito_status`";
	$sSql .= " WHERE " . $sqlKey;
