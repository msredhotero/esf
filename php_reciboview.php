...
<?php echo $x_referencia_pago; ?>
	...
	<tr>
	  <td class="ewTableHeaderThin"><span>Referencia de pago 2</span></td>
	  <td class="ewTableAltRow"><?php echo $x_referencia_pago_2; ?></td>
	  </tr>
	<tr>
...
function LoadData($conn)
{
	...
	if (phpmkr_num_rows($rs) == 0) {
		...
		$GLOBALS["x_referencia_pago_2"] = $row["referencia_pago2"];		
