<?php
/*
Spanish description: Clase para generar una CURP y comprovar la existencia en el la pagina oficial
English description: Class for generate a CURP (Clave Unica de Registro de Poblacion...unique key of record of population ) and test it in the official page if it is register
Autor:Rafael Rojas Torres
Email: duranguenze@gmail.com
Web: None*/
...
$Entidad = "MORELOS";
$x_curp = new B_CURP();
 $x_re = $x_curp->SetDatos($Nombre, $Ape1, $Ape2, $Sexo, $Dia, $Mes, $Anio, $Entidad);
echo    $x_re;
...
class B_CURP{
	...
	private $Articulos=array(" DE ", " LA ", " LOS ", " LAS ", " Y ");//articulos que van con los apellidos el espacio  de los articulos es muy importante //articles come with second names, important the space of the text
	...
	public function SetDatos($Nombre="", $Ape1="", $Ape2="", $Sexo="", $Dia=0, $Mes=0, $Anio=0, $Entidad=0){
		...
		//remplaza los articulos agregamos un espacio para que no nos trunque lo que no debe ser//replace the articles	
		$Ape1=trim(str_replace($Articulos,""," ".$Ape1)); trim($Ape2=str_replace($Articulos,""," ".$Ape2));
