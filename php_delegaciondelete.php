...
while ($i < count($arRecKey)){
	...
	// Build the SQL
	$sDbWhere .= "`delegacion_id`=" . $sRecKey . " AND ";
...
<form action="php_delegaciondelete.php" method="post">
<p>
...
<table class="ewTable_small">
	<tr class="ewTableHeader">
		<td width="47" valign="top"><span>No</span></td>
		<td width="310" valign="top"><span>Entidad</span></td>
		<td width="427" valign="top"><span>Nombre</span></td>
	</tr>
<?php
$nRecCount = 0;
$i = 0;
