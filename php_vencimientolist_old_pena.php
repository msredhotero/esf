...
$sDbWhere = "(vencimiento.credito_id = $x_credito_id) AND  vencimiento.vencimiento_num < 2000 )   ";
...
if(($_SESSION["php_project_esf_status_UserRolID"] == 3) || ($_SESSION["php_project_esf_status_UserRolID"] == 1)){
	if($x_vencimiento_status_idc == 1 || $x_vencimiento_status_idc == 3 || $x_vencimiento_status_idc == 6  || $x_vencimiento_status_idc == 8){
		echo " <a href=php_credito_condonar_comision.php?credito_id=$x_credito_id&x_refloc=$x_ref_loc target=\"_self\">  Condonar</a>";
	}else{
//		echo $x_ref_loc; 	
	}
}else{
...
<tr <?php echo $sItemRowClass; ?><?php echo $sListTrJs; ?>>
<td><?php echo  FormatDateTime($x_fecha,7); ?></td>
<td><?php echo (is_numeric($x_monto)) ? FormatNumber($x_monto,2,0,0,1) : $x_monto; ?></td>
<td align="left"><h3><strong><?php echo $x_status?></strong></h3></td>
<td align="center"><?php echo $x_detalle;?></td>
</tr>
</table>
<?php }?>
<?php }?>
