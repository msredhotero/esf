...
while ($row = @phpmkr_fetch_array($rs)){
	...
	$dias_diferencia = $rowDisf["dias_dif"];
	 ...
	 $sqlStatusContacto = "SELECT telefono_status.descripcion as status_telefono  FROM telefono_contacto_status join telefono_status on telefono_status.telefono_status_id =  telefono_contacto_status.telefono_status_id where credito_id = $x_credito_id ";
...
order by vencimiento_num+0	
	...
	$sqlCaso = "SELECT * FROM crm_caso WHERE crm_caso_tipo_id = 3 and credito_id = $x_credito_id ";//and  ";
...
<td><span><a href="php_telefono_contacto_statusedit.php?x_credito_id=<?php echo $x_credito_id; ?>" ><?php echo $x_estatus_contacto; ?></a></span></td>
...
<td><span><a href="modulos/casos_view.php?key=<?php echo $x_crm_caso_id;?>" target="_blank">Ver tareas </a></span><a class='iframe' href="modulos/casos_view.php?key=<?php echo $x_crm_caso_id;?>">Outside Webpage (Iframe)</a></td>
