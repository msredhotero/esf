...
$reporte_cnbv_id=  $_GET["reporte_cnbv_id"];
...
$nombre_archivo =  "2069119".$año_nombre_reporte.".002";
...
$rs2 = phpmkr_query($SQLInsert,$conn) or die("Error al seleccionar los datos de la solicitud".phpmkr_error()."sql :".$SQLInsert);
	...
	echo "<center>
	ARCHIVO GENERADO CORRECTAMENTE <br>OPERACI&Oacute;N INUSUAL<BR>".$nombre_archivo."<br></center>";
