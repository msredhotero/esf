...
if (($sKey == "") || ((is_null($sKey)))) {
	ob_end_clean(); 
	header("Locationphp_responsable_sucursallist.php"); 
}
...
<p><span class="phpmaker">RESPONSABLE DE SUCURSAL<br><br>
<a href="php_responsable_sucursallist.php">Regrsar a la lista</a>&nbsp;&nbsp;&nbsp;
</span></p>
<p>
<form>
<table class="ewTable">
	<tr>
		<td width="302" class="ewTableHeaderThin"><span>responsable sucursal id</span></td>
		<td width="686" class="ewTableAltRow"><span>
<?php echo $x_responsable_sucursal_id; ?>
</span></td>
	</tr>
	<tr>
		<td class="ewTableHeaderThin"><span>sucursal </span></td>
...
<?php echo $x_nombre_completo; ?>
	...
	<tr>
		<td class="ewTableHeaderThin">correo electronico</td>
		<td class="ewTableAltRow"><span>
<?php echo $x_email; ?>
</span></td>
	</tr>
...
<?php echo $x_telefono_sucursal; ?>
	...
	<tr>
		<td class="ewTableHeaderThin"><span> movil</span></td>
		<td class="ewTableAltRow"><span>
