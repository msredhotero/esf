...
while ($i < count($arRecKey)){
	...
	// Build the SQL
	$sDbWhere .= "`cuenta_cont_tipo_id`=" . $sRecKey . " AND ";
...
<form action="php_cuenta_cont_tipodelete.php" method="post">
<p>
...
<table class="ewTable">
	<tr class="ewTableHeader">
		...
		<td valign="top"><span>Descripcion Corta</span></td>
	</tr>
<?php
$nRecCount = 0;
$i = 0;
...
{
	global $x_cuenta_cont_tipo_id;
	$sSql = "Delete FROM `cuenta_cont_tipo`";
	$sSql .= " WHERE " . $sqlKey;
