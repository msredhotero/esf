...
<head>  
  ...
  <style type="text/css" media="screen">
    html { background: #ddd; }
    body { font: normal 10px/1.6 'Open Sans', "Helvetica Neue", Arial, sans-serif; font-weight: 300; color: #777; padding: 2em 5%; width: 80%; max-width: 900px; margin: 0 auto; background: #fff; }
    small { color: #aaa; }
...
<script language="javascript">
  ...
  $('input').keypress(function(e){
	...
	$('x_envia').click(function (evento){
		$('#x_form_nueva_dispo').submit();
		
		});	
	});
	</script>

  <title>FINANCIERA CREA ==CREDITO DISPONIBLE==</title>
</head> 

<body>
<CENTER><form action="php_credito_revolvente_inc_lien_form.php"  id="x_form_nueva_dispo" method="post" >
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td colspan="3"  ><CENTER>
      <h3>CR&Eacute;DITO DISPONIBLE</h3></CENTER></td>
    </tr>
  <tr>
    <td width="463"><label>N&uacute;mero de cr&eacute;dito </label></td>
    <td width="339"><strong><?php echo $x_credito_num?></strong></td>
    <td width="46">&nbsp;</td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <tr>
    ...
    <td style="color:#C00"><strong><?php echo $x_sugerido_a_otorgar?></strong><input type="hidden" name="x_monto_maximo_a_otorgar" id="x_monto_maximo_a_otorgar" value="<?php echo $x_sugerido_a_otorgar?>"></td>
    <td>&nbsp;</td>
  </tr>
  
    <tr>
    <td colspan="3" style="color:#FF0000"><center><span id="x_compara_valores">&nbsp;</span></center></td>
    </tr>
    <tr>
   ...
   <tr>
    <td colspan="3" align="right"><input  type="button" value="Aprobar" id="x_envia" disabled ></td>
    </tr>
...
$GLOBALS["x_saldo_pendiente_actual"] = $x_monto_pendiente;
// se calcula el monto para generar el nuevo vencimiento 
$x_monto_para_genererar_nuevo_vencimeinto =  $x_ultimo_incremento - $x_monto_pendiente;
