 ...
 --->
  ...
  <tr>
    ...
    <input type="radio" name="x_garantia_liquida" value="1" <?php if($x_garantia_liquida == 1){ echo "checked";} ?> />&nbsp;SI
      &nbsp;&nbsp;
      <input type="radio" name="x_garantia_liquida" value="2" <?php if($x_garantia_liquida == 2){ echo "checked";} ?>/>&nbsp;NO</td>
    <td class="ewTableAltRow">&nbsp;</td>
    <td class="ewTableHeaderThin">Penalizaci&oacute;n</td>
    <td class="ewTableAltRow"><input name="x_penalizacion" type="text" id="x_penalizacion" value="<?php echo @$x_penalizacion; ?>" size="20" maxlength="50" /></td>
  </tr>
  ...
  <tr>
    ...
    </label>&nbsp;&nbsp;<input type="button" name="x_convenio" value="Aceptar convencio"  onclick="aceptaConvenio();" <?php echo $x_disabled;?> /></div></td>
  </tr>
  <tr>
    <td colspan="5" class="ewTableAltRow">
...
if($GLOBALS["x_garantia_liquida"] == 1){
	...
	if($GLOBALS["x_garantia_liquida_id"] < 1){
		...
		$x_total_venc_doble = $x_total_venc * 2;
			$sqlIGL = "INSERT INTO garantia_liquida (`garantia_liquida_id`, `credito_id`, `monto`, `status`, `fecha`, `fecha_modificacion`) VALUES (NULL, $x_credito_id, $x_total_venc_doble, '1', \"".ConvertDateToMysqlFormat($GLOBALS["x_fecha_otrogamiento"])."\", NULL);";		
		}else{
	$sqlIGL = "INSERT INTO garantia_liquida (`garantia_liquida_id`, `credito_id`, `monto`, `status`, `fecha`, `fecha_modificacion`) VALUES (NULL, $x_credito_id, $x_total_venc, '1', \"".ConvertDateToMysqlFormat($GLOBALS["x_fecha_otrogamiento"])."\", NULL);";
		}
	}else{
		if ($GLOBALS["x_forma_pago_id"] == 1){
			$x_total_venc_doble = $x_total_venc * 2;
