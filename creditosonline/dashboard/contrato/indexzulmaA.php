          ...
          <div class="col-xl-4 col-lg-6 col-md-6 col-12">
            ...
            <div class="small-box bg-info elevation-3">
              <div class="inner">
                ...
                <p><h6 class="lead"><b>Sube tu documentación</b></h6></p>
              </div>
              <div class="icon ">
          ...
          <div class="col-xl-4 col-lg-6 col-md-6 col-12">
            ...
            <div class="small-box bg-grayligth elevation-3 bt-1">
              <div class="inner">
                ...
                <p><h6 class="lead"><b>Descarga tu paquete</b></h6></p>
              </div>
          ...
          <div class="col-xl-4 col-lg-6 col-md-6 col-12">
            ...
            <div class="small-box bg-grayligth elevation-3">
              <div class="inner">
                ...
                <p><h6 class="lead"><b>Obtén tu NIP</b></h6></p>
              </div>
              <div class="icon text-info">
          ...
          <div class="col-xl-4 col-lg-6 col-md-6 col-12">
            ...
            <div class="small-box bg-grayligth elevation-3">
              <div class="inner">
                ...
                <p><h6 class="lead"><b>Firma tu contrato</b></h6></p>
              </div>
              <div class="icon text-info">
