...
//if (!empty($x_vivienda_tipo_id )) $x_vivienda_tipo_id  = (get_magic_quotes_gpc()) ? stripslashes($x_vivienda_tipo_id ) : $x_vivienda_tipo_id ;
// Get action
...
<form name="vivienda_tipoedit" id="vivienda_tipoedit" action="php_vivienda_tipoedit.php" method="post" onSubmit="return EW_checkMyForm(this);">
<p>
<input type="hidden" name="a_edit" value="U">
<table class="ewTable_small">
	<tr>
		<td width="142" class="ewTableHeader"><span>No</span></td>
		<td width="846" class="ewTableAltRow"><span>
<?php echo $x_vivienda_tipo_id; ?>
<input type="hidden" id="x_vivienda_tipo_id" name="x_vivienda_tipo_id" value="<?php echo htmlspecialchars(@$x_vivienda_tipo_id); ?>">
</span></td>
	</tr>
	<tr>
		<td class="ewTableHeader"><span>Descripción</span></td>
		<td class="ewTableAltRow"><span>
<input type="text" name="x_descripcion" id="x_descripcion" size="50" maxlength="150" value="<?php echo htmlspecialchars(@$x_descripcion) ?>">
</span></td>
	</tr>
</table>
<p>
