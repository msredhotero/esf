...
$x_direccion = "  calle ".$x_calle." ".$x_numero_exterior." Colonia ".$x_colonia." en ".$x_delegacion.", ".$x_entidad;
...
$x_diraval = " en la calle ".$x_aval_calle.". Colonia ".$x_aval_colonia.", en ".$x_aval_delegacion.", ".
$x_aval_entidad;
...
//echo "sol id".$x_solicitud_id."<br>";
	...
	if (phpmkr_num_rows($rs) == 0) {
		...
		$sSql = "SELECT * FROM credito  WHERE solicitud_id = ".$x_solicitud_id." ";
		...
		// echo $sSql ;
		// echo "credito_id" .$GLOBALS["x_credito_id"];
...
if($GLOBALS["x_estado_nombre"] == "COLIMA"){
	...
	/*	if($x_gara > 0){
		...
		$GLOBALS["x_garantia"] = $x_gara;
				...
				if(($x_aval>0) ){
					 //demanda con aval con exhorto
					$x_contenido_id = 45;					
					}else {
						//demanda sin aval con exorto
						$x_contenido_id = 43;
						}
