...
while ($i < count($arRecKey)){
	...
	// Build the SQL
	$sDbWhere .= "`estado_civil_id`=" . $sRecKey . " AND ";
...
<form action="php_estado_civildelete.php" method="post">
<p>
...
<table class="ewTable_small">
	<tr class="ewTableHeader">
		<td width="72" valign="top"><span>No</span></td>
		<td width="716" valign="top"><span>Descripción</span></td>
	</tr>
<?php
$nRecCount = 0;
$i = 0;
