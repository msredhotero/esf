...
switch ($sAction)
{
	...
	case "U": // Update
		if (EditData($conn)) { // Update Record based on key
			...
			echo "<br><br><br><p align='center'><a href='javascript: window.close();' >Los datos han sido actualizados de clic aqui para cerrar esta ventana</a></p>";
  ...
  <tr>
    <td colspan="3" align="left" valign="top"><table width="700" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td colspan="2"><input name="x_tipo_negocio_aval" type="text" class="texto_normal" id="x_tipo_negocio_aval" value="<?php echo htmlentities(@$x_tipo_negocio_aval) ?>" size="80" maxlength="250" /></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td colspan="4"><span class="texto_normal">
          <input name="x_ocupacion" type="text" class="texto_normal" id="x_ocupacion" value="<?php echo htmlentities(@$x_ocupacion) ?>" size="30" maxlength="150" />
        </span></td>
      </tr>
      <tr>
        <td class="texto_normal">&nbsp;</td>
...
<tr>
  ...
  <tr>
    <td colspan="3" align="center" valign="middle" bgcolor="#FFE6E6">Gastos Mensuales</td>
    </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td colspan="3" align="left" valign="top"><table width="700" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td><input name="x_nombre_completo_ref_2" type="text" class="texto_normal" id="x_nombre_completo_ref_2" value="<?php echo htmlentities(@$x_nombre_completo_ref_2) ?>" size="50" maxlength="250" /></td>
...
*/
			...
			$x_cpm = (($x_ingresos + $x_otros_ing + $x_ing_fam1 + $x_ing_fam2) - (($x_dep * 700) + $x_ren + 200 + 400));
