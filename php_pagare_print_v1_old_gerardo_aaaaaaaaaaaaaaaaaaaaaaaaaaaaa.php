...
//CREDITO
$sSql = "SELECT credito_respaldo.tarjeta_num, fecha_vencimiento, referencia_pago, tasa, tasa_moratoria, fecha_otrogamiento, credito_respaldo.credito_respaldo_id FROM credito_respaldo where solicitud_id = $x_solicitud_id";
...
//CREDITO
$sSql = "SELECT credito_respaldo.credito_respaldo_id, credito_respaldo.tarjeta_num, fecha_vencimiento, referencia_pago, tasa, tasa_moratoria, fecha_otrogamiento FROM credito_respaldo where solicitud_id = $x_solicitud_id AND credito_status_id = 1";
$rs = phpmkr_query($sSql,$conn) or die("Failed to execute query: " . phpmkr_error() . '<br>SQL: ' . $sSql);
$row = phpmkr_fetch_array($rs);
$x_cheque_valor = $row["referencia"];
$x_tasa_valor = $row["tasa"];
...
//TABLA DE VENC
$sSql = "SELECT * FROM vencimiento_respaldo where vencimiento_respaldo.credito_respaldo_id = $x_credito_id ORDER BY vencimiento_respaldo.vencimiento_num";
