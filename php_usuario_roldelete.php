...
while ($i < count($arRecKey)){
	...
	// Build the SQL
	$sDbWhere .= "`usuario_rol_id`=" . $sRecKey . " AND ";
...
<p><span class="phpmaker">Delete from TABLE: PERMISOS DE USUARIOS<br><br><a href="php_usuario_rollist.php">Back to List</a></span></p>
<form action="php_usuario_roldelete.php" method="post">
<p>
