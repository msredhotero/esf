...
if ($sExport == "excel") {
	...
	header('Content-Disposition: attachment; filename=reporte_ctp.xls');
}
?>
<?php include ("db.php") ?>
...
<p><span class="phpmaker">REPORTE DE CARTERA TOTAL PROMEDIO
<?php if ($sExport == "") { ?>
&nbsp;&nbsp;<a href="php_rpt_ctp.php?export=excel&x_fecha_desde=<?php echo FormatDateTime(@$x_fecha_desde,7); ?>&x_fecha_hasta=<?php echo FormatDateTime(@$x_fecha_hasta,7); ?>">Exportar a Excel</a><?php } ?>
</span></p>

<?php if ($sExport == "") { ?>
<p><span class="phpmaker">
<form action="php_rpt_ctp.php" name="filtro" id="filtro" method="post">
...
$x_tot_cartera_p = $x_tot_otorgado_p - $x_tot_pagado_p;
