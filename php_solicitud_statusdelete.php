...
while ($i < count($arRecKey)){
	...
	// Build the SQL
	$sDbWhere .= "`solicitud_status_id`=" . $sRecKey . " AND ";
...
<p><span class="phpmaker">Delete from TABLE: STATUS DE SOLICITUDES<br><br><a href="php_solicitud_statuslist.php">Back to List</a></span></p>
<form action="php_solicitud_statusdelete.php" method="post">
<p>
...
{
	global $x_solicitud_status_id;
	$sSql = "Delete FROM `solicitud_status`";
	$sSql .= " WHERE " . $sqlKey;
