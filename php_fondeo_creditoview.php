...
<table width="700" cellpadding="1" cellspacing="2" border="0" class="phpmaker" >
	<tr>
	  ...
	  <td class="ewTableAltRow"><?php echo $x_fondeo_credito_num; ?></td>
...
?>
        ...
        <?php //$x_fondeo_credito_tipo_id = $ox_fondeo_credito_tipo_id; // Restore Original Value ?></td>
	  </tr>
	<tr>
...
?>
	...
	<tr>
        ...
        <!---
        <input type="button" name="btn_rest" id="btn_rest" value="Pagos Multiples" onclick="javascript: document.getElementById('vencdesk').src = 'php_pagosadd.php?credito_id=<?php //echo $x_fondeo_credito_id; ?>';" />		
        --->        </td>
	</tr>
	<tr>
		<td colspan="5" class="ewTableAltRow">
		<iframe id="vencdesk" name="vencdesk" src="php_fondeo_vencimientolist.php?credito_id=<?php echo $x_fondeo_credito_id; ?>" style="margin-left:2px; width:700px; height:750px; border:0 " allowtransparency="true" frameborder="0"></iframe>		</td>
	</tr>	
</table>
</form>
<p>
