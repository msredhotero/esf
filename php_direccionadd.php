...
<p><span class="phpmaker">Add to TABLE: DIRECCIONES<br><br><a href="php_direccionlist.php">Back to List</a></span></p>
<form name="direccionadd" id="direccionadd" action="php_direccionadd.php" method="post" onSubmit="return EW_checkMyForm(this);">
<p>
...
?>
	...
	<tr>
		...
		<td class="ewTableAltRow"><span>
<?php if (!(!is_null($x_aval_id)) || ($x_aval_id == "")) { $x_aval_id = 0;} // Set default value ?>
<?php
...
?>
	...
	<tr>
		...
		<td class="ewTableAltRow"><span>
<?php if (!(!is_null($x_direccion_tipo_id)) || ($x_direccion_tipo_id == "")) { $x_direccion_tipo_id = 0;} // Set default value ?>
<?php
...
<input type="text" name="x_colonia" id="x_colonia" size="30" maxlength="150" value="<?php echo htmlspecialchars(@$x_colonia) ?>">
	...
	<tr>
		...
		<td class="ewTableAltRow"><span>
<?php if (!(!is_null($x_delegacion_id)) || ($x_delegacion_id == "")) { $x_delegacion_id = 0;} // Set default value ?>
<?php
...
<input type="text" name="x_antiguedad" id="x_antiguedad" size="30" value="<?php echo htmlspecialchars(@$x_antiguedad) ?>">
	...
	<tr>
		...
		<td class="ewTableAltRow"><span>
<?php if (!(!is_null($x_vivienda_tipo_id)) || ($x_vivienda_tipo_id == "")) { $x_vivienda_tipo_id = 0;} // Set default value ?>
<?php
...
function AddData($conn)
{
	...
	if ((@$x_direccion_id == "") || (is_null($x_direccion_id))) {
		...
		$sTmp =  (get_magic_quotes_gpc()) ? stripslashes($x_direccion_id) : $x_direccion_id;			
		$sWhereChk .= "(`direccion_id` = " . addslashes($sTmp) . ")";
	}
	if ($bCheckKey) {
