...
if (empty($x_vencimiento_status_id)) {
	$bCopy = false;
}
...
<p><span class="phpmaker">Add to TABLE: STATUS DE VENCIMIENOS<br><br><a href="php_vencimiento_statuslist.php">Back to List</a></span></p>
<form name="vencimiento_statusadd" id="vencimiento_statusadd" action="php_vencimiento_statusadd.php" method="post" onSubmit="return EW_checkMyForm(this);">
<p>
...
function AddData($conn)
{
	...
	if ((@$x_vencimiento_status_id == "") || (is_null($x_vencimiento_status_id))) {
		...
		$sTmp =  (get_magic_quotes_gpc()) ? stripslashes($x_vencimiento_status_id) : $x_vencimiento_status_id;			
		$sWhereChk .= "(`vencimiento_status_id` = " . addslashes($sTmp) . ")";
	}
	if ($bCheckKey) {
	...
	$sSql = "INSERT INTO `vencimiento_status` (";
