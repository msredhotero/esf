...
// Build SQL
	...
	$x_importe_ccc = 0;
	$x_saldo_c = 0;
	$sSql = "SELECT credito_id  from credito join solicitud on solicitud.solicitud_id = credito.solicitud_id where credito.credito_status_id  in (3) and credito.fecha_otrogamiento <= '".$x_fecha_actual."'".$x_filtros;
	$rs = phpmkr_query($sSql,$conn) or die("Failed to execute query: " . phpmkr_error() . '<br>SQL: ' . $sSql);
...
?>
<table>
<tr><td>credito</td><td>Pago</td></tr>
<?php echo ?>
</table>
