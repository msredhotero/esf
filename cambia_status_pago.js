...
function process(registro_id)
{
  ...
  if (xmlHttp.readyState == 4 || xmlHttp.readyState == 0)
  {
	...
	//tipo de solicitud 
	var url = "php_cambia_status_pago_masivo.php?x_mp_id="+registro_id+"";	
...
function handleServerResponse() 
{
  ...
  if (xmlHttp.readyState == 4) 
  {
	...
	document.getElementById("capaNoAplicaPago"+registro_id+"").innerHTML=xmlHttp.responseText;      
    } 
