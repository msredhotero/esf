...
?>
	...
	<tr>
		<td colspan="5" class="ewTableAltRow">
		<iframe id="vencdesk" name="vencdesk" src="php_vencimientolist.php?credito_id=<?php echo $x_credito_id; ?>" style="margin-left:2px; width:700px; height:750px; border:0 " allowtransparency="true" frameborder="0"></iframe>		</td>
	</tr>	
</table>
</form>
<p>
