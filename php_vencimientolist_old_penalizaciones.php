...
Interés
<?php }else{ ?>
	<a href="php_vencimientolist.php?credito_id=<?php echo $x_credito_id; ?>&order=<?php echo urlencode("interes"); ?>">Interés<?php if (@$_SESSION["vencimiento_x_interes_Sort"] == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif (@$_SESSION["vencimiento_x_interes_Sort"] == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></a>
<?php } ?>
		</span></td>
