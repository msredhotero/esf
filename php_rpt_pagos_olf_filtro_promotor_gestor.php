...
<?php if ($sExport == "") { ?>
&nbsp;&nbsp;<a href="php_rpt_pagos.php?export=excel&x_credito_num_filtro=<?php echo $x_credito_num_filtro; ?>&x_fecha_desde=<?php echo ConvertDateToMysqlFormat(@$filter['x_fecha_desde']); ?>&x_fecha_hasta=<?php echo ConvertDateToMysqlFormat(@$filter['x_fecha_hasta']); ?>&x_gestor_srch=<?php echo $filter["x_gestor_srch"];?>">Exportar a Excel</a><?php } ?>
</span></p>
<p>
<?php
if (@$_SESSION["ewmsg"] <> "") {
